...
export default function CustomTimestamps() {

  // Date picker form element
  const datePickerEl = $('#custom-date-selector');
  ...
  // Submit new date
  $('#submit-custom-date').on('click', function () {
  ...
  $('#custom-time-trigger-link').on('click', function(event) {
