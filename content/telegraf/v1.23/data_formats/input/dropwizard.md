...
menu:
  telegraf_1_23_ref:
    ...
    aliases:
        - /telegraf/v1.23/data_formats/template-patterns/
---
...
## Templates <!--This content is duplicated in /telegraf/v1.23/data_formats/input/graphite/-->

Template patterns are a mini language that describes how a dot-delimited
string should be mapped to and from [metrics](/telegraf/v1.23/concepts/metrics/).
