...
Telegraf offers multiple service [input plugins](/telegraf/v1.13/plugins/inputs/) that may
...
[configuration documentation](/telegraf/v1.13/administration/configuration/).
