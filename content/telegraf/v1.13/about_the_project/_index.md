...
View the [Telegraf release notes](/telegraf/v1.13/about_the_project/release-notes-changelog/)
...
The [list of third party software components, including references to associated licenses and other materials](https://github.com/influxdata/telegraf/blob/release-1.13/docs/LICENSE_OF_DEPENDENCIES.md), is maintained on a version by version basis.