---
description: "Telegraf plugin for retrieving secrets from HashiCorp Vault"
menu:
  telegraf_v1_ref:
    parent: secretstore_plugins_reference
    name: HashiCorp Vault
    identifier: secretstore-vault
tags: [HashiCorp Vault, "secret-store-plugins", "configuration", "web"]
introduced: "v1.37.0"
...
This plugin allows to access secrets provided by a [HashiCorp Vault](https://www.hashicorp.com/en/products/vault)
