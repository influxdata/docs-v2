---
description: "Telegraf plugin for retrieving secrets from OAuth2"
menu:
  telegraf_v1_ref:
    parent: secretstore_plugins_reference
    name: OAuth2
    identifier: secretstore-oauth2
tags: [OAuth2, "secret-store-plugins", "configuration", "web"]
introduced: "v1.28.0"
...
such as [Auth0](https://auth0.com), [AzureAD](https://azure.microsoft.com/en/products/active-directory) or others (see
...
To use the [Auth0 service](https://auth0.com) for retrieving the token you need to set the
...
To use the [AzureAD service](https://azure.microsoft.com/en/products/active-directory) for retrieving the token you need to set
