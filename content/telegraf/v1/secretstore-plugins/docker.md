---
description: "Telegraf plugin for retrieving secrets from Docker"
menu:
  telegraf_v1_ref:
    parent: secretstore_plugins_reference
    name: Docker
    identifier: secretstore-docker
tags: [Docker, "secret-store-plugins", "configuration", "containers"]
introduced: "v1.27.0"
...
This plugin allows to access [Docker secrets](https://docs.docker.com/engine/swarm/secrets/) mounted by the
...
([see documentation](https://github.com/compose-spec/compose-spec/blob/master/09-secrets.md)) instead of using `environment` variables.
