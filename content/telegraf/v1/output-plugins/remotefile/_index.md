...
related:
  ...
  - https://github.com/influxdata/telegraf/tree/v1.36.2/plugins/outputs/remotefile/README.md, Remote File Plugin Source
---

# Remote File Output Plugin

This plugin writes metrics to files in a remote location using the
[rclone library](https://rclone.org). Currently the following backends are supported:
