...
related:
  ...
  - https://github.com/influxdata/telegraf/tree/v1.37.2/plugins/outputs/nats/README.md, NATS Plugin Source
---

# NATS Output Plugin

This plugin writes metrics to subjects of a set of [NATS](https://nats.io) instances in
...
and `credential` option. See the [secret-store documentation](/telegraf/v1/configuration/#secret-store-secrets) for
