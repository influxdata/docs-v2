---
description: "Telegraf plugin for sending metrics to Heartbeat"
menu:
  telegraf_v1_ref:
    parent: output_plugins_reference
    name: Heartbeat
    identifier: output-heartbeat
tags: [Heartbeat, "output-plugins", "configuration", "applications"]
introduced: "v1.37.0"
os_support: "freebsd, linux, macos, solaris, windows"
related:
  - /telegraf/v1/configure_plugins/
  - https://github.com/influxdata/telegraf/tree/v1.38.2/plugins/outputs/heartbeat/README.md, Heartbeat Plugin Source
---
...
[plugin directory](/telegraf/v1/plugins/#output-heartbeat).
...
The `ok`, `warn` and `fail` settings allow to specify [CEL expressions](https://cel.dev)
...
`internal_agent` metric of the [internal input plugin](/telegraf/v1/plugins/#input-internal):
