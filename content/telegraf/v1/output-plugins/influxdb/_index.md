...
related:
  ...
  - https://github.com/influxdata/telegraf/tree/v1.37.3/plugins/outputs/influxdb/README.md, InfluxDB v1.x Plugin Source
---

# InfluxDB v1.x Output Plugin

This plugin writes metrics to a [InfluxDB v1.x](https://docs.influxdata.com/influxdb/v1) instance via
