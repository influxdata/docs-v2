...
related:
  ...
  - https://github.com/influxdata/telegraf/tree/v1.36.1/plugins/outputs/influxdb_v2/README.md, InfluxDB v2.x Plugin Source
---
...
`http_headers` option. See the [secret-store documentation](/telegraf/v1/configuration/#secret-store-secrets) for
