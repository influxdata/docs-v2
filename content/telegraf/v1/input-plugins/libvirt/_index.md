...
related:
  ...
  - https://github.com/influxdata/telegraf/tree/v1.37.2/plugins/inputs/libvirt/README.md, Libvirt Plugin Source
---

# Libvirt Input Plugin

This plugin collects statistics about virtualized guests on a system by using
the [libvirt](https://libvirt.org/) virtualization API. Metrics are gathered directly from
...
- [qemu hypervisor](https://www.qemu.org/) installed and running
