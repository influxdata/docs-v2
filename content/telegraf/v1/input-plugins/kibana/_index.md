...
related:
  ...
  - https://github.com/influxdata/telegraf/tree/v1.36.3/plugins/inputs/kibana/README.md, Kibana Plugin Source
---

# Kibana Input Plugin

This plugin collects metrics about service status from [Kibana](https://www.elastic.co/kibana)
