...
related:
  ...
  - https://github.com/influxdata/telegraf/tree/v1.37.3/plugins/inputs/phpfpm/README.md, PHP-FPM Plugin Source
---

# PHP-FPM Input Plugin

This plugin gathers statistics of the [PHP FastCGI Process Manager](https://www.php.net/manual/en/install.fpm.php)
using either the HTTP status page or the fpm socket.

**Introduced in:** Telegraf v0.1.10
**Tags:** server, web
**OS support:** all
