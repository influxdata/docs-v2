...
related:
  ...
  - https://github.com/influxdata/telegraf/tree/v1.37.1/plugins/inputs/supervisor/README.md, Supervisor Plugin Source
---

# Supervisor Input Plugin

This plugin gathers information about processes running under
[supervisord](https://supervisord.org/) using the [XML-RPC API](https://supervisord.org/api.html).
