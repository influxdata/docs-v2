...
related:
  ...
  - https://github.com/influxdata/telegraf/tree/v1.37.2/plugins/inputs/rabbitmq/README.md, RabbitMQ Plugin Source
---

# RabbitMQ Input Plugin

This plugin gathers statistics from [RabbitMQ](https://www.rabbitmq.com) servers via the
