...
related:
  ...
  - https://github.com/influxdata/telegraf/tree/v1.36.1/plugins/inputs/zipkin/README.md, Zipkin Plugin Source
---

# Zipkin Input Plugin

This service plugin implements the [Zipkin](https://zipkin.io/) HTTP server to gather trace
