...
related:
  ...
  - https://github.com/influxdata/telegraf/tree/v1.37.0/plugins/inputs/tail/README.md, Tail Plugin Source
---

# Tail Input Plugin

This service plugin continuously reads a file and parses new data as it arrives
similar to the [tail -f command](https://man7.org/linux/man-pages/man1/tail.1.html). The incoming messages are expected to be
in one of the supported [data formats](/telegraf/v1/data_formats/input).

**Introduced in:** Telegraf v1.1.2
**Tags:** logging
**OS support:** all
