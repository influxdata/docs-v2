...
related:
  ...
  - https://github.com/influxdata/telegraf/tree/v1.36.3/plugins/inputs/mqtt_consumer/README.md, MQTT Consumer Plugin Source
---

# MQTT Consumer Input Plugin

This service plugin consumes messages from [MQTT](https://mqtt.org) brokers for the
configured topics in one of the supported [data formats](/telegraf/v1/data_formats/input).
...
multi-field metric. For more info check out the [pivot processor](/telegraf/v1/plugins/#processor-pivot).
