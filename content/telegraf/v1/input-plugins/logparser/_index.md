...
tags: [Logparser, "input-plugins", "configuration", "system", "logging
...
> [!IMPORTANT]
> This plugin is deprecated. Please use the [`tail` plugin]() plugin in
> combination with the [`grok` data format]() as a replacement.

**introduces in:** Telegraf v1.0.0
**deprecated in:** Telegraf v1.15.0
**removal in:** Telegraf v1.35.0
**tags:** system, logging
**supported OS:** freebsd, linux, macos, windows

## Migration guide

This plugin is deprecated since Telegraf v1.15. To replace the plugin please
use the [`tail` plugin]() plugin in combination with the
[`grok` data format]().
