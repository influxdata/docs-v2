...
related:
  ...
  - https://github.com/influxdata/telegraf/tree/v1.36.2/plugins/inputs/opensmtpd/README.md, OpenSMTPD Plugin Source
---

# OpenSMTPD Input Plugin

This plugin gathers statistics from [OpenSMTPD](https://www.opensmtpd.org/) using the `smtpctl`
binary.
