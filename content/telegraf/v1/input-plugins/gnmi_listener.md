---
description: "Telegraf plugin for collecting metrics from gNMI (gRPC Network Management Interface) dial-out"
menu:
  telegraf_v1_ref:
    parent: input_plugins_reference
    name: gNMI (gRPC Network Management Interface) dial-out
    identifier: input-gnmi_listener
tags: [gNMI (gRPC Network Management Interface) dial-out, "input-plugins", "configuration", "network"]
introduced: "v1.39.0"
...
This plugin consumes telemetry data based on [gNMI](https://github.com/openconfig/reference/blob/master/rpc/gnmi/gnmi-specification.md) messages sent by
network devices in dial-out mode. This plugin supports a list of vendor
protocols such as [Nokia dial-out telemetry](https://infocenter.nokia.com/public/7750SR222R1A/index.jsp?topic=%2Fcom.nokia.System_Mgmt_Guide%2Fdial-out_teleme-ai9exj5ye3.html).

**Introduced in:** Telegraf v1.39.0
**Tags:** network
**OS support:** all
