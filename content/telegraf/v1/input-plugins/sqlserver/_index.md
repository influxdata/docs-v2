---
description: "Telegraf plugin for collecting metrics from Microsoft SQL Server"
menu:
  telegraf_v1_ref:
...
related:
  ...
  - https://github.com/influxdata/telegraf/tree/v1.36.2/plugins/inputs/sqlserver/README.md, Microsoft SQL Server Plugin Source
---

# Microsoft SQL Server Input Plugin

This plugin provides metrics for your [SQL Server](https://docs.microsoft.com/en-us/sql/sql-server) instance. Recorded
...
> [lifecycle dates](https://docs.microsoft.com/en-us/sql/sql-server/end-of-support/sql-server-end-of-life-overview?view=sql-server-ver15#lifecycle-dates)), Azure SQL Databases (Single), Azure SQL Managed
...
only) check the [howto document](https://docs.microsoft.com/en-us/sql/relational-databases/security/using-service-sids-to-grant-permissions-to-services-in-sql-server). In an administrative command prompt
...
[authentication](https://docs.microsoft.com/en-us/azure/azure-sql/database/security-overview#authentication): SQL authentication and AAD authentication. The
recommended practice is to use [AAD authentication](https://docs.microsoft.com/en-us/azure/azure-sql/database/authentication-aad-overview) when possible as
...
Please check [SQL Server driver](https://github.com/microsoft/go-mssqldb#azure-active-directory-authentication) documentation for available options.
...
(the VM connecting to the SQL server/database) [using the Azure portal](https://docs.microsoft.com/en-us/azure/active-directory/managed-identities-azure-resources/qs-configure-portal-windows-vm).
