...
related:
  ...
  - https://github.com/influxdata/telegraf/tree/v1.36.4/plugins/inputs/nginx_upstream_check/README.md, Nginx Upstream Check Plugin Source
---

# Nginx Upstream Check Input Plugin

This plugin gathers metrics from the [Nginx web server](https://www.nginx.com) using the
[upstream check module](https://github.com/yaoweibin/nginx_upstream_check_module). This module periodically sends
