...
related:
  ...
  - https://github.com/influxdata/telegraf/tree/v1.37.0/plugins/inputs/lustre2/README.md, Lustre Plugin Source
---

# Lustre Input Plugin

This plugin gathers metrics for the [Lustre® file system](http://lustre.org/) using its
entries in the `proc` filesystem. Reference the
[Lustre Monitoring and Statistics Guide](http://wiki.lustre.org/Lustre_Monitoring_and_Statistics_Guide) for the reported information.
