...
related:
  ...
  - https://github.com/influxdata/telegraf/tree/v1.36.1/plugins/inputs/minecraft/README.md, Minecraft Plugin Source
---

# Minecraft Input Plugin

This plugin collects score metrics from a [Minecraft](https://www.minecraft.net/) server using
the RCON protocol.
...
Scoreboard [objectives](https://minecraft.gamepedia.com/Scoreboard#Objectives) must be added using the server console for
