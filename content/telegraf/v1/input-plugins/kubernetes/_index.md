...
related:
  ...
  - https://github.com/influxdata/telegraf/tree/v1.36.3/plugins/inputs/kubernetes/README.md, Kubernetes Plugin Source
---
...
See the [Kubernetes documentation](https://kubernetes.io/docs/tasks/administer-cluster/access-cluster-api/#without-kubectl-proxy) for a full example of
...
[Monitoring Kubernetes Architecture blog post](https://www.influxdata.com/blog/monitoring-kubernetes-architecture/) or check the
