...
This plugin gathers status information from [FRITZ!](https://fritz.com/) devices (routers,
repeaters, etc) using the device's [TR-064](https://fritz.com/en/pages/interfaces) interface.
