...
related:
  ...
  - https://github.com/influxdata/telegraf/tree/v1.36.3/plugins/inputs/opensearch_query/README.md, OpenSearch Query Plugin Source
---

# OpenSearch Query Input Plugin

This plugin queries [OpenSearch](https://opensearch.org/) endpoints to derive metrics from
