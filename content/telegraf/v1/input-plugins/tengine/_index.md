...
related:
  ...
  - https://github.com/influxdata/telegraf/tree/v1.36.3/plugins/inputs/tengine/README.md, Tengine Web Server Plugin Source
---

# Tengine Web Server Input Plugin

This plugin gathers metrics from the [Tengine Web Server](http://tengine.taobao.org) via the
