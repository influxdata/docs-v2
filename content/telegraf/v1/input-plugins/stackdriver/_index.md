...
related:
  ...
  - https://github.com/influxdata/telegraf/tree/v1.36.4/plugins/inputs/stackdriver/README.md, Stackdriver Google Cloud Monitoring Plugin Source
---

# Stackdriver Google Cloud Monitoring Input Plugin

This plugin collects metrics from [Google Cloud Monitoring](https://cloud.google.com/monitoring)
(formerly Stackdriver) using the [Cloud Monitoring API v3](https://cloud.google.com/monitoring/api/v3/).
