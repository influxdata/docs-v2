...
For the following example to work, configure [`influxdb_v2` output plugin](/telegraf/v1/plugins/#output-influxdb_v2). This plugin is what allows Telegraf to write the metrics to InfluxDB.
...
[Start the Telegraf service](/telegraf/v1/get_started/#start-telegraf).
