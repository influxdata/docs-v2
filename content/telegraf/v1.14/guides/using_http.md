...
For the following example to work, configure [`influxdb` output plugin](/telegraf/v1.14/plugins/plugin-list/#influxdb). This plugin is what allows Telegraf to write the metrics to your InfluxDB.
