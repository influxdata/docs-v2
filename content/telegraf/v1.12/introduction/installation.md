...
Telegraf offers multiple service [input plugins](/telegraf/v1.12/plugins/inputs/) that may
...
[configuration documentation](/telegraf/v1.12/administration/configuration/).
