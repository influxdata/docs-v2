...
<a class="btn download" href="https://dl.influxdata.com/influxdb/releases/influxdb_2.0.0-beta.6_darwin_amd64.tar.gz" download>InfluxDB v2.0 beta (macOS)</a>
...
tar zxvf ~/Downloads/influxdb_2.0.0-beta.6_darwin_amd64.tar.gz
```
...
sudo cp influxdb_2.0.0-beta.6_darwin_amd64/{influx,influxd} /usr/local/bin/
```
...
<a class="btn download" href="https://dl.influxdata.com/influxdb/releases/influxdb_2.0.0-beta.6_linux_amd64.tar.gz" download >InfluxDB v2.0 beta (amd64)</a>
<a class="btn download" href="https://dl.influxdata.com/influxdb/releases/influxdb_2.0.0-beta.6_linux_arm64.tar.gz" download >InfluxDB v2.0 beta (arm)</a>
...
```sh
# Unpackage contents to the current working directory
tar xvzf path/to/influxdb_2.0.0-beta.6_linux_amd64.tar.gz

# Copy the influx and influxd binary to your $PATH
sudo cp influxdb_2.0.0-beta.6_linux_amd64/{influx,influxd} /usr/local/bin/
```
