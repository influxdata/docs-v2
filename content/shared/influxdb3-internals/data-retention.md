...
Use the [`influxdb3 create database` command](/influxdb3/version/reference/cli/influxdb3/create/database/) or the [/api/v3/configure/database](/influxdb3/version/reference/api/#operation/PostConfigureDatabase) HTTP API endpoint to create a database with a retention period:
