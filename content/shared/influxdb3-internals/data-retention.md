...
Use the [`influxdb3 create database` command](/influxdb3/version/reference/cli/influxdb3/create/database/) or the [/api/v3/configure/database](/influxdb3/version/api/database/#operation/PostConfigureDatabase) HTTP API endpoint to create a database with a retention period:
...
Use the [`influxdb3 create table` command](/influxdb3/enterprise/reference/cli/influxdb3/create/table/) or the [/api/v3/configure/table](/influxdb3/enterprise/api/table/#operation/PostConfigureTable) HTTP API endpoint to create a table with a retention period:
