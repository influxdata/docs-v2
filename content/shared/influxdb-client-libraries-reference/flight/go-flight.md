...
> 
> Use the [`influxdb3-go` Go client library](/influxdb3/version/reference/client-libraries/v3/go/) for integrating InfluxDB 3 with your Go application code.
> 
...
1.  In your editor, open a new file named `query.go` and enter the following sample code:
    ...
    2.  Creates a `dbQuery` function that does the following:
        ...
        1.  Defines variables for InfluxDB credentials.
            ...
            - **`token`**:  a [database token](/influxdb3/version/admin/tokens/database/) with read permission on the specified database.
