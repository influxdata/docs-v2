...
- [Query engine internals](/influxdb/version/reference/influxql/internals/) -->
...
[database](/influxdb/version/reference/glossary/#database) names,
[retention policy](/influxdb/version/reference/glossary/#retention-policy-rp) names,
[measurement](/influxdb/version/reference/glossary/#measurement) names,
[tag keys](/influxdb/version/reference/glossary/#tag-key), and
[field keys](/influxdb/version/reference/glossary/#field-key).
...
[identifier](/influxdb/version/reference/glossary/#identifier),
...
[retention policy](/influxdb/version/reference/glossary/#retention-policy-rp) name, and
[user](/influxdb/version/reference/glossary/#user) name.

In those cases, you don't need to double-quote `time`  in queries.

`time` can't be a [field key](/influxdb/version/reference/glossary/#field-key) or
...
> 
> - [field keys](/influxdb/version/reference/glossary/#field-key) and [tag keys](/influxdb/version/reference/glossary/> #tag-key) in the [`SELECT` clause](/influxdb/version/reference/influxql/select/)
> - [measurements](/influxdb/version/reference/glossary/#measurement) in the [`FROM` clause](/influxdb/version/reference/> influxql/select/#from-clause)
> - [tag values](/influxdb/version/reference/glossary/#tag-value) and
>   string [field values](/influxdb/version/reference/glossary/#field-value)
>   in the [`WHERE` clause](/influxdb/version/reference/influxql/where/)
> - [tag keys](/influxdb/version/reference/glossary/#tag-key) in the
...
> field values in the `WHERE` clause, [databases](/influxdb/version/reference/glossary/#database),
> and [retention polices](/influxdb/version/reference/glossary/#retention-policy-rp).
