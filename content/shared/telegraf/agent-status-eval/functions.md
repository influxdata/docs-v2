...
> [!Note]
> The same CEL language, functions, and operators also apply to the Telegraf
> [`metricpass` metric-filtering option](/telegraf/v1/configuration/filtering/#metricpass).
> Only the available variables differ.
