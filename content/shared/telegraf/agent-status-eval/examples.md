...
- [CEL variables](../variables/)
- [CEL functions and operators](../functions/)
...
**Scenario:** Combine multiple signals to detect a degraded agent, such as a
high error count combined with output buffer pressure.
