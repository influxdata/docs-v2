...
InfluxDB does not support combining mathematical operations with a wildcard (`*`) or [regular expression](/product/version/query_language/explore-data/#regular-expressions) in the `SELECT` clause.
...
> InfluxQL supports [subqueries](/product/version/query_language/explore-data/#subqueries) which offer similar functionality to using mathematical operators inside a function call.
See [Data Exploration](/product/version/query_language/explore-data/#subqueries) for more information.
