...
Flux is a scripting language designed specifically for working with data.
...
This likely seems familiar if you've already been through the other [getting started guides](/product/version/flux/get-started).
...
_More information about creating custom functions is available in the [Custom functions](/influxdb/v2/query-data/flux/custom-functions) documentation._
...
<div class="page-nav-btns">
  <a class="btn prev" href="/product/version/flux/get-started/transform-data/">Transform your data</a>
</div>
