...
When [querying data from InfluxDB](/product/version/flux/get-started/query-influxdb),
...
## Query data
Use the query built in the previous [Query data from InfluxDB](/product/version/flux/get-started/query-influxdb)
...
view the [Windowing and aggregating data](/product/version/flux/guides/window-aggregate) guide._

---

<div class="page-nav-btns">
  <a class="btn prev" href="/product/version/flux/get-started/query-influxdb/">Query InfluxDB</a>
  <a class="btn next" href="/product/version/flux/get-started/syntax-basics/">Syntax basics</a>
</div>
