...
[Chronograf](/chronograf/v1/) is the web user interface for managing for the
...
_**Chronograf v1.8+** and **InfluxDB v1.8+ with [Flux enabled](/product/version/flux/installation)**
...
> [Flux enabled](/product/version/flux/installation).
...
Chronograf [template variables](/chronograf/v1/guides/dashboard-template-variables/)
...
[windowing and aggregation](/product/version/flux/guides/window-aggregate) operations with dashboard refreshes.
