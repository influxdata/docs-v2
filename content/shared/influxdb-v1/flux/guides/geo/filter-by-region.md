...
The following example uses the [sample bird migration data](/product/version/flux/guides/geo/#sample-data)
...
Define a geographic region using one of the following shapes:
