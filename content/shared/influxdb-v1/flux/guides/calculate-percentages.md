...
2. Use [`pivot()` or `join()`](/product/version/flux/guides/mathematic-operations/#pivot-vs-join)
...
_See [Pivot vs join](/product/version/flux/guides/mathematic-operations/#pivot-vs-join)._
{{% /note %}}
...
1. Ensure measurements are in the same [bucket](/product/version/flux/get-started/#buckets).
