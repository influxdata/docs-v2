...
<!-- Percentile ordinals (50th, 99th) are standard statistical terminology. -->
...
{{% note %}}
The examples below use the [example data variable](/product/version/flux/guides/#example-data-variable).
{{% /note %}}
