...
- The [Flux REPL](/product/version/flux/guides/execute-queries/#influx-cli) does not currently support
...
Use [`tableFind()`](/flux/v0/stdlib/universe/tablefind/)
to extract the **first** table whose [group key](/product/version/flux/get-started/#group-keys)
...
Use the [`getColumn()` function](/flux/v0/stdlib/universe/getcolumn/)
...
Use the [`getRecord()` function](/flux/v0/stdlib/universe/getrecord/)
...
Use [dot notation](/product/version/flux/get-started/syntax-basics/#records) to reference
keys in the record.
