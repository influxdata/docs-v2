...
The InfluxQL [`SHOW STATS`](/product/version/query_language/spec#show-stats)
...
see [Measurements for monitoring InfluxDB OSS and InfluxDB Enterprise (`_internal`)](/product/version/administration/monitor/measurements-internal/).
...
For details on the measurement statistics returned, see [InfluxDB `_internal` measurements](/product/version/administration/monitor/measurements-internal/).
