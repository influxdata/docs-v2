...
Find overview and background information on Time Series Index (TSI) in this topic. For detail, including how to enable and configure TSI, see [Time Series Index (TSI) details](/product/version/concepts/tsi-details/).
...
> For details, see [TSM-based data storage and in-memory indexing](/product/version/concepts/storage_engine/).
...
The latter will give us the ability to add things to the query languages like the [SHOW CARDINALITY](/product/version/query_language/spec#show-cardinality) queries.
