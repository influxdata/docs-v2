...
[`/api/v2/delete`](/influxdb/version/api/delete/) endpoint to delete
...
Use the InfluxDB API [`/api/v2/delete` endpoint](/influxdb/version/api/delete/)
to delete points from InfluxDB.

{{< api-endpoint method="post" endpoint="http://localhost:8086/api/v2/delete" api-ref="/influxdb/version/api/delete/" >}}
...
_For more information, see the [`/api/v2/delete` endpoint documentation](/influxdb/version/api/delete/)._
