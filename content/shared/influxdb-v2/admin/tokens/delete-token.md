...
{{< api-endpoint method="DELETE" endpoint="http://localhost:8086/api/v2/authorizations/AUTH_ID" api-ref="/influxdb/version/api/authorizations-api-tokens/" >}}

Include the following in your request:

| Requirement          | Include by                                               |
|:-----------          |:----------                                               |
| API token with the [`write: authorizations`](/influxdb/version/api/authorizations-api-tokens/) permission  | Use the `Authorization: Token YOUR_API_TOKEN` header. |
