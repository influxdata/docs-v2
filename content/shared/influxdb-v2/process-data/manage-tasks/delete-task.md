...
Use the [`/tasks/TASK_ID` InfluxDB API endpoint](/influxdb/version/api/tasks/) to delete a task and all associated records (task runs, logs, and labels).

{{< api-endpoint method="DELETE" endpoint="http://localhost:8086/api/v2/tasks/TASK_ID" api-ref="/influxdb/version/api/tasks/" >}}
