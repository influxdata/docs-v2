...
Use the [`/tasks/TASK_ID` InfluxDB API endpoint](/influxdb/version/api/tasks/) to update properties of a task.

{{< api-endpoint method="PATCH" endpoint="http://localhost:8086/api/v2/tasks/TASK_ID" api-ref="/influxdb/version/api/tasks/" >}}
