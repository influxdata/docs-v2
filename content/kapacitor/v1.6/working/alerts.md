...
[Alert](/kapacitor/v1.6/nodes/alert_node/) node.
...
in the [configuration](/kapacitor/v1.6/administration/configuration/#optional-table-groupings)
file.  If the handler requires sensitive information such as tokens and
passwords, it can also be configured using the [Kapacitor HTTP API](/kapacitor/v1.6/working/api/#overriding-configurations).

## Push to handler

Pushing messages to a handler is the basic approach presented in the
[Getting started with Kapacitor](/kapacitor/v1.6/introduction/getting-started/#trigger-alerts-from-stream-data)
...
[Create a Handler](/kapacitor/v1.6/working/api/#creating-handlers) section of
the HTTP API document.

For a walk through on defining and using alert topics see the
[Using Alert Topics](/kapacitor/v1.6/working/using_alert_topics) walk-through.
...
| Handler                       | Description                                                                           |
| -------                       | -----------                                                                           |
| [Alerta](/kapacitor/v1.6/event_handlers/alerta)             | Post alert message to Alerta.                                                         |
| [email](/kapacitor/v1.6/event_handlers/email)               | Send and email with alert data.                                                       |
| [exec](/kapacitor/v1.6/event_handlers/exec)                 | Execute a command passing alert data over STDIN.                                      |
| [HipChat](/kapacitor/v1.6/event_handlers/hipchat)           | Post alert message to HipChat room.                                                   |
| [Kafka](/kapacitor/v1.6/event_handlers/kafka)               | Send alert to a Apache Kafka cluster.                                                 |
| [log](/kapacitor/v1.6/event_handlers/log)                   | Log alert data to file.                                                               |
| [MQTT](/kapacitor/v1.6/event_handlers/mqtt)                 | Post alert message to MQTT.                                                           |
| [OpsGenie v1](/kapacitor/v1.6/event_handlers/opsgenie/v1)   | Send alert to OpsGenie using their v1 API. <em style="opacity: .5">(Deprecated)</em>  |
| [OpsGenie v2](/kapacitor/v1.6/event_handlers/opsgenie/v2)   | Send alert to OpsGenie using their v2 API.                                            |
| [PagerDuty v1](/kapacitor/v1.6/event_handlers/pagerduty/v1) | Send alert to PagerDuty using their v1 API. <em style="opacity: .5">(Deprecated)</em> |
| [PagerDuty v2](/kapacitor/v1.6/event_handlers/pagerduty/v2) | Send alert to PagerDuty using their v2 API.                                           |
| [post](/kapacitor/v1.6/event_handlers/post)                 | HTTP POST data to a specified URL.                                                    |
| [Pushover](/kapacitor/v1.6/event_handlers/pushover)         | Send alert to Pushover.                                                               |
| [Sensu](/kapacitor/v1.6/event_handlers/sensu)               | Post alert message to Sensu client.                                                   |
| [Slack](/kapacitor/v1.6/event_handlers/slack)               | Post alert message to Slack channel.                                                  |
| [SNMPTrap](/kapacitor/v1.6/event_handlers/snmptrap)         | Trigger SNMP traps.                                                                   |
| [Talk](/kapacitor/v1.6/event_handlers/talk)                 | Post alert message to Talk client.                                                    |
| [tcp](/kapacitor/v1.6/event_handlers/tcp)                   | Send data to a specified address via raw TCP.                                         |
| [Telegram](/kapacitor/v1.6/event_handlers/telegram)         | Post alert message to Telegram client.                                                |
| [VictorOps](/kapacitor/v1.6/event_handlers/victorops)       | Send alert to VictorOps.                                                              |
...
| **Recoverable** | Indicates whether the alert is auto-recoverable. Determined by the [`.noRecoveries()`](/kapacitor/v1.6/nodes/alert_node/#norecoveries) property. |

This data is used by [event handlers](/kapacitor/v1.6/event_handlers) in their
