...
aliases:
  - /kapacitor/v1.6/examples/using_alert_topics/
  - /kapacitor/v1.6/guides/using_alert_topics/
menu:
  kapacitor_1_6:
...
presented in the [Getting Started](/kapacitor/v1.6/introduction/getting-started/)
guide. The reader should also have a basic understanding of working with tasks
and [TICKscripts](/kapacitor/v1.6/tick/introduction/).
