...
aliases:
  - /kapacitor/v1.6/pull_metrics/scraping-and-discovery/
  - /kapacitor/v1.6/pull_metrics/
menu:
  kapacitor_1_6:
...
Use those features with [TICKscripts](/kapacitor/v1.6/tick/) to monitor targets, process the data, and write data to [InfluxDB](/influxdb/v1.3/).
...
1. Finally, Kapacitor processes the data according to configured [TICKscripts](/kapacitor/v1.6/tick/).
