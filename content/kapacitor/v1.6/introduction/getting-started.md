...
aliases:
  - /kapacitor/v1.6/introduction/getting_started/
weight: 20
menu:
  kapacitor_1_6:
    parent: Introduction
...
Kapacitor tasks define work to do on a set of data using [TICKscript](/kapacitor/v1.6/tick/) syntax. Kapacitor tasks include:
...
2. Start the Kapacitor service:
    ...
    Because InfluxDB is running on `http://localhost:8086`, Kapacitor finds it during start up and creates several [subscriptions](/kapacitor/v1.6/administration/subscription-management/) on InfluxDB.
...
1. Record the data stream:
    ...
    verify the Kapacitor service is running (see [Installing and Starting Kapacitor](/kapacitor/v1.6/introduction/installation/)).
...
For more information on how alerting works, see the [AlertNode](/kapacitor/v1.6/nodes/alert_node/) docs.
...
For more information, see [Load Directory](/kapacitor/v1.6/guides/load_directory/).
