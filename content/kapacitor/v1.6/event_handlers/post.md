...
Alert templates are only used with post [alert](/kapacitor/v1.6/nodes/alert_node/)
...
Row templates are only used with the [httpPost node](/kapacitor/v1.6/nodes/http_post_node/)
...
They are only used with post [alert](/kapacitor/v1.6/nodes/alert_node/) handlers
...
They are only used with [httpPost](/kapacitor/v1.6/nodes/http_post_node/)
