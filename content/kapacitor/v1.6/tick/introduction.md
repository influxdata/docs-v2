...
The [node reference documentation](/kapacitor/v1.6/nodes/) lists the property and chaining methods of each node along with examples and descriptions.
...
For TICKscript solutions for intermediate to advanced use cases, see the [Guides](/kapacitor/v1.6/guides/) documentation.

The next section covers [TICKscript syntax](/kapacitor/v1.6/tick/syntax/) in more detail. [Continue...](/kapacitor/v1.6/tick/syntax/)
