...
Using a [NoOpNode](/kapacitor/v1.6/nodes/no_op_node/) is a work around so that statistics are accurately reported
for nodes with no real children.
A [NoOpNode](/kapacitor/v1.6/nodes/no_op_node/) is automatically appended to any node that is a source for a [StatsNode](/kapacitor/v1.6/nodes/stats_node/)
