...
The join can be an inner or outer join, see the [JoinNode.Fill](/kapacitor/v1.6/nodes/join_node/#fill) property.
...
> Use the [DefaultNode](/kapacitor/v1.6/nodes/default_node/) and [DeleteNode](/kapacitor/v1.6/nodes/delete_node/)
...
This is done using the [DefaultNode](/kapacitor/v1.6/nodes/default_node/),
...
You can also use the [DeleteNode](/kapacitor/v1.6/nodes/delete_node/) to remove
