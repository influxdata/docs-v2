...
The [node reference documentation](/kapacitor/v1/nodes/) lists the property and chaining methods of each node along with examples and descriptions.
...
The next section covers [TICKscript syntax](/kapacitor/v1/tick/syntax/) in more detail. [Continue...](/kapacitor/v1/tick/syntax/)
