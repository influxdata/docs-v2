...
menu:
  kapacitor_v1:
    ...
    weight: 1
aliases:
  - /kapacitor/v1/tick/introduction/
---
...
The [node reference documentation](/kapacitor/v1/reference/nodes/) lists the property and chaining methods of each node along with examples and descriptions.
...
For TICKscript solutions for intermediate to advanced use cases, see the [Guides](/kapacitor/v1/guides/) documentation.

The next section covers [TICKscript syntax](/kapacitor/v1/reference/tick/syntax/) in more detail. [Continue...](/kapacitor/v1/reference/tick/syntax/)
