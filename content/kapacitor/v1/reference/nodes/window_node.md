...
menu:
  kapacitor_v1:
    ...
    parent: nodes
aliases:
  - /kapacitor/v1/nodes/window_node/
---
...
FillPeriod instructs the [WindowNode](/kapacitor/v1/reference/nodes/window_node/) to wait till the period has elapsed before emitting the first batch.
