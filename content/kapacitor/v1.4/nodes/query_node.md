---
title: QueryNode (Kapacitor TICKscript node)
description: QueryNode defines a source and a schedule for processing batch data. The data is queried from an InfluxDB database and then passed into the data pipeline.
