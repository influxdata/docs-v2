...
For more information and help writing TICKscripts from InfluxQL queries take a looks at these [docs](/{{< latest "kapacitor" >}}/nodes/influx_q_l_node/) on the InfluxQL node in Kapacitor.
