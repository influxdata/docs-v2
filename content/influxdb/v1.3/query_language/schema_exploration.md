...
The following sections cover useful query syntax for exploring your [schema](/influxdb/v1.3/concepts/glossary/#schema).
...
Returns a list of [retention policies](/influxdb/v1.3/concepts/glossary/#retention-policy-rp) for the specified [database](/influxdb/v1.3/concepts/glossary/#database).
...
database with `USE <database_name>` in the [CLI](/influxdb/v1.3/tools/shell/) or with the `db` query
string parameter in the [HTTP API](/influxdb/v1.3/tools/api/#query-string-parameters) request.
...
The `autogen` retention policy has an infinite [duration](/influxdb/v1.3/concepts/glossary/#duration),
a seven-day [shard group duration](/influxdb/v1.3/concepts/glossary/#shard-group),
a [replication factor](/influxdb/v1.3/concepts/glossary/#replication-factor)
...
## `SHOW SERIES`
Returns a list of [series](/influxdb/v1.3/concepts/glossary/#series) for
the specified [database](/influxdb/v1.3/concepts/glossary/#database).
...
[`FROM` clause](/influxdb/v1.3/query_language/data_exploration/#the-basic-select-statement),
[`LIMIT` clause](/influxdb/v1.3/query_language/data_exploration/#the-limit-clause),
[`OFFSET` clause](/influxdb/v1.3/query_language/data_exploration/#the-offset-clause),
and on [Regular Expressions in Queries](/influxdb/v1.3/query_language/data_exploration/#regular-expressions).
...
The query's output is similar to the [line protocol](/influxdb/v1.3/concepts/glossary/#line-protocol) format.
Everything before the first comma is the [measurement](/influxdb/v1.3/concepts/glossary/#measurement) name.
Everything after the first comma is either a [tag key](/influxdb/v1.3/concepts/glossary/#tag-key) or a [tag value](/influxdb/v1.3/concepts/glossary/#tag-value).
...
## `SHOW MEASUREMENTS`
Returns a list of [measurements](/influxdb/v1.3/concepts/glossary/#measurement)
for the specified [database](/influxdb/v1.3/concepts/glossary/#database).
...
## `SHOW TAG KEYS`
Returns a list of [tag keys](/influxdb/v1.3/concepts/glossary/#tag-key)
associated with the specified [database](/influxdb/v1.3/concepts/glossary/#database).
...
## `SHOW TAG VALUES`
Returns the list of [tag values](/influxdb/v1.3/concepts/glossary/#tag-value)
for the specified [tag key(s)](/influxdb/v1.3/concepts/glossary/#tag-key) in the database.
...
## `SHOW FIELD KEYS`
Returns the [field keys](/influxdb/v1.3/concepts/glossary/#field-key) and the
[data type](/influxdb/v1.3/write_protocols/line_protocol_reference/#data-types) of their
[field values](/influxdb/v1.3/concepts/glossary/#field-value).
...
> **Note:** A field's data type [can differ](/influxdb/v1.3/troubleshooting/frequently-asked-questions/#how-does-influxdb-handle-field-type-discrepancies-across-shards) across
[shards](/influxdb/v1.3/concepts/glossary/#shard).
...
Field value
[data types](/influxdb/v1.3/write_protocols/line_protocol_reference/#data-types)
cannot differ within a [shard](/influxdb/v1.3/concepts/glossary/#shard) but they
...
`SELECT` statements.
See the
[FAQ](/influxdb/v1.3/troubleshooting/frequently-asked-questions/#how-does-influxdb-handle-field-type-discrepancies-across-shards)
