...
_**Configuration options by section**_
...
The maximum number of [tag values](/influxdb/v1.3/concepts/glossary/#tag-value)
...
This setting is a [duration](#configuration-options-overview).
...
This setting is a
[duration](#configuration-options-overview).
