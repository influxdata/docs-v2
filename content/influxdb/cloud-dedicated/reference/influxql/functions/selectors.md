...
`BOTTOM()` supports int64 and float64 field value [data types](/influxdb/cloud-dedicated/reference/glossary/#field-value).
...
`TOP()` supports int64 and float64 field value [data types](/influxdb/cloud-dedicated/reference/glossary/#field-value).
