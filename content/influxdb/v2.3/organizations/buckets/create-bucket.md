...
Use the [`influx bucket create` command](/influxdb/v2.3/reference/cli/influx/bucket/create)
...
instance _(see [InfluxDB URLs](/influxdb/v2.3/reference/urls/))_.
...
[InfluxDB API Buckets documentation](/influxdb/v2.3/api/#operation/PostBuckets)._
