...
aliases:
  - /influxdb/v2.3/write-data/no-code/use-telegraf/auto-config/delete-telegraf-config/
  - /influxdb/v2.3/collect-data/use-telegraf/auto-config/delete-telegraf-config
---
...
## Use the influx CLI
Use the [`influx telegrafs rm` command](/influxdb/v2.3/reference/cli/influx/telegrafs/rm/)
