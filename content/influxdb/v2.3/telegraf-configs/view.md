...
aliases:
  - /influxdb/v2.3/write-data/no-code/use-telegraf/auto-config/view-telegraf-config/
  - /influxdb/v2.3/collect-data/use-telegraf/auto-config/view-telegraf-config
---
...
## Use the influx CLI
Use the [`influx telegrafs` command](/influxdb/v2.3/reference/cli/influx/telegrafs/) to
