...
aliases:
  - /influxdb/v2.3/write-data/no-code/use-telegraf/auto-config/update-telegraf-config/
  - /influxdb/v2.3/collect-data/use-telegraf/auto-config/update-telegraf-config
---
...
Use the [`influx telegrafs update` command](/influxdb/v2.3/reference/cli/influx/telegrafs/update/)
