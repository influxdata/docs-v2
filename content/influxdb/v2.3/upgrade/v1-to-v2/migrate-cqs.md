...
related:
  ...
  - /influxdb/v2.3/process-data/common-tasks/
  - /influxdb/v2.3/reference/flux/flux-vs-influxql/
---
...
[Flux vs InfluxQL](/influxdb/v2.3/reference/syntax/flux/flux-vs-influxql/#influxql-and-flux-parity).
...
[create a new task](/influxdb/v2.3/process-data/manage-tasks/create-task/).
...
- [Query data with Flux](/influxdb/v2.3/query-data/flux/)
- [Common tasks](/influxdb/v2.3/process-data/common-tasks/#downsample-data-with-influxdb)
