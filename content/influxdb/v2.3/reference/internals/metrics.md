...
menu:
 influxdb_2_3_ref:
   ...
   name: Metrics
influxdb/v2.3/tags: [cpu, memory, metrics, performance, Prometheus, storage, usage]
---
Get metrics about the workload performance of an InfluxDB OSS instance.
...
To learn how InfluxDB writes, stores, and caches data, see [InfluxDB storage engine](/influxdb/v2.3/reference/internals/storage-engine/).
...
Size (in bytes) of the most recent [snapshot](/influxdb/v2.3/reference/internals/storage-engine/#cache).
...
Current memory consumption (in bytes) of the [cache](/influxdb/v2.3/reference/internals/storage-engine/#cache).
...
[Unix time](/influxdb/v2.3/reference/glossary/#unix-timestamp) of the most recent [snapshot](/influxdb/v2.3/reference/internals/storage-engine/#cache).
...
Cumulative number of [cached](/influxdb/v2.3/reference/internals/storage-engine/#cache) writes that had [rejected points](/influxdb/v2.3/reference/glossary/#rejected-point). Writes with rejected points also increment the [write errors counter (`storage_cache_writes_err`)](#cache-writes-failed).
...
Cumulative number of  [cached](/influxdb/v2.3/reference/internals/storage-engine/#cache) writes that [failed](/influxdb/v2.3/write-data/troubleshoot/#troubleshoot-failures), inclusive of [cache writes with dropped points (`storage_cache_writes_dropped`)](#cache-writes-with-dropped-points).
...
Cumulative number of  writes to [cache](/influxdb/v2.3/reference/internals/storage-engine/#cache).
...
Currently running [TSM](/influxdb/v2.3/reference/internals/storage-engine/#time-structured-merge-tree-tsm) compactions (by level).
...
[TSM](/influxdb/v2.3/reference/internals/storage-engine/#time-structured-merge-tree-tsm) compactions (by level) since startup.
...
Failed [TSM](/influxdb/v2.3/reference/internals/storage-engine/#time-structured-merge-tree-tsm) compactions (by level).
...
Queued [TSM](/influxdb/v2.3/reference/internals/storage-engine/#time-structured-merge-tree-tsm) compactions (by level).
...
Disk size (in bytes) of the [shard](/influxdb/v2.3/reference/internals/shards/).
...
Number of [shard](/influxdb/v2.3/reference/internals/shards/) fields created.
...
Number of series in the [shard](/influxdb/v2.3/reference/internals/shards/) index.
...
Number of [shard write](/influxdb/v2.3/reference/internals/shards/#shard-writes) requests.
...
Number of [rejected points](/influxdb/v2.3/reference/glossary/#rejected-point) in [shard writes](/influxdb/v2.3/reference/internals/shards/#shard-writes).
...
Number of [shard write](/influxdb/v2.3/reference/internals/shards/#shard-writes) requests with errors.
...
Number of points in [shard write](/influxdb/v2.3/reference/internals/shards/#shard-writes) requests with errors.
...
Number of points in [shard write](/influxdb/v2.3/reference/internals/shards/#shard-writes) requests.
...
Gauge of the data size (in bytes) for each [shard](/influxdb/v2.3/reference/internals/shards/).
...
Number of files per [shard](/influxdb/v2.3/reference/internals/shards/).
...
[WAL](/influxdb/v2.3/reference/internals/storage-engine/#write-ahead-log-wal) size (in bytes).
...
Cumulative number of write attempts to the [WAL](/influxdb/v2.3/reference/internals/storage-engine/#write-ahead-log-wal).
...
Cumulative number of failed write attempts to the [WAL](/influxdb/v2.3/reference/internals/storage-engine/#write-ahead-log-wal).
...
Number of points in successful [shard write](/influxdb/v2.3/reference/internals/shards/#shard-writes) requests.
...
Cumulative number of [shard write](/influxdb/v2.3/reference/internals/shards/#shard-writes) request timeouts.
