...
weight: 8
influxdb/v2.3/tags: [prometheus]
related:
  - https://prometheus.io/docs/concepts/data_model/, Prometheus data model
  - /influxdb/v2.3/write-data/developer-tools/scrape-prometheus-metrics/
...
| [InfluxDB scraper](/influxdb/v2.3/write-data/no-code/scrape-data/)                         |                                                     1 |
