...
Related entries: [line protocol](/influxdb/v2.3/reference/syntax/line-protocol/), [point](#point)
...
Learn how to [create a check](/influxdb/v2.3/monitor-alert/checks/create/).
...
For more detail, see [Annotated CSV](/influxdb/v2.3/reference/syntax/annotated-csv/).
...
- [annotated CSV](/influxdb/v2.3/reference/syntax/annotated-csv/)
- [extended annotated CSV](/influxdb/cloud/reference/syntax/annotated-csv/extended/#datatype)
- [line protocol](/influxdb/v2.3/reference/syntax/line-protocol/#data-types-and-format)
- [InfluxQL](/influxdb/v1.8/query_language/spec/#literals)
- [Flux](/influxdb/v2.3/reference/flux/language/types/)
- [InfluxDB](/influxdb/v2.3/reference/syntax/line-protocol/#data-types-and-format)
...
See [line protocol](/influxdb/v2.3/reference/syntax/line-protocol/).
...
Learn how to [create a notification endpoint](/influxdb/v2.3/monitor-alert/notification-endpoints/create).
...
Learn how to [create a notification rule](/influxdb/v2.3/monitor-alert/notification-rules/create).
...
In Flux, you can process data with [InfluxDB tasks](/influxdb/v2.3/process-data/get-started/).
...
See [Query data in InfluxDB](/influxdb/v2.3/query-data/).
...
See [Flux REPL](/influxdb/v2.3/tools/repl/) for information on building and using the REPL.
...
- [Manage buckets](/influxdb/v2.3/organizations/buckets/)
...
Generate a step-plot using the step [interpolation option for line graphs](/influxdb/v2.3/visualize-data/visualization-types/graph/#options).
...
For more information, see [Process Data with InfluxDB tasks](/influxdb/v2.3/process-data/).
...
Related entries: [Automatically configure Telegraf](/influxdb/v2.3/write-data/no-code/use-telegraf/auto-config/), [Manually configure Telegraf](/influxdb/v2.3/write-data/no-code/use-telegraf/manual-config/), [Telegraf plugins](/{{< latest "telegraf" >}}/plugins//), [Use Telegraf to collect data](/influxdb/v2.3/write-data/no-code/use-telegraf/), [View a Telegraf configuration](/influxdb/v2.3/telegraf-configs/view/)
...
To specify time when writing data, see [Elements of line protocol](/influxdb/v2.3/reference/syntax/line-protocol/#elements-of-line-protocol).
To specify time when querying data, see [Query InfluxDB with Flux](/influxdb/v2.3/query-data/get-started/query-influxdb/#2-specify-a-time-range).
...
Related entries: [Create a token](/influxdb/v2.3/security/tokens/create-token/).
...
Specify timestamp precision when [writing data to InfluxDB](/influxdb/v2.3/write-data/).
...
For information about how to window in Flux, see [Window and aggregate data with Flux](/influxdb/v2.3/query-data/flux/window-aggregate/).
