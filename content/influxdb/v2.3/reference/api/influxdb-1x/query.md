...
### epoch
Return results with [Unix timestamps](/influxdb/v2.3/reference/glossary/#unix-timestamp)
(also known as epoch timestamps) in the specified precision instead of
[RFC3339 timestamps](/influxdb/v2.3/reference/glossary/#rfc3339-timestamp) with nanosecond precision.
