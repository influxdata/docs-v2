...
weight: 101
aliases:
  - /influxdb/v2.3/reference/cli/influx/pkg/export/
related:
  - /influxdb/v2.3/influxdb-templates/create/
...
[Create an InfluxDB template](/influxdb/v2.3/influxdb-templates/create/)._
...
|:----------                                                 |:-----------                                                |
| [all](/influxdb/v2.3/reference/cli/influx/export/all/)     | Export all resources in an organization as a template      |
| [stack](/influxdb/v2.3/reference/cli/influx/export/stack/) | Export all resources associated with a stack as a template |
