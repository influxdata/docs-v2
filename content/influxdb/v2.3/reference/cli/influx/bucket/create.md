...
weight: 201
aliases:
  - /influxdb/v2.3/reference/cli/influx/bucket/create/
related:
  - /influxdb/v2.3/organizations/buckets/create-bucket/
...
The shard group duration must be shorter than the bucket's retention period. For more information, see [InfluxDB shards and shard groups](/influxdb/v2.3/reference/internals/shards/).
