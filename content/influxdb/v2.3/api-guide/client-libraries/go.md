...
influxdb/v2.3/tags: [client libraries, Go]
weight: 201
aliases:
  - /influxdb/v2.3/reference/api/client-libraries/go/
  - /influxdb/v2.3/tools/client-libraries/go/
---
...
2. Define variables for your InfluxDB [bucket](/influxdb/v2.3/organizations/buckets/), [organization](/influxdb/v2.3/organizations/), and [token](/influxdb/v2.3/security/tokens/).
...
1. Create a [point](/influxdb/v2.3/reference/glossary/#point) and write it to InfluxDB using the `WritePoint` method of the API writer struct.
