...
the [`influx template validate` command](/influxdb/v2.3/reference/cli/influx/template/validate/).
...
## Apply templates
Use the [`influx apply` command](/influxdb/v2.3/reference/cli/influx/apply/) to install templates
...
For more information, see [InfluxDB stacks](/influxdb/v2.3/influxdb-templates/stacks/).
{{% /note %}}
