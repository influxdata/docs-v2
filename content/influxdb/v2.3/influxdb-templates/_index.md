...
_See [Create an InfluxDB template](/influxdb/v2.3/influxdb-templates/create/) for information about
...
- [buckets](/influxdb/v2.3/organizations/buckets/create-bucket/)
- [checks](/influxdb/v2.3/monitor-alert/checks/create/)
- [dashboards](/influxdb/v2.3/visualize-data/dashboards/create-dashboard/)
- [dashboard variables](/influxdb/v2.3/visualize-data/variables/create-variable/)
- [labels](/influxdb/v2.3/visualize-data/labels/)
- [notification endpoints](/influxdb/v2.3/monitor-alert/notification-endpoints/create/)
- [notification rules](/influxdb/v2.3/monitor-alert/notification-rules/create/)
- [tasks](/influxdb/v2.3/process-data/manage-tasks/create-task/)
- [Telegraf configurations](/influxdb/v2.3/write-data/no-code/use-telegraf/)
