...
<a class="btn download" href="https://dl.influxdata.com/influxdb/releases/influxdb2-{{< latest-patch >}}.x86_64.amd" download >InfluxDB v{{< current-version >}} (Windows)</a>

Expand the downloaded archive into `C:\Program Files\InfluxData\` and rename the files if desired.

```powershell
> Expand-Archive .\influxdb2-{{< latest-patch >}}.x86_64.amd -DestinationPath 'C:\Program Files\InfluxData\'
