...
influxdb/v2.3/tags: [security, authentication, tls, https, ssl]
products: [oss]
---
...
[`tls-min-version`](/influxdb/v2.3/reference/config-options/#tls-min-version)
and
[`tls-strict-ciphers`](/influxdb/v2.3/reference/config-options/#tls-strict-ciphers).
