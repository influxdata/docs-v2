...
Use the [`influx auth active` command](/influxdb/v2.2/reference/cli/influx/auth/active)
to activate a token.
...
```
To get the current status of a token, use the JSON output of the [`influx auth list` command](/influxdb/v2.2/reference/cli/influx/auth/list).
...
Use the [`influx auth inactive` command](/influxdb/v2.2/reference/cli/influx/auth/active)
