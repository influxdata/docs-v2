...
weight: 102
influxdb/v2.3/tags: [templates, monitor]
aliases:
  - /influxdb/v2.3/influxdb-templates/monitor/
related:
...
- Command line access to a machine [running InfluxDB OSS 2.x](/influxdb/v2.3/install/) and permissions to install Telegraf on this machine
