...
aliases: 
  - /influxdb/v2.2/query-data/common-queries/count_unique_values_for_column/
...
{{% note %}}
These examples use [NOAA water sample data](/influxdb/v2.2/reference/sample-data/#noaa-water-sample-data).
{{% /note %}}
