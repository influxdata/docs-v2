...
Choose between [visualization types](/influxdb/v2.2/visualize-data/visualization-types/) for your query.
...
See [Get started with Flux](/influxdb/v2.2/query-data/get-started) to learn more about Flux.
...
2. Use the Flux builder in the bottom panel to create a Flux query:
   ...
   - Select **Group** from the **Filter** dropdown menu to group data into tables. For more about how grouping data in Flux works, see [Group data](/influxdb/v2.2/query-data/flux/group-data/).    
...
- Select an available [visualization types](/influxdb/v2.2/visualize-data/visualization-types/) from the dropdown menu in the upper-left:
