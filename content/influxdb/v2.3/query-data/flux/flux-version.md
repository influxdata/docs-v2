...
3.  Enable the **View Raw Data {{< icon "toggle" >}}** toggle or select one of the
    ...
    - [Single Stat](/influxdb/v2.3/visualize-data/visualization-types/single-stat/)
    - [Table](/influxdb/v2.3/visualize-data/visualization-types/table/)
...
- InfluxDB **host**, **organization**, and **API token**  
  ...
  [CLI configuration](/influxdb/v2.3/reference/cli/influx/#provide-required-authentication-credentials)
...
use the [`/api/v2/query` endpoint](/influxdb/v2.3/api/#tag/Query).
...
When you run `runtime.version()` in the [Flux REPL](/influxdb/v2.3/tools/repl/),
