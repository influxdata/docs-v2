...
influxdb/v2.3/tags: [query, percentile, quantile]
related:
  - /influxdb/v2.3/query-data/flux/query-median/
...
{{% note %}}
The examples below use the [example data variable](/influxdb/v2.3/query-data/flux/#example-data-variable).
{{% /note %}}
...
It is primarily used to [downsample data](/influxdb/v2.3/process-data/common-tasks/downsample-data/).
