...
influxdb/v2.3/tags: [functions, custom, flux]
menu:
  influxdb_2_3:
...
weight: 220
aliases:
  - /influxdb/v2.3/query-data/guides/custom-functions/
list_code_example: |
  ```js
...
function operations and variables inside of a [block (`{}`)](/influxdb/v2.3/reference/flux/language/blocks/)
