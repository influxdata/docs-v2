...
influxdb/v2.3/tags: [query, flux, sql]
menu:
  influxdb_2_3:
...
weight: 220
aliases:
  - /influxdb/v2.3/query-data/guides/sql/
related:
...
The [Flux](/influxdb/v2.3/reference/flux) `sql` package provides functions for working with SQL data sources.
...
Use `sql.from()` to [create dashboard variables](/influxdb/v2.3/visualize-data/variables/create-variable/)
...
If your SQL database requires authentication, use [InfluxDB secrets](/influxdb/v2.3/security/secrets/)
...
For added security, [store secrets in Vault](/influxdb/v2.3/security/secrets/use-vault/).

### Store your database credentials as secrets
Use the [InfluxDB API](/influxdb/v2.3/reference/api/) or the [`influx` CLI](/influxdb/v2.3/reference/cli/influx/secret/)
...
- [your organization ID](/influxdb/v2.3/organizations/view-orgs/#view-your-organization-id)  
- [your API token](/influxdb/v2.3/security/tokens/view-tokens/)
{{% /tab-content %}}
{{% tab-content %}}
```sh
# Syntax
...
1.  [Create a bucket](/influxdb/v2.3/organizations/buckets/create-bucket/) to store the data.
2.  [Create an InfluxDB task](/influxdb/v2.3/process-data/manage-tasks/create-task/)
...
3.  [Query your target bucket](/influxdb/v2.3/query-data/execute-queries/) after
...
_For information about importing a dashboard, see [Create a dashboard](/influxdb/v2.3/visualize-data/dashboards/create-dashboard)._
