...
weight: 208
aliases:
  - /influxdb/v2.3/query-data/guides/mathematic-operations/
related:
  ...
  - /influxdb/v2.3/query-data/flux/calculate-percentages/
...
<p style="font-size:.85rem;font-style:italic;margin-top:-2rem;">See <a href="/influxdb/v2.3/tools/repl/">Flux Read-Eval-Print Loop (REPL)</a>.</p>
...
Flux lets you [create custom functions](/influxdb/v2.3/query-data/flux/custom-functions) that use mathematic operations.
...
- [Handle piped-forward data](/influxdb/v2.3/query-data/flux/custom-functions/#use-piped-forward-data-in-a-custom-function).
...
_For an in-depth look at calculating percentages, see [Calculate percentages](/influxdb/v2.3/query-data/flux/calculate-percentages)._
