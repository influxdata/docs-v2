...
The name of the [measurement](/influxdb/v1.6/concepts/glossary/#measurement)
...
See the [API Reference](/influxdb/v1.6/tools/api/#write-http-endpoint) for more information.
...
See the [API Reference](/influxdb/v1.6/tools/api/#write-http-endpoint) for how to specify
...
and more examples, see the [API Reference](/influxdb/v1.6/tools/api/#write-http-endpoint).
...
on the [HTTP API](/influxdb/v1.6/tools/api/#write-http-endpoint), the
