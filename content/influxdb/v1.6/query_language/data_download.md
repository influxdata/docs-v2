...
menu:
  influxdb_1_6:
    ...
    parent: InfluxQL
aliases:
  - /influxdb/v1.6/sample_data/data_download/
---
...
From your terminal, download the text file that contains the data in [line protocol](/influxdb/v1.6/concepts/glossary/#line-protocol) format:
```
