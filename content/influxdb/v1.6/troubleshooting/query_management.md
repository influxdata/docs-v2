...
- `qid`&emsp;&emsp;&emsp;&nbsp;The id number of the query. Use this value with [`KILL - QUERY`](/influxdb/v1.6/troubleshooting/query_management/#stop-currently-running-queries-with-kill-query).  
...
See [Query Language Reference](/influxdb/v1.6/query_language/spec/#durations)
...
This setting is a [duration literal](/influxdb/v1.6/query_language/spec/#durations).
...
Use this value with [`KILL QUERY`](/influxdb/v1.6/troubleshooting/query_management/#stop-currently-running-queries-with-kill-query).
