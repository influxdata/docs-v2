...
For more information about sizing requirements for InfluxDB Enterprise, see [InfluxDB Enterprise hardware sizing guidelines](https://docs.influxdata.com/enterprise_influxdb/v1.8/guides/hardware_sizing/).
