...
Check out the [glossary of terms](/influxdb/v1.5/concepts/glossary/) if you prefer the cold, hard facts.
...
To optimize your queries, it may be beneficial to rearrange your [schema](/influxdb/v1.5/concepts/glossary/#schema) such that the fields (`butterflies` and `honeybees`) become the tags and the tags (`location` and `scientist`) become the fields:
...
If you're interested in reading more about retention policies, check out [Database Management](/influxdb/v1.5/query_language/database_management/#retention-policy-management).
...
Understanding the concept of a series is essential when designing your [schema](/influxdb/v1.5/concepts/glossary/#schema) and when working with your data in InfluxDB.
...
See [Authentication and Authorization](/influxdb/v1.5/query_language/authentication_and_authorization/) and [Continuous Queries](/influxdb/v1.5/query_language/continuous_queries/) for more on those topics.
