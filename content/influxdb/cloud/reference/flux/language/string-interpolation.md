...
To use Flux string interpolation, enclose embedded [expressions](/influxdb/cloud/reference/flux/language/expressions/)
...
[Records](/influxdb/cloud/reference/flux/language/expressions/#record-literals) consist of key-value pairs.
Use [dot notation](/influxdb/cloud/reference/flux/language/expressions/#member-expressions)
