...
aliases:
  - /influxdb/cloud/reference/flux/functions/transformations/selectors/lowestcurrent
  - /influxdb/cloud/reference/flux/functions/built-in/transformations/selectors/lowestcurrent/
menu:
  influxdb_cloud_ref:
    name: lowestCurrent
