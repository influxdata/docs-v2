...
aliases:
  - /influxdb/cloud/reference/flux/functions/built-in/transformations/aggregates/reduce/
menu:
  influxdb_cloud_ref:
    name: reduce
...
related:
  - /influxdb/cloud/query-data/flux/custom-functions/custom-aggregate/
...
1. Are not part of the input table's [group key](/influxdb/cloud/reference/glossary/#group-key).
