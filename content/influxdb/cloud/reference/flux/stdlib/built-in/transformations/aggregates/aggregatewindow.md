...
aliases:
  - /influxdb/cloud/reference/flux/functions/transformations/aggregates/aggregatewindow
  - /influxdb/cloud/reference/flux/functions/built-in/transformations/aggregates/aggregatewindow/
menu:
  influxdb_cloud_ref:
