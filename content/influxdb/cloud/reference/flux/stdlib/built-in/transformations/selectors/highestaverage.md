...
aliases:
  - /influxdb/cloud/reference/flux/functions/transformations/selectors/highestaverage
  - /influxdb/cloud/reference/flux/functions/built-in/transformations/selectors/highestaverage/
menu:
  influxdb_cloud_ref:
    name: highestAverage
