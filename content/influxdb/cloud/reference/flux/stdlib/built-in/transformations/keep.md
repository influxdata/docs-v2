...
aliases:
  - /influxdb/cloud/reference/flux/functions/transformations/keep
  - /influxdb/cloud/reference/flux/functions/built-in/transformations/keep/
menu:
  influxdb_cloud_ref:
    name: keep
...
_It is the inverse of [`drop`](/influxdb/cloud/reference/flux/stdlib/built-in/transformations/drop)._
