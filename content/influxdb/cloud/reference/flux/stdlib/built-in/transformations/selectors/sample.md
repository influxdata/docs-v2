...
aliases:
  - /influxdb/cloud/reference/flux/functions/transformations/selectors/sample
  - /influxdb/cloud/reference/flux/functions/built-in/transformations/selectors/sample/
menu:
  influxdb_cloud_ref:
    name: sample
