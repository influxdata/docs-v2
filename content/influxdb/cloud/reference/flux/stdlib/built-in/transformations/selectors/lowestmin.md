...
aliases:
  - /influxdb/cloud/reference/flux/functions/transformations/selectors/lowestmin
  - /influxdb/cloud/reference/flux/functions/built-in/transformations/selectors/lowestmin/
menu:
  influxdb_cloud_ref:
    name: lowestMin
