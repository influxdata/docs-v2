...
aliases:
  - /influxdb/cloud/reference/flux/functions/transformations/selectors/highestmax
  - /influxdb/cloud/reference/flux/functions/built-in/transformations/selectors/highestmax/
menu:
  influxdb_cloud_ref:
    name: highestMax
