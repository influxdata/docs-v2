...
aliases:
  - /influxdb/cloud/reference/flux/functions/built-in/transformations/aggregates/kaufmansama/
  - /influxdb/cloud/reference/flux/stdlib/built-in/transformations/aggregates/kaufmansama/
menu:
  influxdb_cloud_ref:
    name: kaufmansAMA
