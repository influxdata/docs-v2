...
aliases:
  - /influxdb/cloud/reference/flux/functions/transformations/group
  - /influxdb/cloud/reference/flux/functions/built-in/transformations/group/
menu:
  influxdb_cloud_ref:
    name: group
...
To ensure data is sorted correctly, use [`sort()`](/influxdb/cloud/reference/flux/stdlib/built-in/transformations/sort/)
after `group()`.
