...
aliases:
  - /influxdb/cloud/reference/flux/functions/transformations/selectors/unique
  - /influxdb/cloud/reference/flux/functions/built-in/transformations/selectors/unique/
menu:
  influxdb_cloud_ref:
    name: unique
