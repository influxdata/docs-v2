...
aliases:
  - /influxdb/cloud/reference/flux/functions/built-in/transformations/aggregates/doubleema/
  - /influxdb/cloud/reference/flux/stdlib/built-in/transformations/aggregates/doubleema/
menu:
  influxdb_cloud_ref:
    name: doubleEMA
...
data at double the rate of [`exponentialMovingAverage()`](/influxdb/cloud/reference/flux/stdlib/built-in/transformations/exponentialmovingaverage/).
...
- `doubleEMA()` inherits all [exponential moving average rules](/influxdb/cloud/reference/flux/stdlib/built-in/transformations/exponentialmovingaverage/#exponential-moving-average-rules).
