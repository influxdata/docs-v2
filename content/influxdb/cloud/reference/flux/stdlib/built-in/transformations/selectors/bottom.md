...
aliases:
  - /influxdb/cloud/reference/flux/functions/transformations/selectors/bottom
  - /influxdb/cloud/reference/flux/functions/built-in/transformations/selectors/bottom/
menu:
  influxdb_cloud_ref:
    name: bottom
