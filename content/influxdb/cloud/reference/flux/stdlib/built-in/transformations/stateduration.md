...
aliases:
  - /influxdb/cloud/reference/flux/functions/transformations/stateduration
  - /influxdb/cloud/reference/flux/functions/built-in/transformations/stateduration/
menu:
  influxdb_cloud_ref:
    name: stateDuration
...
weight: 402
related:
  - /influxdb/cloud/query-data/flux/monitor-states/
