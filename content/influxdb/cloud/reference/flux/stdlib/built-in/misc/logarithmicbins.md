...
aliases:
  - /influxdb/cloud/reference/flux/functions/misc/logarithmicbins
  - /influxdb/cloud/reference/flux/functions/built-in/misc/logarithmicbins/
menu:
  influxdb_cloud_ref:
...
[`histogram()` function](/influxdb/cloud/reference/flux/stdlib/built-in/transformations/histogram).
