...
aliases:
  - /influxdb/cloud/reference/flux/functions/misc/intervals
  - /influxdb/cloud/reference/flux/functions/built-in/misc/intervals/
...
of the [`window()` function](/influxdb/cloud/reference/flux/stdlib/built-in/transformations/window).
{{% /note %}}
