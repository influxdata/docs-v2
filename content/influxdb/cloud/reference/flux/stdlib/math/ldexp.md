...
aliases:
  - /influxdb/cloud/reference/flux/functions/math/ldexp/
menu:
  influxdb_cloud_ref:
    name: math.ldexp
    parent: Math
...
The `math.ldexp()` function is the inverse of [`math.frexp()`](/influxdb/cloud/reference/flux/stdlib/math/frexp).
