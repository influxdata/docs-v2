...
The `influx write` command writes data to InfluxDB via stdin or from a specified file.
Write data using [line protocol](/influxdb/cloud/reference/syntax/line-protocol) or
...
|:----------                                        |:-----------                         |
| [dryrun](/influxdb/cloud/reference/cli/influx/write/dryrun) | Write to stdout instead of InfluxDB |
