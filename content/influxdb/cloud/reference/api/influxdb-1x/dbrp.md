...
related:
  ...
  - /influxdb/cloud/api/#tag/DBRPs, InfluxDB 2.0 API /dbrps endpoint
aliases:
...
InfluxDB 2.0 replaces both with [buckets](/influxdb/cloud/reference/glossary/#bucket).
...
[compatibility API](/influxdb/cloud/reference/api/influxdb-1x/) requests to route operations to a bucket.
...
### When writing data
When writing data to InfluxDB 2.0 using the [`/write` compatibility endpoint](/influxdb/cloud/reference/api/influxdb-1x/write/),
...
### When querying data
When querying data from InfluxDB 2.0 using the [`/query` compatibility endpoint](/influxdb/cloud/reference/api/influxdb-1x/query/),
...
Use the using the [`/api/v2/dbrps` API endpoint](/influxdb/cloud/api/#tag/DBRPs) to
manually create and manage DBRP mappings.
...
_For more information, see the [`/api/v2/dbrps` endpoint documentation](/influxdb/cloud/api/#tag/DBRPs)._
