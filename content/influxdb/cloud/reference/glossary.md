...
For a list of available aggregation functions, see [Flux built-in aggregate functions](/influxdb/cloud/reference/flux/stdlib/built-in/transformations/aggregates/).
...
Related entries: [line protocol](/influxdb/cloud/reference/syntax/line-protocol/), [point](#point)
...
In [annotated CSV](/influxdb/cloud/reference/syntax/annotated-csv/), columns that contain
...
Learn how to [create a check](/influxdb/cloud/monitor-alert/checks/create/).
...
For more detail, see [Annotated CSV](/influxdb/cloud/reference/syntax/annotated-csv/).
...
For a complete list of Flux functions, see [Flux functions](/influxdb/cloud/reference/flux/stdlib/all-functions/).
...
For examples and rules, see [Flux language lexical elements](/influxdb/cloud/reference/flux/language/lexical-elements/#identifiers).
...
See a list of [Flux keywords](/influxdb/cloud/reference/flux/language/lexical-elements/#keywords).
...
See examples of [Flux literals](/influxdb/cloud/reference/flux/language/expressions/#examples-of-function-literals).
...
See [line protocol](/influxdb/cloud/reference/syntax/line-protocol/).
...
The Flux data model includes [Missing values (null)](/influxdb/cloud/reference/flux/language/data-model/#missing-values-null).
...
Learn how to [create a notification endpoint](/influxdb/cloud/monitor-alert/notification-endpoints/create).
...
Learn how to [create a notification rule](/influxdb/cloud/monitor-alert/notification-rules/create).
...
See built-in Flux [options](/influxdb/cloud/reference/flux/language/options/).

### option assignment

An option assignment binds an identifier to an option.

Learn about the [option assignment](/influxdb/cloud/reference/flux/language/assignment-scope/#option-assignment) in Flux.
...
In Flux, you can process data with [InfluxDB tasks](/influxdb/cloud/process-data/get-started/).
...
See [Query data in InfluxDB](/influxdb/cloud/query-data/).
...
See [Flux REPL](/influxdb/cloud/tools/repl/) for information on building and using the REPL.
...
See [Flux built-in selector functions](/influxdb/cloud/reference/flux/stdlib/built-in/transformations/selectors/) for a complete list of available built-in selector functions.
...
A file created and used by the [InfluxDB storage engine](/influxdb/cloud/reference/internals/storage-engine/)
...
Generate a step-plot using the step [interpolation option for line graphs](/influxdb/cloud/visualize-data/visualization-types/graph/#options).
...
For more information, see [Process Data with InfluxDB tasks](/influxdb/cloud/process-data/).
...
Related entries: [Automatically configure Telegraf](/influxdb/cloud/write-data/no-code/use-telegraf/auto-config/), [Manually configure Telegraf](/influxdb/cloud/write-data/no-code/use-telegraf/manual-config/), [Telegraf plugins](/{{< latest "telegraf" >}}/plugins//), [Use Telegraf to collect data](/influxdb/cloud/write-data/no-code/use-telegraf/), [View a Telegraf configuration](/influxdb/cloud/telegraf-configs/view/)
...
To specify time when writing data, see [Elements of line protocol](/influxdb/cloud/reference/syntax/line-protocol/#elements-of-line-protocol).
To specify time when querying data, see [Query InfluxDB with Flux](/influxdb/cloud/query-data/get-started/query-influxdb/#2-specify-a-time-range).
...
Related entries: [Create a token](/influxdb/cloud/security/tokens/create-token/).

### tracing

By default, tracing is disabled in InfluxDB.
To enable tracing or set other InfluxDB configuration options, see [InfluxDB configuration options](/influxdb/cloud/reference/config-options/).
...
Specify timestamp precision when [writing data to InfluxDB](/influxdb/cloud/write-data/).
...
For information about how to window in Flux, see [Window and aggregate data with Flux](/influxdb/cloud/query-data/flux/window-aggregate/).
