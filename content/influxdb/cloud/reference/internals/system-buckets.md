...
For more information, see [InfluxDB key concepts](/influxdb/cloud/reference/key-concepts/data-elements/).
{{% /note %}}

## \_monitoring system bucket
The `_monitoring` system bucket stores InfluxDB data used to
[monitor data and send alerts](/influxdb/cloud/monitor-alert/).
...
The `_tasks` system bucket stores data related to [InfluxDB task](/influxdb/cloud/process-data/) executions.
