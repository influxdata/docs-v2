...
### Features
- Add [Opsgenie package](/influxdb/cloud/reference/flux/stdlib/contrib/opsgenie/).
- Implement [`lastSuccess()`](/influxdb/cloud/reference/flux/stdlib/influxdb-tasks/lastsuccess/) in the `tasks` package.
...
- Add [BigQuery](https://cloud.google.com/bigquery) support to
  [`sql` package](/influxdb/cloud/reference/flux/stdlib/sql/).
...
- Update [`integral()`](/influxdb/cloud/reference/flux/stdlib/built-in/transformations/aggregates/integral/)
...
### Features
- Add [`tasks.lastSuccess` function](/influxdb/cloud/reference/flux/stdlib/influxdb-tasks/lastsuccess/)
...
### Features
- Add the [`profiler` package](/influxdb/cloud/reference/flux/stdlib/profiler/).
...
- Extend with Geo package with GIS functions and
  [unit support](/influxdb/cloud/reference/flux/stdlib/experimental/geo/#distance-units).
...
### Features
- Add a faster [`map()` function](/influxdb/cloud/reference/flux/stdlib/contrib/rows/map/) _(user-contributed)_.
- Add an [`influxdb.select()` function](/influxdb/cloud/reference/flux/stdlib/contrib/influxdb/select/) _(user-contributed)_.
...
- Add [`http.pathEscape()` function](/influxdb/cloud/reference/flux/stdlib/http/pathescape/).
...
- Add [Microsoft Teams package](/influxdb/cloud/reference/flux/stdlib/contrib/teams/).
- Evaluate and store `now` in execution dependencies for `tableFind()`.
- Add `Timeable` constraint for time and duration types.
- Add [SQL Server support](/influxdb/cloud/reference/flux/stdlib/sql/from/#query-a-sql-server-database) to `sql` package.
- Add [Telegram package](/influxdb/cloud/reference/flux/stdlib/contrib/telegram/).
- Add [Amazon Athena support](/influxdb/cloud/reference/flux/stdlib/sql/from/#query-an-amazon-athena-database) to `sql` package.
...
- Flux test for [experimental `json.parse()`](/influxdb/cloud/reference/flux/stdlib/experimental/json/parse/).
...
### Features
- Add [Discord package](/influxdb/cloud/reference/flux/stdlib/contrib/discord/)
  _(contributed by [@chobbs](https://github.com/chobbs))_.
- Add [`json.parse()` function](/influxdb/cloud/reference/flux/stdlib/experimental/json/parse/).
...
## Features
- Add [`fieldKeys()`](/influxdb/cloud/reference/flux/stdlib/influxdb-v1/fieldkeys/) and
  [`measurementFieldKeys()`](/influxdb/cloud/reference/flux/stdlib/influxdb-v1/measurementfieldkeys/)
  to v1 package.
- Add a context to `plantest.RuleTestCase`.
- Add Snowflake support to SQL package.
- Add [`experimental.chain()`](/influxdb/cloud/reference/flux/stdlib/experimental/chain/) function.
- Add semantic nodes for bad statement and bad expression.
- Add [`findColumn()`](/influxdb/cloud/reference/flux/stdlib/built-in/transformations/stream-table/findcolumn/)
  and [`findRecord()`](/influxdb/cloud/reference/flux/stdlib/built-in/transformations/stream-table/findrecord/) functions.
...
### Features
- Add [`epsilon` parameter](/influxdb/cloud/reference/flux/stdlib/testing/diff/#epsilon) to `testing.diff()`.
- Add [`experimental.alignTime()` function](/influxdb/cloud/reference/flux/stdlib/experimental/aligntime/).
- Add random access group lookup.
- Add [Pushbullet package](/influxdb/cloud/reference/flux/stdlib/pushbullet/).
...
### Features
- Add [`experimental.join()`](/influxdb/cloud/reference/flux/stdlib/experimental/join/) function.
- Store comments in the AST and preserve on format.
- Add [`shapeData()`](/influxdb/cloud/reference/flux/stdlib/experimental/geo/shapedata/) function to Geo package.
...
- Add stream table index functions (
  [`tableFind()`](/influxdb/cloud/reference/flux/stdlib/built-in/transformations/stream-table/tablefind/),
  [`getRecord()`](/influxdb/cloud/reference/flux/stdlib/built-in/transformations/stream-table/getrecord/),
  [`getColumn()`](/influxdb/cloud/reference/flux/stdlib/built-in/transformations/stream-table/getcolumn/)
  ).
