...
The InfluxDB `/delete` endpoint uses an InfluxQL-like predicate syntax to determine
what data [points](/influxdb/cloud/reference/glossary/#point) to delete.
InfluxDB uses the delete predicate to evaluate the [series keys](/influxdb/cloud/reference/glossary/#series-key)
...
A delete predicate is comprised of one or more [predicate expressions](/influxdb/cloud/reference/glossary/#predicate-expression).
