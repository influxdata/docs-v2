...
Extended annotated CSV supports all [Annotated CSV](/influxdb/cloud/reference/syntax/annotated-csv/)
annotations.

{{% warn %}}
The Flux [`csv.from` function](/influxdb/cloud/reference/flux/stdlib/csv/from/) only supports
...
- [timestamp](/influxdb/cloud/reference/syntax/line-protocol/#timestamp) _(Optional but recommended)_
- [tag set](/influxdb/cloud/reference/syntax/line-protocol/#tag-set) _(Optional)_
...
### datatype
Use the `#datatype` annotation to specify the [line protocol element](/influxdb/cloud/reference/syntax/line-protocol/#elements-of-line-protocol)
a column represents.
...
The `influx write` command converts timestamps to [Unix timestamps](/influxdb/cloud/reference/glossary/#unix-timestamp).
...
use the [`influx write --precision` flag](/influxdb/cloud/reference/cli/influx/write/#flags)
to specify the [timestamp precision](/influxdb/cloud/reference/glossary/#precision).
{{% /note %}}
...
see [Line protocol data types and formats](/influxdb/cloud/reference/syntax/line-protocol/#data-types-and-format).
...
##### string
Column is a **[string](/influxdb/cloud/reference/glossary/#string) field**.

##### double
Column is a **[float](/influxdb/cloud/reference/glossary/#float) field**.
...
##### long
Column is an **[integer](/influxdb/cloud/reference/glossary/#integer) field**.
...
##### unsignedLong
Column is an **[unsigned integer (uinteger)](/influxdb/cloud/reference/glossary/#unsigned-integer) field**.
If column values contain separators such as periods (`.`) or commas (`,`), specify
...
##### boolean
Column is a **[boolean](/influxdb/cloud/reference/glossary/#boolean) field**.
If column values are not [supported boolean values](/influxdb/cloud/reference/syntax/line-protocol/#boolean),
...
[line protocol elements](/influxdb/cloud/reference/syntax/line-protocol/#elements-of-line-protocol)
