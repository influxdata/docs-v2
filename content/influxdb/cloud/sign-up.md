...
<a class="btn download" href="https://dl.influxdata.com/influxdb/releases/influxdb2-client-{{< latest-cli cli=true >}}-linux-amd64.tar.gz" download >influx CLI (amd64)</a>
<a class="btn download" href="https://dl.influxdata.com/influxdb/releases/influxdb2-client-{{< latest-cli cli=true >}}-linux-arm64.tar.gz" download >influx CLI (arm)</a>
...
```sh
# Unpackage contents to the current working directory
tar xvfz influxdb2-client-{{< latest-cli cli=true >}}-linux-amd64.tar.gz
```
...
sudo cp influxdb2-client-{{< latest-cli cli=true >}}-linux-amd64/influx /usr/local/bin/
```
