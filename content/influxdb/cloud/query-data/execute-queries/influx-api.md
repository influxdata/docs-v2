...
The [InfluxDB v2 API](/influxdb/cloud/reference/api) provides a programmatic interface for all interactions with InfluxDB. To query InfluxDB 2.0, do one of the following:

- Send a Flux query request to the [`/api/v2/query`](/influxdb/cloud/api/#operation/PostQueryAnalyze) endpoint.
- Send an InfluxQL query request to the [/query 1.x compatibility API](/influxdb/cloud/reference/api/influxdb-1x/query/).
