...
Cacluated values are returned as [floats](/influxdb/cloud/reference/flux/language/types/#numeric-types).
...
Use the [`aggregate.rate()` function](/influxdb/cloud/reference/flux/stdlib/experimental/aggregate/rate/)
to calculate the average rate of change per window of time.
...
`aggregate.rate()` returns the average rate of change (as a [float](/influxdb/cloud/reference/flux/language/types/#numeric-types))
