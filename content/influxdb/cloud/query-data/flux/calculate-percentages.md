...
weight: 209
aliases:
 - /influxdb/cloud/query-data/guides/calculate-percentages/
related:
...
1. Use [`from()`](/influxdb/cloud/reference/flux/stdlib/built-in/inputs/from/),
   [`range()`](/influxdb/cloud/reference/flux/stdlib/built-in/transformations/range/) and
   [`filter()`](/influxdb/cloud/reference/flux/stdlib/built-in/transformations/filter/) to query operands.
2. Use [`pivot()` or `join()`](/influxdb/cloud/query-data/flux/mathematic-operations/#pivot-vs-join)
   to align operand values into rows.
3. Use [`map()`](/influxdb/cloud/reference/flux/stdlib/built-in/transformations/map/)
...
_See [Pivot vs join](/influxdb/cloud/query-data/flux/mathematic-operations/#pivot-vs-join)._
{{% /note %}}
...
1. Ensure measurements are in the same [bucket](/influxdb/cloud/reference/glossary/#bucket).
