...
weight: 210
aliases:
  - /influxdb/cloud/query-data/guides/histograms/
related:
...
The [`histogram()` function](/influxdb/cloud/reference/flux/stdlib/built-in/transformations/histogram) approximates the
...
### linearBins()
The [`linearBins()` function](/influxdb/cloud/reference/flux/stdlib/built-in/misc/linearbins) generates a list of linearly separated floats.
...
### logarithmicBins()
The [`logarithmicBins()` function](/influxdb/cloud/reference/flux/stdlib/built-in/misc/logarithmicbins) generates a list of exponentially separated floats.
...
The [Histogram visualization type](/influxdb/cloud/visualize-data/visualization-types/histogram/)
...
Use the [Histogram visualization controls](/influxdb/cloud/visualize-data/visualization-types/histogram/#histogram-controls)
