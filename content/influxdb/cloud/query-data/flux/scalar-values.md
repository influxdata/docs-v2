...
aliases:
  - /influxdb/cloud/query-data/guides/scalar-values/
list_code_example: |
  ```js
  scalarValue = {
    _record =
...
Use Flux [stream and table functions](/influxdb/cloud/reference/flux/stdlib/built-in/transformations/stream-table/)
...
- The InfluxDB user interface (UI) does not currently support raw scalar output.
  Use [`map()`](/influxdb/cloud/reference/flux/stdlib/built-in/transformations/map/) to add
  scalar values to output data.
{{% /warn %}}

## Table extraction
Flux formats query results as a stream of tables.
Both [`findColumn()`](/influxdb/cloud/reference/flux/stdlib/built-in/transformations/stream-table/findcolumn/)
and [`findRecord()`](/influxdb/cloud/reference/flux/stdlib/built-in/transformations/stream-table/findrecord/)
extract the first table in a stream of tables whose [group key](/influxdb/cloud/reference/glossary/#group-key)
values match the `fn` [predicate function](/influxdb/cloud/reference/glossary/#predicate-function).
...
## Extract a column
Use the [`findColumn()` function](/influxdb/cloud/reference/flux/stdlib/built-in/transformations/stream-table/findcolumn/)
...
## Extract a row
Use the [`findRecord()` function](/influxdb/cloud/reference/flux/stdlib/built-in/transformations/stream-table/findrecord/)
...
Use [dot notation](/influxdb/cloud/query-data/get-started/syntax-basics/#records) to reference
keys in the record.
...
It's formatted in [annotated CSV](/influxdb/cloud/reference/syntax/annotated-csv/) and imported
into the Flux query using the [`csv.from()` function](/influxdb/cloud/reference/flux/stdlib/csv/from/).
