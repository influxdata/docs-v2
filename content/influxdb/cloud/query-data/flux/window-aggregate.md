...
aliases:
  - /influxdb/cloud/query-data/guides/window-aggregate/
related:
...
## Windowing data
Use the [`window()` function](/influxdb/cloud/reference/flux/stdlib/built-in/transformations/window)
...
{{% note %}}
The `every` parameter supports all [valid duration units](/influxdb/cloud/reference/flux/language/types/#duration-types),
...
## Aggregate data
[Aggregate functions](/influxdb/cloud/reference/flux/stdlib/built-in/transformations/aggregates) take the values
...
For this example, use the [`mean()` function](/influxdb/cloud/reference/flux/stdlib/built-in/transformations/aggregates/mean)
...
Use the [`duplicate()` function](/influxdb/cloud/reference/flux/stdlib/built-in/transformations/duplicate) to
...
Flux also provides the [`aggregateWindow()` function](/influxdb/cloud/reference/flux/stdlib/built-in/transformations/aggregates/aggregatewindow)
