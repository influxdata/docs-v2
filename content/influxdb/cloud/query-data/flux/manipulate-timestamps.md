...
weight: 220
aliases:
  - /influxdb/cloud/query-data/guides/manipulate-timestamps/
related:
...
Use the [`time()` function](/influxdb/cloud/reference/flux/stdlib/built-in/transformations/type-conversions/time/)
to convert a [Unix **nanosecond** timestamp](/influxdb/cloud/reference/glossary/#unix-timestamp)
to an [RFC3339 timestamp](/influxdb/cloud/reference/glossary/#rfc3339-timestamp).
...
Use the [`uint()` function](/influxdb/cloud/reference/flux/stdlib/built-in/transformations/type-conversions/uint/)
...
Flux doesn't support mathematical operations using [time type](/influxdb/cloud/reference/flux/language/types/#time-types) values.
...
To store a duration in a column, use the [`string()` function](/influxdb/cloud/reference/flux/stdlib/built-in/transformations/type-conversions/string/)
...
### Current UTC time
Use the [`now()` function](/influxdb/cloud/reference/flux/stdlib/built-in/misc/now/) to
...
### Current system time
Import the `system` package and use the [`system.time()` function](/influxdb/cloud/reference/flux/stdlib/system/time/)
...
with the [`truncateTimeColumn()` function](/influxdb/cloud/reference/flux/stdlib/built-in/transformations/truncatetimecolumn/).
This is useful in [`join()`](/influxdb/cloud/reference/flux/stdlib/built-in/transformations/join/)
and [`pivot()`](/influxdb/cloud/reference/flux/stdlib/built-in/transformations/pivot/)
...
The [`experimental.addDuration()` function](/influxdb/cloud/reference/flux/stdlib/experimental/addduration/)
adds a duration to a specified time and returns the resulting time.

{{% warn %}}
By using `experimental.addDuration()`, you accept the
[risks of experimental functions](/influxdb/cloud/reference/flux/stdlib/experimental/#use-experimental-functions-at-your-own-risk).
{{% /warn %}}
...
The [`experimental.subDuration()` function](/influxdb/cloud/reference/flux/stdlib/experimental/subduration/)
