...
[`sort()` function](/influxdb/cloud/reference/flux/stdlib/built-in/transformations/sort/)
...
Use `first()` and `last()` with [`aggregateWindow()`](/influxdb/cloud/reference/flux/stdlib/built-in/transformations/aggregates/aggregatewindow/)
