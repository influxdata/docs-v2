...
weight: 220
aliases:
  - /influxdb/cloud/query-data/guides/sql/
related:
...
The [Flux](/influxdb/cloud/reference/flux) `sql` package provides functions for working with SQL data sources.
[`sql.from()`](/influxdb/cloud/reference/flux/stdlib/sql/from/) lets you query SQL data sources
...
see [SQL Server ADO authentication](/influxdb/cloud/reference/flux/stdlib/sql/from/#sql-server-ado-authentication)._
{{% /code-tab-content %}}
...
see [Athena connection string](/influxdb/cloud/reference/flux/stdlib/sql/from/#athena-connection-string)._
{{% /code-tab-content %}}
{{% code-tab-content %}}
```js
import "sql"
...
[BigQuery authentication parameters](/influxdb/cloud/reference/flux/stdlib/sql/from/#bigquery-authentication-parameters)._
{{% /code-tab-content %}}
{{< /code-tabs-wrapper >}}

_See the [`sql.from()` documentation](/influxdb/cloud/reference/flux/stdlib/sql/from/) for
...
Use `sql.from()` to [create dashboard variables](/influxdb/cloud/visualize-data/variables/create-variable/)
...
If your SQL database requires authentication, use [InfluxDB secrets](/influxdb/cloud/security/secrets/)
...
For added security, [store secrets in Vault](/influxdb/cloud/security/secrets/use-vault/).

### Store your database credentials as secrets
Use the [InfluxDB API](/influxdb/cloud/reference/api/) or the [`influx` CLI](/influxdb/cloud/reference/cli/influx/secret/)
...
{{% tab-content %}}
```sh
curl -X PATCH https://cloud2.influxdata.com/api/v2/orgs/<org-id>/secrets \
...
- [your organization ID](/influxdb/cloud/organizations/view-orgs/#view-your-organization-id)  
- [your authentication token](/influxdb/cloud/security/tokens/view-tokens/)
{{% /tab-content %}}
{{% tab-content %}}
```sh
# Syntax
...
Import the `influxdata/influxdb/secrets` package and use [string interpolation](/influxdb/cloud/reference/flux/language/string-interpolation/)
...
1. [Create a bucket](/influxdb/cloud/organizations/buckets/create-bucket/) to store the data.
...
4. Start the generator. Specify your organization, bucket, and authorization token.
  _For information about retrieving your token, see [View tokens](/influxdb/cloud/security/tokens/view-tokens/)._
...
5. [Query your target bucket](/influxdb/cloud/query-data/execute-queries/) to ensure the
...
_For information about importing a dashboard, see [Create a dashboard](/influxdb/cloud/visualize-data/dashboards/create-dashboard/#create-a-new-dashboard)._
