...
Use the [Flux Geo package](/influxdb/cloud/reference/flux/stdlib/experimental/geo) to
...
By using it, you agree to the [risks of experimental functions](/influxdb/cloud/reference/flux/stdlib/experimental/#use-experimental-functions-at-your-own-risk).
{{% /warn %}}
...
[requirements of the Flux Geo package](/influxdb/cloud/reference/flux/stdlib/experimental/geo/#geo-schema-requirements).

### Load annotated CSV sample data
Use the [experimental `csv.from()` function](/influxdb/cloud/reference/flux/stdlib/experimental/csv/from/)
...
If bandwidth is a concern, use the [`to()` function](/influxdb/cloud/reference/flux/stdlib/built-in/outputs/to/)
to write the data to a bucket, and then query the bucket with [`from()`](/influxdb/cloud/reference/flux/stdlib/built-in/inputs/from/).
{{% /note %}}
