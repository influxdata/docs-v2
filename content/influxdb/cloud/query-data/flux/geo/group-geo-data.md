...
### Group data by area
Use the [`geo.groupByArea()` function](/influxdb/cloud/reference/flux/stdlib/experimental/geo/groupbyarea/)
...
The following example uses the [sample bird migration data](/influxdb/cloud/query-data/flux/geo/#sample-data)
...
Use [`geo.asTracks()` function](/influxdb/cloud/reference/flux/stdlib/experimental/geo/astracks/)
