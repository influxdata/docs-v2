...
weight: 210
aliases:
  - /influxdb/cloud/query-data/guides/join/
related:
  - /influxdb/cloud/reference/flux/stdlib/built-in/transformations/join
list_query_example: join
---

The [`join()` function](/influxdb/cloud/reference/flux/stdlib/built-in/transformations/join) merges two or more
...
[`map()` function](/influxdb/cloud/reference/flux/stdlib/built-in/transformations/map)
