...
You can pass queries to the [`influx query` command](/influxdb/cloud/reference/cli/influx/query)
...
## InfluxDB API
The [InfluxDB v2 API](/influxdb/cloud/reference/api) provides a programmatic
...
{{% code-tab-content %}}
```bash
curl https://cloud2.influxdata.com/api/v2/query?org=my-org -XPOST -sS \
