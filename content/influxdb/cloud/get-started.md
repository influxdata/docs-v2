...
<a class="btn download" href="https://dl.influxdata.com/influxdb/releases/influxdb_client_2.0.0_darwin_amd64.tar.gz" download>influx CLI (macOS)</a>
...
tar zxvf ~/Downloads/influxdb_client_2.0.0_darwin_amd64.tar.gz
```
...
sudo cp influxdb_client_2.0.0_darwin_amd64/influx /usr/local/bin/
```
...
<a class="btn download" href="https://dl.influxdata.com/influxdb/releases/influxdb_client_2.0.0_linux_amd64.tar.gz" download >influx CLI (amd64)</a>
<a class="btn download" href="https://dl.influxdata.com/influxdb/releases/influxdb_client_2.0.0_linux_arm64.tar.gz" download >influx CLI (arm)</a>
...
```sh
# Unpackage contents to the current working directory
tar xvfz influxdb_client_2.0.0_linux_amd64.tar.gz
```
...
sudo cp influxdb_client_2.0.0_linux_amd64/influx /usr/local/bin/
```
