...
For more information, see [Automatically configure Telegraf](/influxdb/cloud/write-data/no-code/use-telegraf/auto-config/).
...
that include any of the available [Telegraf plugins](/influxdb/cloud/reference/telegraf-plugins).

## Use the influx CLI
Use the [`influx telegrafs create` command](/influxdb/cloud/reference/cli/influx/telegrafs/create/)
...
1. Create a custom Telegraf configuration file that includes the `outputs.influxdb_v2`
   output plugin. _See [Manually configure Telegraf](/influxdb/cloud/write-data/no-code/use-telegraf/manual-config/)_
   for more information.
2. Add and customize [Telegraf plugins](/influxdb/cloud/reference/telegraf-plugins) and save your changes.
