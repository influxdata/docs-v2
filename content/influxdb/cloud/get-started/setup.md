...
{{< api-endpoint endpoint="http://cloud2.influxdata.com/api/v2/authorizations" method="post" api-ref="/influxdb/cloud/api/authorizations-api-tokens/" >}}
      ...
      - **resource**: JSON object that represents the InfluxDB resource to grant
        permission to. Each resource contains at least the following properties:
          ...
          - **type**: Resource type.
            ...
            [`/api/v2/resources` endpoint](/influxdb/cloud/api/resources/)._
...
{{< api-endpoint endpoint="http://cloud2.influxdata.com/api/v2/buckets" method="post" api-ref="/influxdb/cloud/api/buckets/" >}}
