...
menu:
  influxdb_v1:
    ...
    parent: InfluxQL
aliases:
  - /influxdb/v1/sample_data/data_download/
  - /influxdb/v1/query_language/data_download/
...
From your terminal, download the text file that contains the data in [line protocol](/influxdb/v1/concepts/glossary/#influxdb-line-protocol) format:
```
