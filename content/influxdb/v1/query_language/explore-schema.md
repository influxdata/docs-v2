...
string parameter in the [InfluxDB API](/influxdb/v1/api/query/) request.
...
`ON <database_name>` is optional.
If the query does not include `ON <database_name>`, you must specify the
database with `USE <database_name>` in the [CLI](/influxdb/v1/tools/shell/) or with the `db` query string parameter in the [InfluxDB API](/influxdb/v1/api/query/) request.
