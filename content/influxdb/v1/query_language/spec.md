...
For more information on using the `SHOW DIAGNOSTICS` command, see [Using the SHOW DIAGNOSTICS command for monitoring InfluxDB](/influxdb/v1/administration/monitor/show-diagnostics/).
...
For more information on using the `SHOW STATS` command, see [Using the SHOW STATS command to monitor InfluxDB](/influxdb/v1/administration/monitor/show-stats/).
