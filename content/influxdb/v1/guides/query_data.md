...
For more information about querying data with the InfluxDB API using Flux, see the [API reference documentation](/influxdb/v1/api/#influxdb-2x-api-compatibility-endpoints).
...
For more information about querying data with the InfluxDB API using InfluxQL, see the [API reference documentation](/influxdb/v1/api/#influxdb-1-x-http-endpoints).
