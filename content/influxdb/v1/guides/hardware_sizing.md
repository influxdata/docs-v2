...
For more information about sizing requirements for InfluxDB Enterprise, see [InfluxDB Enterprise hardware sizing guidelines](/enterprise_influxdb/v1/guides/hardware_sizing/).
...
Estimated guidelines include writes per second, queries per second, and number of unique [series](/influxdb/v1/concepts/glossary/#series), CPU, RAM, and IOPS (input/output operations per second).
