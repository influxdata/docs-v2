...
- [CQ documentation](/influxdb/v1/query_language/continuous_queries/) and
- [RP documentation](/influxdb/v1/query_language/manage-database/#retention-policy-management).
...
We store this data in a [database](/influxdb/v1/concepts/glossary/#database) or [bucket]() called `food_data`, in
the [measurement](/influxdb/v1/concepts/glossary/#measurement) `orders`, and
in the [fields](/influxdb/v1/concepts/glossary/#field) `phone` and `website`.
...
Use the
[`CREATE CONTINUOUS QUERY`](/influxdb/v1/query_language/continuous_queries/)
...
together, check out the detailed documentation on [CQs](/influxdb/v1/query_language/continuous_queries/) and [RPs](/influxdb/v1/query_language/manage-database/#retention-policy-management)
