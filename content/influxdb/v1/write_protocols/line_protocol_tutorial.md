...
See the [API Reference](/influxdb/v1/api/write/) for more information.
...
See the [API Reference](/influxdb/v1/api/write/) for how to specify
...
and more examples, see the [API Reference](/influxdb/v1/api/write/).
...
on the [InfluxDB API](/influxdb/v1/api/write/), the
