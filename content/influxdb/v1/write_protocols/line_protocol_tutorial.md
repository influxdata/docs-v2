...
aliases:
    - /influxdb/v1/write_protocols/line/
menu:
  influxdb_v1:
    weight: 20
...
write points (unless you're using a [service plugin](/influxdb/v1/supported_protocols/)).
...
The name of the [measurement](/influxdb/v1/concepts/glossary/#measurement)
...
The [tag(s)](/influxdb/v1/concepts/glossary/#tag) that you want to include
...
The [field(s)](/influxdb/v1/concepts/glossary/#field) for your data point.
...
The [timestamp](/influxdb/v1/concepts/glossary/#timestamp) for your data
...
See the [API Reference](/influxdb/v1/tools/api/#write-http-endpoint) for more information.
...
[measurements](/influxdb/v1/concepts/glossary/#measurement),
[tag keys](/influxdb/v1/concepts/glossary/#tag-key),
[tag values](/influxdb/v1/concepts/glossary/#tag-value),
[field keys](/influxdb/v1/concepts/glossary/#field-key),
[field values](/influxdb/v1/concepts/glossary/#field-value), and
...
tag values.
In addition, InfluxQL [functions](/influxdb/v1/query_language/functions/)
...
See the [API Reference](/influxdb/v1/tools/api/#write-http-endpoint) for how to specify
...
[shard](/influxdb/v1/concepts/glossary/#shard), but it can differ across
...
[Tools](/influxdb/v1/tools/) sections for further
information.
...
and more examples, see the [API Reference](/influxdb/v1/tools/api/#write-http-endpoint).

#### CLI

Write data to InfluxDB using the InfluxDB command line interface (CLI).
[Launch](/influxdb/v1/tools/shell/#launch-influx) the CLI, use the relevant
...
[import](/influxdb/v1/tools/shell/#import-data-from-a-file-with-import) Line
Protocol from a file.

There are several ways to write data to InfluxDB.
See the [Tools](/influxdb/v1/tools/) section for more
on the [InfluxDB API](/influxdb/v1/tools/api/#write-http-endpoint), the
[CLI](/influxdb/v1/tools/shell/), and the available Service Plugins (
[UDP](/influxdb/v1/tools/udp/),
[Graphite](/influxdb/v1/tools/graphite/),
[CollectD](/influxdb/v1/tools/collectd/), and
[OpenTSDB](/influxdb/v1/tools/opentsdb/)).
...
[How does InfluxDB handle duplicate point?](/influxdb/v1/troubleshooting/frequently-asked-questions/#how-does-influxdb-handle-duplicate-points)
