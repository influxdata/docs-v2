...
See the [API Reference](/influxdb/v1/api/#write-http-endpoint) for more information.
...
See the [API Reference](/influxdb/v1/api/#write-http-endpoint) for how to specify
...
and more examples, see the [API Reference](/influxdb/v1/api/#write-http-endpoint).
...
on the [InfluxDB API](/influxdb/v1/api/#write-http-endpoint), the
