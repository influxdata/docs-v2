...
the [InfluxDB API](/influxdb/v1/api/#query-string-parameters) request.
...
**Resources:**
[Schema exploration](/influxdb/v1/query_language/explore-schema/),
[InfluxQL reference](/influxdb/v1/query_language/spec/)

## `error: max series per database exceeded: < >`

The `max series per database exceeded` error occurs when a write causes the
number of [series](/influxdb/v1/concepts/glossary/#series) in a database to
...
[identifiers](/influxdb/v1/concepts/glossary/#identifier) in the query is an
[InfluxQL Keyword](/influxdb/v1/query_language/spec/#keywords).
...
[Query Language Documentation](/influxdb/v1/query_language/)
...
includes both an [aggregate function](/influxdb/v1/query_language/functions/)
and a standalone [field key](/influxdb/v1/concepts/glossary/#field-key) or
...
**Resources:**
[Data Exploration](/influxdb/v1/query_language/explore-data/#time-syntax)
...
[line protocol](/influxdb/v1/concepts/glossary/#influxdb-line-protocol) includes a
...
[InfluxDB line protocol](/influxdb/v1/concepts/glossary/#influxdb-line-protocol)
...
**Resources:**
[InfluxDB line protocol tutorial](/influxdb/v1/write_protocols/line_protocol_tutorial/#data-types),
[InfluxDB line protocol reference](/influxdb/v1/write_protocols/line_protocol_reference/#data-types)
...
or for datasets with higher [series cardinality](/influxdb/v1/concepts/glossary/#series-cardinality).
...
**Resources:**
[Database Configuration](/influxdb/v1/administration/config/)
...
2. Review import errors for possible causes to resolve:
  ...
  >**Note:** To learn how to use the `-import` command, see [Import data from a file with `-import`](/influxdb/v1/tools/shell/#import-data-from-a-file-with-import).
