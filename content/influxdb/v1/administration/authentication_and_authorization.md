...
aliases:
  /influxdb/v1/query_language/authentication_and_authorization/
menu:
  influxdb_v1:
    name: Manage authentication and authorization
    weight: 20
    parent: Administration
v2: /influxdb/v2/security/tokens/
---
...
Add a custom shared secret in your [InfluxDB configuration file](/influxdb/v1/administration/config/#shared-secret).
...
For more information about these commands, see [Database management](/influxdb/v1/query_language/manage-database/) and
[Continuous queries](/influxdb/v1/query_language/continuous_queries/).
...
Non-admin users can [`SHOW`](/influxdb/v1/query_language/explore-schema/#show-databases) the databases on which they have `READ` and/or `WRITE` permissions.
