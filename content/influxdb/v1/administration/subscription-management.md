...
HTTP, HTTPS, or UDP in [line protocol](/influxdb/v1/write_protocols/line_protocol_tutorial/).
...
_**Descriptions of `[subscriber]` configuration options are available in the [Configuring InfluxDB](/influxdb/v1/administration/config#subscription-settings) documentation.**_
