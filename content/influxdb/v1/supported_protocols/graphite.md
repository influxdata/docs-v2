...
aliases:
    - /influxdb/v1/tools/graphite/
    - /influxdb/v1/write_protocols/graphite/
menu:
  influxdb_v1:
    name: Graphite
    weight: 20
...
size limit, [see here for more details.](/influxdb/v1/supported_protocols/udp#a-note-on-udp-ip-os-buffer-sizes)
