...
## Query data
Use the query built in the previous [Query data from InfluxDB](/influxdb/v1/flux/get-started/query-influxdb)
...
_Functions are covered in detail in the [Flux functions](/flux/v0/stdlib) documentation._
...
`every` supports all [valid duration units](/flux/v0/language/types/#duration-types),
...
view the [Windowing and aggregating data](/influxdb/v1/flux/guides/window-aggregate) guide._

---

<div class="page-nav-btns">
  <a class="btn prev" href="/influxdb/v1/flux/get-started/query-influxdb/">Query InfluxDB</a>
  <a class="btn next" href="/influxdb/v1/flux/get-started/syntax-basics/">Syntax basics</a>
</div>
