...
<p style="font-size:.85rem;font-style:italic;margin-top:-2rem;">See <a href="/influxdb/v1/flux/guides/execute-queries/#influx-cli">Flux read-eval-print-loop (REPL)</a>.</p>
...
_For an in-depth look at calculating percentages, see [Calculate percentages](/influxdb/v1/flux/guides/calculate-percentages)._
