...
2. Use [`pivot()` or `join()`](/influxdb/v1/flux/guides/mathematic-operations/#pivot-vs-join)
...
_See [Pivot vs join](/influxdb/v1/flux/guides/mathematic-operations/#pivot-vs-join)._
{{% /note %}}
...
1. Ensure measurements are in the same [bucket](/influxdb/v1/flux/get-started/#buckets).
