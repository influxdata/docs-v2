...
- [field set](/influxdb/v1/concepts/glossary/#field-set)
- [field value](/influxdb/v1/concepts/glossary/#field-value)
- [measurement](/influxdb/v1/concepts/glossary/#measurement)
- [point](/influxdb/v1/concepts/glossary/#point)
...
- [tag set](/influxdb/v1/concepts/glossary/#tag-set)
- [tag value](/influxdb/v1/concepts/glossary/#tag-value)
- [timestamp](/influxdb/v1/concepts/glossary/#timestamp)
...
[Queries](/influxdb/v1/concepts/glossary/#query) that use field values as filters must scan all values that match the other conditions in the query.
...
To optimize your queries, it may be beneficial to rearrange your [schema](/influxdb/v1/concepts/glossary/#schema) such that the fields (`butterflies` and `honeybees`) become the tags and the tags (`location` and `scientist`) become the fields:
...
If you're interested in reading more about retention policies, check out [Database Management](/influxdb/v1/query_language/manage-database/#retention-policy-management).
...
Understanding the concept of a series is essential when designing your [schema](/influxdb/v1/concepts/glossary/#schema) and when working with your data in InfluxDB.
...
See [Authentication and Authorization](/influxdb/v1/administration/authentication_and_authorization/) and [Continuous Queries](/influxdb/v1/query_language/continuous_queries/) for more on those topics.
...
If you're just starting out, we recommend taking a look at [Getting Started](/influxdb/v1/introduction/getting_started/) and the [Writing Data](/influxdb/v1/guides/writing_data/) and [Querying Data](/influxdb/v1/guides/querying_data/) guides.
