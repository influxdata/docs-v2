...
For a complete list of the available and upcoming aggregations, see [InfluxQL functions](/influxdb/v1/query_language/functions/#aggregations).

Related entries: [function](/influxdb/v1/concepts/glossary/#function), [selector](/influxdb/v1/concepts/glossary/#selector), [transformation](/influxdb/v1/concepts/glossary/#transformation)
...
Related entries: [InfluxDB line protocol](/influxdb/v1/concepts/glossary/#influxdb-line-protocol), [point](/influxdb/v1/concepts/glossary/#point)
...
Related entries: [continuous query](/influxdb/v1/concepts/glossary/#continuous-query-cq), [retention policy](/influxdb/v1/concepts/glossary/#retention-policy-rp), [user](/influxdb/v1/concepts/glossary/#user)
...
See [Database Management](/influxdb/v1/query_language/manage-database/#create-retention-policies-with-create-retention-policy) for how to set duration.

Related entries: [retention policy](/influxdb/v1/concepts/glossary/#retention-policy-rp)
...
Related entries: [field key](/influxdb/v1/concepts/glossary/#field-key), [field set](/influxdb/v1/concepts/glossary/#field-set), [field value](/influxdb/v1/concepts/glossary/#field-value), [tag](/influxdb/v1/concepts/glossary/#tag)
...
Related entries: [field](/influxdb/v1/concepts/glossary/#field), [field set](/influxdb/v1/concepts/glossary/#field-set), [field value](/influxdb/v1/concepts/glossary/#field-value), [tag key](/influxdb/v1/concepts/glossary/#tag-key)

## field set

The collection of field keys and field values on a point.

Related entries: [field](/influxdb/v1/concepts/glossary/#field), [field key](/influxdb/v1/concepts/glossary/#field-key), [field value](/influxdb/v1/concepts/glossary/#field-value), [point](/influxdb/v1/concepts/glossary/#point)
...
Related entries: [field](/influxdb/v1/concepts/glossary/#field), [field key](/influxdb/v1/concepts/glossary/#field-key), [field set](/influxdb/v1/concepts/glossary/#field-set), [tag value](/influxdb/v1/concepts/glossary/#tag-value), [timestamp](/influxdb/v1/concepts/glossary/#timestamp)

## function

InfluxQL aggregations, selectors, and transformations.
See [InfluxQL Functions](/influxdb/v1/query_language/functions/) for a complete list of InfluxQL functions.

Related entries: [aggregation](/influxdb/v1/concepts/glossary/#aggregation), [selector](/influxdb/v1/concepts/glossary/#selector), [transformation](/influxdb/v1/concepts/glossary/#transformation)
...
user names.
See [Query Language Specification](/influxdb/v1/query_language/spec/#identifiers).

Related entries:
[database](/influxdb/v1/concepts/glossary/#database),
[field key](/influxdb/v1/concepts/glossary/#field-key),
...
[user](/influxdb/v1/concepts/glossary/#user)

## InfluxDB line protocol

The text based format for writing points to InfluxDB. See [InfluxDB line protocol](/influxdb/v1/write_protocols/).
...
Related entries: [field](/influxdb/v1/concepts/glossary/#field), [series](/influxdb/v1/concepts/glossary/#series)
...
Related entries: [database](/influxdb/v1/concepts/glossary/#database), [retention policy](/influxdb/v1/concepts/glossary/#retention-policy-rp), [user](/influxdb/v1/concepts/glossary/#user)

## node

An independent `influxd` process.

Related entries: [server](/influxdb/v1/concepts/glossary/#server)
...
For more information about duplicate points, see [How does InfluxDB handle duplicate points?](/influxdb/v1/troubleshooting/frequently-asked-questions/#how-does-influxdb-handle-duplicate-points)

Related entries: [field set](/influxdb/v1/concepts/glossary/#field-set), [series](/influxdb/v1/concepts/glossary/#series), [timestamp](/influxdb/v1/concepts/glossary/#timestamp)
...
Related entries: [point](/influxdb/v1/concepts/glossary/#point), [schema](/influxdb/v1/concepts/glossary/#schema), [values per second](/influxdb/v1/concepts/glossary/#values-per-second)

## query

An operation that retrieves data from InfluxDB.
See [Data Exploration](/influxdb/v1/query_language/explore-data/), [Schema Exploration](/influxdb/v1/query_language/explore-schema/), [Database Management](/influxdb/v1/query_language/manage-database/).

## replication factor  

The attribute of the retention policy that determines how many copies of data to concurrently store (or retain) in a cluster. Replicating copies ensures that data is available when a data node (or more) is unavailable.

Replication requires multiple data nodes, which are available only in
[InfluxDB Enterprise](/enterprise_influxdb/v1/) clusters. InfluxDB OSS runs as
a single node, so the replication factor has no effect--there is only ever one
copy of your data. For default replication factor behavior in a cluster, see
the InfluxDB Enterprise [`CREATE RETENTION POLICY`
reference](/enterprise_influxdb/v1/query_language/manage-database/#replication).

Related entries: [duration](/influxdb/v1/concepts/glossary/#duration), [node](/influxdb/v1/concepts/glossary/#node),
[retention policy](/influxdb/v1/concepts/glossary/#retention-policy-rp)
...
Related entries: [database](/influxdb/v1/concepts/glossary/#database), [field key](/influxdb/v1/concepts/glossary/#field-key), [measurement](/influxdb/v1/concepts/glossary/#measurement), [retention policy](/influxdb/v1/concepts/glossary/#retention-policy-rp), [series](/influxdb/v1/concepts/glossary/#series), [tag key](/influxdb/v1/concepts/glossary/#tag-key), [tag value](/influxdb/v1/concepts/glossary/#tag-value)

## selector

An InfluxQL function that returns a single point from the range of specified points.
See [InfluxQL Functions](/influxdb/v1/query_language/functions/#selectors) for a complete list of the available and upcoming selectors.

Related entries: [aggregation](/influxdb/v1/concepts/glossary/#aggregation), [function](/influxdb/v1/concepts/glossary/#function), [transformation](/influxdb/v1/concepts/glossary/#transformation)

## series

A logical grouping of data defined by shared measurement, tag set, and field key.

Related entries: [field set](/influxdb/v1/concepts/glossary/#field-set), [measurement](/influxdb/v1/concepts/glossary/#measurement), [tag set](/influxdb/v1/concepts/glossary/#tag-set)
...
See [SHOW CARDINALITY](/influxdb/v1/query_language/spec/#show-cardinality) to learn about the InfluxQL commands for series cardinality.
...
Related entries: [series](/influxdb/v1/concepts/glossary/#series)
...
Related entries: [node](/influxdb/v1/concepts/glossary/#node)
...
Related entries: [series](/influxdb/v1/concepts/glossary/#series), [shard duration](/influxdb/v1/concepts/glossary/#shard-duration), [shard group](/influxdb/v1/concepts/glossary/#shard-group), [tsm](/influxdb/v1/concepts/glossary/#tsm-time-structured-merge-tree)
...
Related entries: [database](/influxdb/v1/concepts/glossary/#database), [retention policy](/influxdb/v1/concepts/glossary/#retention-policy-rp), [series](/influxdb/v1/concepts/glossary/#series), [shard](/influxdb/v1/concepts/glossary/#shard), [shard group](/influxdb/v1/concepts/glossary/#shard-group)
...
Related entries: [database](/influxdb/v1/concepts/glossary/#database), [retention policy](/influxdb/v1/concepts/glossary/#retention-policy-rp), [series](/influxdb/v1/concepts/glossary/#series), [shard](/influxdb/v1/concepts/glossary/#shard), [shard duration](/influxdb/v1/concepts/glossary/#shard-duration)
...
Related entries: [field](/influxdb/v1/concepts/glossary/#field), [tag key](/influxdb/v1/concepts/glossary/#tag-key), [tag set](/influxdb/v1/concepts/glossary/#tag-set), [tag value](/influxdb/v1/concepts/glossary/#tag-value)
...
Related entries: [field key](/influxdb/v1/concepts/glossary/#field-key), [tag](/influxdb/v1/concepts/glossary/#tag), [tag set](/influxdb/v1/concepts/glossary/#tag-set), [tag value](/influxdb/v1/concepts/glossary/#tag-value)

## tag set

The collection of tag keys and tag values on a point.

Related entries: [point](/influxdb/v1/concepts/glossary/#point), [series](/influxdb/v1/concepts/glossary/#series), [tag](/influxdb/v1/concepts/glossary/#tag), [tag key](/influxdb/v1/concepts/glossary/#tag-key), [tag value](/influxdb/v1/concepts/glossary/#tag-value)
...
Related entries: [tag](/influxdb/v1/concepts/glossary/#tag), [tag key](/influxdb/v1/concepts/glossary/#tag-key), [tag set](/influxdb/v1/concepts/glossary/#tag-set)
...
For how to specify time when writing data, see [Write Syntax](/influxdb/v1/write_protocols/write_syntax/).
For how to specify time when querying data, see [Data Exploration](/influxdb/v1/query_language/explore-data/#time-syntax).

Related entries: [point](/influxdb/v1/concepts/glossary/#point)
...
Related entries: [aggregation](/influxdb/v1/concepts/glossary/#aggregation), [function](/influxdb/v1/concepts/glossary/#function), [selector](/influxdb/v1/concepts/glossary/#selector)

## TSM (Time Structured Merge tree)

The purpose-built data storage format for InfluxDB. TSM allows for greater compaction and higher write and read throughput than existing B+ or LSM tree implementations. See [Storage Engine](/influxdb/v1/concepts/storage_engine/) for more.
...
See [Authentication and Authorization](/influxdb/v1/administration/authentication_and_authorization/).
...
Related entries: [batch](/influxdb/v1/concepts/glossary/#batch), [field](/influxdb/v1/concepts/glossary/#field), [point](/influxdb/v1/concepts/glossary/#point), [points per second](/influxdb/v1/concepts/glossary/#points-per-second)
...
Related entries: [tsm](/influxdb/v1/concepts/glossary/#tsm-time-structured-merge-tree)
