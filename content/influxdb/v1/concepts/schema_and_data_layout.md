...
Each InfluxDB use case is unique and your [schema](/influxdb/v1/concepts/glossary/#schema) reflects that uniqueness.
...
- [tags](/influxdb/v1/concepts/glossary/#tag)

[Tag values](/influxdb/v1/concepts/glossary/#tag-value) are indexed and [field values](/influxdb/v1/concepts/glossary/#field-value) are not.
...
Each unique set of indexed data elements forms a [series key](/influxdb/v1/concepts/glossary/#series-key).
[Tags](/influxdb/v1/concepts/glossary/#tag) containing highly variable information like unique IDs, hashes, and random strings lead to a large number of [series](/influxdb/v1/concepts/glossary/#series), also known as high [series cardinality](/influxdb/v1/concepts/glossary/#series-cardinality).
...
See [how to find and reduce series high cardinality](/influxdb/v1/troubleshooting/frequently-asked-questions/#why-does-series-cardinality-matter).
...
Also, if a tag or field key contains characters other than `[A-z,_]`, you must wrap it in double quotes in InfluxQL or use [bracket notation](/flux/v0/data-types/composite/record/#bracket-notation) in Flux.
...
[Frequently asked questions](/influxdb/v1/troubleshooting/frequently-asked-questions/#tag-and-field-key-with-the-same-name)
...
Store data in [tag values](/influxdb/v1/concepts/glossary/#tag-value) or [field values](/influxdb/v1/concepts/glossary/#field-value), not in [tag keys](/influxdb/v1/concepts/glossary/#tag-key), [field keys](/influxdb/v1/concepts/glossary/#field-key), or [measurements](/influxdb/v1/concepts/glossary/#measurement). If you design your schema to store data in tag and field values,
...
To learn more about the performance impact of high series cardinality, see [how to find and reduce high series cardinality](/influxdb/v1/troubleshooting/frequently-asked-questions/#why-does-series-cardinality-matter).
...
Shard groups are organized by [retention policy](/influxdb/v1/concepts/glossary/#retention-policy-rp) (RP) and store data with timestamps that fall within a specific time interval called the [shard duration](/influxdb/v1/concepts/glossary/#shard-duration).

If no shard group duration is provided, the shard group duration is determined by the RP [duration](/influxdb/v1/concepts/glossary/#duration) at the time the RP is created. The default values are:
...
To configure the shard group duration, see [Retention Policy Management](/influxdb/v1/query_language/manage-database/#retention-policy-management).
...
> **Note:** Note that `INF` (infinite) is not a [valid shard group duration](/influxdb/v1/query_language/manage-database/#retention-policy-management).
...
* Shard groups should each contain more than 100,000 [points](/influxdb/v1/concepts/glossary/#point) per shard group
* Shard groups should each contain more than 1,000 points per [series](/influxdb/v1/concepts/glossary/#series)
