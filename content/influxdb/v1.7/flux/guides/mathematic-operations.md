...
<p style="font-size:.85rem;font-style:italic;margin-top:-2rem;">See <a href="/influxdb/v1.7/flux/guides/execute-queries/#influx-cli">Flux read-eval-print-loop (REPL)</a>.</p>
...
- [Handle piped-forward data](/{{< latest "influxdb" "v2" >}}/query-data/flux/custom-functions/#functions-that-use-piped-forward-data).
...
_For an in-depth look at calculating percentages, see [Calculate percentates](/influxdb/v1.7/flux/guides/calculate-percentages)._
