...
_**Chronograf v1.7+** and **InfluxDB v1.7 with [Flux enabled](/influxdb/v1.7/flux/installation)**
...
[windowing and aggregation](/influxdb/v1.7/flux/guides/window-aggregate) operations with dashboard refreshes.
