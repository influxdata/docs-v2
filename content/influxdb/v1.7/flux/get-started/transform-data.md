...
## Query data
Use the query built in the previous [Query data from InfluxDB](/influxdb/v1.7/flux/get-started/query-influxdb)
...
view the [Windowing and aggregating data](/influxdb/v1.7/flux/guides/window-aggregate) guide._

---

<div class="page-nav-btns">
  <a class="btn prev" href="/influxdb/v1.7/flux/get-started/query-influxdb/">Query InfluxDB</a>
  <a class="btn next" href="/influxdb/v1.7/flux/get-started/syntax-basics/">Syntax basics</a>
</div>
