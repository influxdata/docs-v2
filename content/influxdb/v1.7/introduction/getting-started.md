...
aliases:
  - /influxdb/v1.7/introduction/getting_started/
menu:
  influxdb_1_7:
...
InfluxQL has many [features and keywords](/influxdb/v1.7/query_language/spec/) that are not covered here,
...
check out the guide on [Writing Data](/influxdb/v1.7/guides/writing_data/).
To further explore the query language,
check out the guide on [Querying Data](/influxdb/v1.7/guides/querying_data/).
For more information on InfluxDB concepts, check out the [Key Concepts]
(/influxdb/v1.7/concepts/key_concepts/) page.
