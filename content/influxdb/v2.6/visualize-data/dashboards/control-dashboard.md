...
For details on using the Data Explorer, see [Explore metrics](/influxdb/v2.6/visualize-data/explore-metrics/).
...
Click **Variables** to display variables available for your dashboard. For details, see [Use and manage variables](/influxdb/v2.6/visualize-data/variables/)
