...
description: >
  Customize your InfluxDB configuration by using [`influxd`](/influxdb/v2.6/reference/cli/influxd/)
...
products: [oss]
related:
  - /influxdb/v2.6/reference/cli/influxd
---
...
Server configuration commands require an [Operator token](/influxdb/v2.6/security/tokens/#operator-token).

#### View your server configuration with the CLI

Use the [`influx server-config` command](/influxdb/v2.6/reference/cli/influx/server-config/)
...
[`influxd` service](/influxdb/v2.6/reference/cli/influxd):
...
Enable [additional security features](/influxdb/v2.6/security/enable-hardening/)
in InfluxDB.
**Default:** `false`
| influxd flag          | Environment variable        | Configuration key   |
| :-------------------- | :-------------------------- | :------------------ |
...
### metrics-disabled
Disable the HTTP `/metrics` endpoint which exposes [internal InfluxDB metrics](/influxdb/v2.6/reference/internals/metrics/).
...
_For more information, see [Enable TLS encryption](/influxdb/v2.6/security/enable-tls/)._
