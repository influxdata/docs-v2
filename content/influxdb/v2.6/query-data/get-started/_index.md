...
aliases:
  - /influxdb/v2.6/query-data/get-started/getting-started
weight: 101
influxdb/v2.6/tags: [query, flux, get-started]
menu:
  influxdb_2_6:
...
The [Execute queries](/influxdb/v2.6/query-data/execute-queries) guide walks through
...
{{< page-nav next="/influxdb/v2.6/query-data/get-started/query-influxdb/" >}}
