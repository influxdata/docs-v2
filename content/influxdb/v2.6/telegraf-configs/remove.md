...
aliases:
  - /influxdb/v2.6/write-data/no-code/use-telegraf/auto-config/delete-telegraf-config/
  - /influxdb/v2.6/collect-data/use-telegraf/auto-config/delete-telegraf-config
---
...
## Use the influx CLI
Use the [`influx telegrafs rm` command](/influxdb/v2.6/reference/cli/influx/telegrafs/rm/)
