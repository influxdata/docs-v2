...
description: >
  ...
  for the [InfluxDB 1.x compatibility API](/influxdb/v2.6/reference/api/influxdb-1x/).
menu:
  influxdb_2_6_ref:
    name: influx v1 dbrp
    parent: influx v1
...
| Command                                                       | Description           |
|:------------------------------------------------------------- |:--------------------- |
| [create](/influxdb/v2.6/reference/cli/influx/v1/dbrp/create/) | Create a DBRP mapping |
| [delete](/influxdb/v2.6/reference/cli/influx/v1/dbrp/delete/) | Delete a DBRP mapping |
| [list](/influxdb/v2.6/reference/cli/influx/v1/dbrp/list/)     | List DBRP mappings    |
| [update](/influxdb/v2.6/reference/cli/influx/v1/dbrp/update/) | Update a DBRP mapping |
