...
aliases:
  - /influxdb/v2/collect-data/use-telegraf/auto-config
  - /influxdb/v2/write-data/use-telegraf/auto-config
menu:
  influxdb_v2:
...
1. Find your API token. _For information about viewing tokens, see [View tokens](/influxdb/v2/security/tokens/view-tokens/)._
