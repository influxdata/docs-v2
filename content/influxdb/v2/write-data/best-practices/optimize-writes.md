...
- [Telegraf](/influxdb/v2/write-data/no-code/use-telegraf/)
...
_Specify timestamp precision when [writing to InfluxDB](/influxdb/v2/write-data/#timestamp-precision)._
...
Each [InfluxDB client library](/influxdb/v2/api-guide/client-libraries/) provides
...
For specific instructions, see the [InfluxDB client libraries documentation](/influxdb/v2/api-guide/client-libraries/).
{{% /tab-content %}}
{{% tab-content %}}
...
Use the [`influx write`](/influxdb/v2/reference/cli/influx/write/) `--rate-limit` flag to control the rate of writes.
