...
3. Download the signature file for the release by appending `.asc` to the download URL,
   ...
   "https://dl.influxdata.com/influxdb/releases/influxdb2-{{< latest-patch >}}_darwin_amd64.tar.gz" \
   ```
   -->

   ```sh
   curl --silent --location \
   https://dl.influxdata.com/influxdb/releases/influxdb2-{{< latest-patch >}}_darwin_amd64.tar.gz.asc \
...
1. In your browser or your terminal, download the InfluxDB binary for your
   ...
   ```sh
   curl -s --location -O \
   "https://dl.influxdata.com/influxdb/releases/influxdb2-{{< latest-patch >}}_linux_amd64.tar.gz"
   ```

   ```sh
   curl -s --location -O \
   "https://dl.influxdata.com/influxdb/releases/influxdb2-{{< latest-patch >}}_linux_arm64.tar.gz"
   ```
   -->
...
3. {{< req text="Recommended:" color="magenta" >}}: Verify the authenticity of the downloaded binary--for example,
   ...
   curl --silent --location "https://dl.influxdata.com/influxdb/releases/influxdb2-{{< latest-patch >}}_linux_amd64.tar.gz.asc" \
   ...
   &&
   # Download and verify the binary's signature file
   curl --silent --location "https://dl.influxdata.com/influxdb/releases/influxdb2-{{< latest-patch >}}_linux_arm64.tar.gz.asc" \
...
<a class="btn download" href="https://dl.influxdata.com/influxdb/releases/influxdb2-{{< latest-patch >}}-windows_amd64.zip" download >InfluxDB v2 (Windows)</a>
