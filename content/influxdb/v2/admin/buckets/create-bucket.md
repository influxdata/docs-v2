...
{{< api-endpoint method="post" endpoint="https://localhost:8086/api/v2/buckets" api-ref="/influxdb/v2/api/buckets/" >}}
...
[InfluxDB API Buckets documentation](/influxdb/v2/api/buckets/)._
