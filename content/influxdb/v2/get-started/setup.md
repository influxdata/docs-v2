...
{{< api-endpoint endpoint="http://localhost:8086/api/v2/setup" method="post" api-ref="/influxdb/v2/api/authorizations-api-tokens/" >}}
...
{{< api-endpoint endpoint="http://localhost:8086/api/v2/authorizations" method="post" api-ref="/influxdb/v2/api/authorizations-api-tokens/" >}}
      ...
      - **resource**: JSON object that represents the InfluxDB resource to grant
        permission to. Each resource contains at least the following properties:
          ...
          - **type**: Resource type.
            ...
            [`/api/v2/resources` endpoint](/influxdb/v2/api/resources/)._
...
{{< api-endpoint endpoint="http://localhost:8086/api/v2/buckets" method="post" api-ref="/influxdb/v2/api/buckets/">}}
