...
description: >
  InfluxDB automatically creates a new stack each time you [apply an InfluxDB template](/influxdb/v2/influxdb-templates/use/)
...
To automatically create a new stack when [applying an InfluxDB template](/influxdb/v2/influxdb-templates/use/)
