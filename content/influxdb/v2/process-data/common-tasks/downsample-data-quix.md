...
- InfluxDB v2 with data ready for downsampling.
...
downsamples it, and then sends it to an output topic which is later written back to InfluxDB.
...
Run `main.py` from the `Machine data to InfluxDB` folder.
