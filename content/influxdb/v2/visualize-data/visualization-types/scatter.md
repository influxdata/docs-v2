...
related:
  - /influxdb/v2/visualize-data/visualization-types/heatmap
---
...
It uses data collected with the Telegraf [Mem](/telegraf/v1/plugins//#mem)
and [CPU](/telegraf/v1/plugins//#cpu) input plugins.
