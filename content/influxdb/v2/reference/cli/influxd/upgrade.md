...
This command copies all data in [databases](/influxdb/v1/concepts/glossary/#database) and
[retention policies](/influxdb/v1/concepts/glossary/#retention-policy-rp) (used in 1.x)
over to [buckets](/influxdb/v2/reference/glossary/#bucket) (used in {{< current-version >}}).
