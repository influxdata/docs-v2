...
If you already have an one, please log into your account before continuing.
...
All the configuration for the data collection agent (Telegraf in this case) will be stored in your InfluxDB Cloud account, 
and fetched on startup of the agent. Any configuration options specific to the machine will be configured with environment 
...
account, it is useful to set up a Deadman alert to ensure you are notified if there is an issue.
