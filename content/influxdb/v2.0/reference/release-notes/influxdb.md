...
- Add new `influxd` configuration options:
  ...
  - [http-read-header-timeout](/influxdb/v2.0/reference/config-options/#http-read-header-timeout) with a default of `10s`
  ...
  - [http-idle-timeout](/influxdb/v2.0/reference/config-options/#http-idle-timeout) with a default of `3m`
- Add `/debug/pprof/all` HTTP endpoint to gather all profiles at once.
- Upgrade `http.pprof-enabled` configuration option in the [InfluxDB upgrade process](/influxdb/v2.0/upgrade/v1-to-v2/automatic-upgrade/).
