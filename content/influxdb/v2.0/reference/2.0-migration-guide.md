...
Migrate from InfluxDB 2.0 beta to TK.
...
In order to support a smoother upgrade process, and enable existing InfluxQL integrations to work with the latest release,
we had to make breaking changes to the underlying storage engine for InfluxDB.
