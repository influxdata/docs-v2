---
title: Migrate from InfluxDB 2.0 Beta to 2.0
description: >
menu:
  influxdb_2_0_ref:
...
## 5 Start your old InfluxDB beta instance
## 6. Configure configuration profiles for the InfluxDB CLI
## 7. Copy all resources from your old instance to the new one
## 8. Setup the integrations to point to your new instance
## 9. Load your historical data into your new instance
-->
...
Next, let’s shut down your existing InfluxDB beta.
You can manually kill the individual process for now using **Control+c** or by finding the process id.
...
I’m going to use the names `influxd_old` for this guide, but you can use whatever you like.
...
If you download the latest InfluxDB beta, and try to spin it up, it will most likely refuse to start since the existing data isn’t compatible.
You will see an error message in the terminal letting you know what’s going on.
...
Note: If you run into a problem about a missing migration, you can manually edit your bolt file to remove it.
You can use BoltBrowser to open and edit your old influxd.bolt file and manually remove the offending migration.
CAUTION: make a backup of your old influxd.bolt file before doing this, as manually editing your bolt file could cause you to lose all your data.
