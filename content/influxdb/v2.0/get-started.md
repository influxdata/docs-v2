...
To avoid having to pass your InfluxDB [authentication token](/v2.0/users/tokens/) with each `influx` command, complete the following steps to set up a configuration profile that stores your credentials.
