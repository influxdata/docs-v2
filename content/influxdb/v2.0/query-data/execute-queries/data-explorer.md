...
Toggle the **View Raw Data** {{< icon "toggle" >}} option to see your data in table format instead of a graph. Group keys and data types are easily identifiable at the top of each column underneath headings. Use this option when data can't be visualized using a visualization type.
