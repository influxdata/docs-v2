...
[requirements of the Flux Geo package](/{{< latest "flux" >}}/stdlib/experimental/to/geo/#geo-schema-requirements).

### Load annotated CSV sample data
Use the [experimental `csv.from()` function](/{{< latest "flux" >}}/stdlib/experimental/to/csv/from/)
