...
list_title: Get started with the JavaScript client library for web browsers
description: >
...
The InfluxDB Javascript client library includes an example browser app that queries from and writes to
...
1. Update the `url` property in `./env` with your InfluxDB [URL](/influxdb/v2.0/reference/urls/).
