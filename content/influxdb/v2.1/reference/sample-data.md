...
description: >
  ...
  and InfluxDB Cloud.
aliases:
  - /influxdb/v2.1/write-data/sample-data/
  - /influxdb/2.0/reference/sample-data/
menu: influxdb_2_1_ref
weight: 7
---
...
[how to join time series data and relational data with Flux](/influxdb/v2.1/query-data/flux/sql/#join-sql-data-with-data-in-influxdb)
in the [Query SQL data sources](/influxdb/v2.1/query-data/flux/sql/) guide.
...
The bird migration sample dataset is used in the [Work with geo-temporal data](/influxdb/v2.1/query-data/flux/geo/)
...
[InfluxDB task](/influxdb/v2.1/process-data/manage-tasks/).
...
we recommend that you [create a new bucket](/influxdb/v2.1/organizations/buckets/create-bucket/)
...
[Common queries](/influxdb/v2.1/query-data/common-queries/) and
[Common tasks](/influxdb/v2.1/process-data/common-tasks/) guides.
