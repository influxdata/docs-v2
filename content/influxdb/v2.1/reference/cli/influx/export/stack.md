...
weight: 201
aliases:
  - /influxdb/v2.1/reference/cli/influx/pkg/export/stack
related:
...
For information about creating an All-Access API token, see [Create an API token](/influxdb/v2.1/security/tokens/create-token/).
{{% /note %}}
