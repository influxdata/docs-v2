...
related:
  ...
  - /influxdb/v2.1/reference/api/influxdb-1x/write
  - /influxdb/v2.1/api/#tag/DBRPs, InfluxDB v2 API /dbrps endpoint
---
...
[1.x compatibility API](/influxdb/v2.1/reference/api/influxdb-1x/) requests to route operations to a bucket.
...
For more information, see [Map unmapped buckets](/influxdb/v2.1/query-data/influxql/#map-unmapped-buckets).
{{% /note %}}
...
[`/query` compatibility endpoint](/influxdb/v2.1/reference/api/influxdb-1x/query/),
...
- If no mapped bucket exists, InfluxDB returns an error. See how to [Map unmapped buckets](/influxdb/v2.1/query-data/influxql/#map-unmapped-buckets).
