...
you **must** [manually create a database and retention policy mapping](/influxdb/v2.1/query-data/influxql/#map-unmapped-buckets)
...
_See [Database and retention policy mapping](/influxdb/v2.1/reference/api/influxdb-1x/dbrp/)._
...
### epoch
Return results with [Unix timestamps](/influxdb/v2.1/reference/glossary/#unix-timestamp)
(also known as epoch timestamps) in the specified precision instead of
[RFC3339 timestamps](/influxdb/v2.1/reference/glossary/#rfc3339-timestamp) with nanosecond precision.
