...
Use the `POST` request method to write [line protocol](/influxdb/v2.1/reference/syntax/line-protocol/)
...
### precision
The precision of [Unix timestamps](/influxdb/v2.1/reference/glossary/#unix-timestamp) in the line protocol.
