...
To customize this path, use the [engine-path](/influxdb/v2.1/reference/config-options/#engine-path)
...
To customize this path, use the [bolt-path](/influxdb/v2.1/reference/config-options/#bolt-path)
configuration option.

#### Configs path
File path to [`influx` CLI connection configurations](/influxdb/v2.1/reference/cli/influx/config/) (configs).
...
[upgrade process](/influxdb/v2.1/upgrade/v1-to-v2/docker/).
{{% /note %}}
