...
- one [dashboard](/influxdb/v2.1/reference/glossary/#dashboard): **Windows System**
- one [bucket](/influxdb/v2.1/reference/glossary/#bucket): `telegraf`, 7d retention
- label: `Windows System Template`, Telegraf plugin labels: `outputs.influxdb_v2`
- one [Telegraf configuration](/influxdb/v2.1/telegraf-configs/): InfluxDB v2 output plugin, Windows Performance Counters input plugin
