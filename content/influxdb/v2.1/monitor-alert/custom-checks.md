...
weight: 201
influxdb/v2.1/tags: [alerts, checks, tasks, Flux]
---

In the UI, you can create two kinds of [checks](/influxdb/v2.1/reference/glossary/#check):
[`threshold`](/influxdb/v2.1/monitor-alert/checks/create/#threshold-check) and
[`deadman`](/influxdb/v2.1/monitor-alert/checks/create/#deadman-check).
...
[Create notification endpoints](/influxdb/v2.1/monitor-alert/notification-endpoints/create),
[Create notification rules](/influxdb/v2.1/monitor-alert/notification-rules/create),
and [Send alert email](/influxdb/v2.1/monitor-alert/send-email/)
{{% /note %}}
