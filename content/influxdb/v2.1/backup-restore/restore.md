...
weight: 101
influxdb/v2.1/tags: [restore]
related:
  - /influxdb/v2.1/backup-restore/backup/
...
To restore data and retain bucket names, [delete existing buckets](/influxdb/v2.1/organizations/buckets/delete-bucket/)
...
[`influx restore` documentation](/influxdb/v2.1/reference/cli/influx/restore/)._
...
1. Retrieve the [admin token](/influxdb/v2.1/security/tokens/#admin-token) from your source InfluxDB instance.
...
directory in the [target engine path](/influxdb/v2.1/reference/cli/influx/restore/#flags)
