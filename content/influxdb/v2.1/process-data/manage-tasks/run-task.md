...
weight: 203
related:
  - /influxdb/v2.1/reference/cli/influx/task/run
  - /influxdb/v2.1/reference/cli/influx/task/run/retry
  - /influxdb/v2.1/reference/cli/influx/task/retry-failed
---
...
2. Find the task you would like to run and click the **{{< icon "settings" >}}** icon located far right of the task name.
3. Click **Run**.
...
Use the [`influx task retry-failed` command](/influxdb/v2.1/reference/cli/influx/task/retry-failed/)
