...
- Do not use any [predefined dashboard variables](/influxdb/v2.1/visualize-data/variables/#predefined-dashboard-variables) in variable queries.
{{% /note %}}
...
_For more on using dashboard variables, see [Use and manage variables](/influxdb/v2.1/visualize-data/variables/)._
