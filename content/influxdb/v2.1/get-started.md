...
**NOTE:** You **must** start the influxd daemon in order to start working with InfluxDB.  See [InfluxDB service](/influxdb/v2.1/reference/cli/influxd/). For information on the command line interface (CLI) see [InfluxDB command line interface](/influxdb/v2.1/reference/cli/influx/).  Once you've started the influxd daemon, use `localhost:8086` to log in to your instance. 
