...
related:
  ...
  - /influxdb/v2.1/query-data/flux/
  - /influxdb/v2.1/process-data/
  - /influxdb/v2.1/process-data/common-tasks/
...
[Flux vs InfluxQL](/influxdb/v2.1/reference/syntax/flux/flux-vs-influxql/#influxql-and-flux-parity).
...
[create a new task](/influxdb/v2.1/process-data/manage-tasks/create-task/).
...
- [Common tasks](/influxdb/v2.1/process-data/common-tasks/#downsample-data-with-influxdb)
