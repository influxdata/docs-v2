...
weight: 104
influxdb/v2.1/tags: [grafana]
aliases:
  - /influxdb/v2.1/visualize-data/other-tools/grafana/
related:
  - https://grafana.com/docs/, Grafana documentation
  - /influxdb/v2.1/query-data/get-started/
---
...
1. [Start InfluxDB OSS {{< current-version >}}](/influxdb/v2.1/install/#start-influxdb).
...
1. Under **Connection**, enter the following:
    ...
    - **URL**: Your [InfluxDB URL](/influxdb/v2.1/reference/urls/).

        ```sh
        http://localhost:8086/
        ```

    - **Organization**: Your InfluxDB [organization name **or** ID](/influxdb/v2.1/organizations/view-orgs/).
    - **Token**: Your InfluxDB [API token](/influxdb/v2.1/security/tokens/).
...
1. [Authenticate with InfluxDB {{< current-version >}} tokens](/influxdb/v2.1/security/tokens/).
...
InfluxDB {{< current-version >}} (following an [official upgrade guide](/influxdb/v2.1/upgrade/v1-to-v2/)):
...
1. If your InfluxDB 1.x instance required authentication,
   ...
   Otherwise, use [InfluxDB v2 token authentication](/influxdb/v2.1/security/tokens/).
2. [Manually create DBRP mappings](#view-and-create-influxdb-dbrp-mappings).
...
Use the [`influx v1 auth list`](/influxdb/v2.1/reference/cli/influx/v1/auth/list/)
...
Use the [`influx v1 auth create` command](/influxdb/v2.1/reference/cli/influx/v1/auth/create/)
to grant read/write permissions to specific buckets. Provide the following:

- [bucket IDs](/influxdb/v2.1/organizations/buckets/view-buckets/) to grant read
...
InfluxDB {{< current-version >}} [buckets](/influxdb/v2.1/reference/glossary/#bucket).
...
Use the [`influx v1 dbrp list`](/influxdb/v2.1/reference/cli/influx/v1/dbrp/list/)
...
_For more information about DBRP mapping, see [Database and retention policy mapping](/influxdb/v2.1/reference/api/influxdb-1x/dbrp/)._
{{< /expand >}}
{{< /expand-wrapper >}}
...
2. Configure InfluxDB authentication:
    ...
    - ##### Token authentication
        ...
        - **Value**: Use the `Token` schema and provide your [InfluxDB API token](/influxdb/v2.1/security/tokens/).
          For example:
