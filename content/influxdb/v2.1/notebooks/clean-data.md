...
5.  Click {{% icon "notebook-add-cell" %}} after your **Flux Script** cell to 
    add a new cell and select **{{% caps %}}Output to Bucket{{% /caps %}}**.
6.  Select your **noaa** bucket from the **{{% icon "bucket" %}} Choose a bucket**
    dropdown menu, 
7.  _(Optional)_ Click {{% icon "notebook-add-cell" %}} and select **Note** to
    ...
    to cardinal directions."
5.  Click **Preview** in the upper left to verify that your notebook runs and
    previews the output.
