...
weight: 100
aliases:
  - /influxdb/v2.1/reference/api/client-libraries/nodejs/install
---
...
1. Set environment variables or update `env.js` with your InfluxDB [bucket](/influxdb/v2.1/organizations/buckets/), [organization](/influxdb/v2.1/organizations/), [token](/influxdb/v2.1/security/tokens/), and [url](/influxdb/v2.1/reference/urls/).
