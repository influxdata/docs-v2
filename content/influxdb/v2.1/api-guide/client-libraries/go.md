...
influxdb/v2.1/tags: [client libraries, Go]
weight: 201
aliases:
  - /influxdb/v2.1/reference/api/client-libraries/go/
...
2. Define variables for your InfluxDB [bucket](/influxdb/v2.1/organizations/buckets/), [organization](/influxdb/v2.1/organizations/), and [token](/influxdb/v2.1/security/tokens/).
...
1. Create a [point](/influxdb/v2.1/reference/glossary/#point) and write it to InfluxDB using the `WritePoint` method of the API writer struct.
