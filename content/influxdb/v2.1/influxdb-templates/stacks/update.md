...
description: >
  Use the [`influx apply` command](/influxdb/v2.1/reference/cli/influx/apply/)
...
related:
  ...
  - /influxdb/v2.1/reference/cli/influx/stacks/update/
list_code_example: |
  ```sh
  influx apply \
    -o example-org \
...
For information about retrieving your stack ID, see [View stacks](/influxdb/v2.1/influxdb-templates/stacks/view/).
