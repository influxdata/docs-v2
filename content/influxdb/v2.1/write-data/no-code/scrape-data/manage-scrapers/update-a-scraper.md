...
aliases:
  - /influxdb/v2.1/collect-data/scrape-data/manage-scrapers/update-a-scraper
  - /influxdb/v2.1/write-data/scrape-data/manage-scrapers/update-a-scraper
menu:
  influxdb_2_1:
...
To modify either, [create a new scraper](/influxdb/v2.1/write-data/no-code/scrape-data/manage-scrapers/create-a-scraper).
{{% /note %}}
