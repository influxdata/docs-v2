...
aliases:
  - /influxdb/v2.1/collect-data/scraper-metrics-endpoint
  - /influxdb/v2.1/collect-data/scrape-data
  - /influxdb/v2.1/write-data/scrape-data
  - /influxdb/v2.1/write-data/scrapable-endpoints
influxdb/v2.1/tags: [scraper]
menu:
  influxdb_2_1:
    name: Scrape data
