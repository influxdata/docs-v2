...
aliases:
  - /influxdb/v2.1/write-data/use-telegraf/use-telegraf-plugins/use-http-plugin/
menu:
  influxdb_2_1:
...
Configure [`influxdb` output plugin](/{{< latest "telegraf" >}}/plugins//#influxdb) to write metrics to your InfluxDB {{< current-version >}} instance.
