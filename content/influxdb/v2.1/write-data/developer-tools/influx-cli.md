...
To write data from the command line, use the [`influx write` command](/influxdb/v2.1/reference/cli/influx/write/).
...
_See [Line protocol](/influxdb/v2.1/reference/syntax/line-protocol/) and [Annotated CSV](/influxdb/v2.1/reference/syntax/annotated-csv)_
