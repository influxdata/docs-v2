...
aliases:
  - /influxdb/v2.1/write-data/no-code/use-telegraf/auto-config/delete-telegraf-config/
  - /influxdb/v2.1/collect-data/use-telegraf/auto-config/delete-telegraf-config
---
...
## Use the influx CLI
Use the [`influx telegrafs rm` command](/influxdb/v2.1/reference/cli/influx/telegrafs/rm/)
