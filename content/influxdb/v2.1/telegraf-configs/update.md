...
aliases:
  - /influxdb/v2.1/write-data/no-code/use-telegraf/auto-config/update-telegraf-config/
  - /influxdb/v2.1/collect-data/use-telegraf/auto-config/update-telegraf-config
---
...
Use the [`influx telegrafs update` command](/influxdb/v2.1/reference/cli/influx/telegrafs/update/)
