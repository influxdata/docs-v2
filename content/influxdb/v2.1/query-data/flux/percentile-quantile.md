...
influxdb/v2.1/tags: [query, percentile, quantile]
related:
  - /influxdb/v2.1/query-data/flux/query-median/
...
{{% note %}}
The examples below use the [example data variable](/influxdb/v2.1/query-data/flux/#example-data-variable).
{{% /note %}}
...
It is primarily used to [downsample data](/influxdb/v2.1/process-data/common-tasks/downsample-data/).
