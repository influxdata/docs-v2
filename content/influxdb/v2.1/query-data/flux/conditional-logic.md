...
influxdb/v2.1/tags: [conditionals, flux]
menu:
  influxdb_2_1:
...
weight: 220
aliases:
  - /influxdb/v2.1/query-data/guides/conditional-logic/
related:
...
The following example uses an example `metric` [dashboard variable](/influxdb/v2.1/visualize-data/variables/)
