...
To create a new user, use the [`influx user create` command](/influxdb/v2.1/reference/cli/influx/user/create)
and include the following:

- Username
- Organization name or organization ID to add the user to _(provided in the output of
  [`influx org list`](/influxdb/v2.1/reference/cli/influx/org/list/))_
