...
Write data once with a single query execution or use [InfluxDB tasks](/influxdb/v2.7/process-data/)
...
use [InfluxDB replication streams](/influxdb/v2.7/write-data/replication/).
{{% /note %}}
...
5.  ({{< req "Recommended" >}}) To keep your raw API token out of queries, store
    your InfluxDB Cloud API token as an [InfluxDB secret](/influxdb/v2.7/security/secrets/)
...
[create a task](/influxdb/v2.7/process-data/manage-tasks/create-task/) in your
