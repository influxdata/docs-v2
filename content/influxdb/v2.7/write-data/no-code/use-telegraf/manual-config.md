...
aliases:
  - /influxdb/v2.7/collect-data/use-telegraf/manual-config
  - /influxdb/v2.7/write-data/use-telegraf/manual-config
menu:
  influxdb_2_7:
...
For information about viewing tokens, see [View tokens](/influxdb/v2.7/security/tokens/view-tokens/).
...
of Telegraf configurations in InfluxDB, use the [`influx telegrafs create`](/influxdb/v2.7/reference/cli/influx/telegrafs/create/)
or [`influx telegrafs update`](/influxdb/v2.7/reference/cli/influx/telegrafs/update/) commands.
For more information, see:

- [Create a Telegraf configuration](/influxdb/v2.7/telegraf-configs/create/#use-the-influx-cli)
- [Update a Telegraf configuration](/influxdb/v2.7/telegraf-configs/update/#use-the-influx-cli)
