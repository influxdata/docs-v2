...
aliases:
  - /influxdb/v2.7/collect-data/scrape-data/manage-scrapers/update-a-scraper
  - /influxdb/v2.7/write-data/scrape-data/manage-scrapers/update-a-scraper
menu:
  influxdb_2_7:
...
To modify either, [create a new scraper](/influxdb/v2.7/write-data/no-code/scrape-data/manage-scrapers/create-a-scraper).
{{% /note %}}
