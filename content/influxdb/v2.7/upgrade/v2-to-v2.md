...
### Manually upgrade
To manually upgrade, [download and install the latest version of InfluxDB {{< current-version >}} for macOS](/influxdb/v2.7/install/#manually-download-and-install)
...
[Download and install the latest version of InfluxDB {{< current-version >}} for Linux](/influxdb/v2.7/install/?t=Linux#download-and-install-influxdb-v21)
...
[Download and install the latest version of InfluxDB {{< current-version >}} for Windows](/influxdb/v2.7/install/?t=Windows)
in place of current 2.x version.
