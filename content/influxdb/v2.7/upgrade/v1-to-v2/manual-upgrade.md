...
related:
  ...
  - /influxdb/v2.7/upgrade/v1-to-v2/migrate-cqs/
---
...
[Download, install, and set up InfluxDB {{< current-version >}}](/influxdb/v2.7/get-started/).
...
[`influx` CLI configuration](/influxdb/v2.7/reference/cli/influx/#provide-required-authentication-credentials).
{{% /note %}}
...
| :--------------------------------- | :-------------------------------------------------------------------------------------------------------------------------------- |
| **[data]**                         |                                                                                                                                   |
| dir                                | [engine-path](/influxdb/v2.7/reference/config-options/#engine-path)                                                               |
| wal-dir                            | [engine-path](/influxdb/v2.7/reference/config-options/#engine-path)                                                               |
| wal-fsync-delay                    | [storage-wal-fsync-delay](/influxdb/v2.7/reference/config-options/#storage-wal-fsync-delay)                                       |
| index-version                      |                                                                                                                                   |
| trace-logging-enabled              |                                                                                                                                   |
| query-log-enabled                  |                                                                                                                                   |
| strict-error-handling              |                                                                                                                                   |
| validate-keys                      | [storage-validate-keys](/influxdb/v2.7/reference/config-options/#storage-validate-keys)                                           |
| cache-max-memory-size              | [storage-cache-max-memory-size](/influxdb/v2.7/reference/config-options/#storage-cache-max-memory-size)                           |
| cache-snapshot-memory-size         | [storage-cache-snapshot-memory-size](/influxdb/v2.7/reference/config-options/#storage-cache-snapshot-memory-size)                 |
| cache-snapshot-write-cold-duration | [storage-cache-snapshot-write-cold-duration](/influxdb/v2.7/reference/config-options/#storage-cache-snapshot-write-cold-duration) |
| compact-full-write-cold-duration   | [storage-compact-full-write-cold-duration](/influxdb/v2.7/reference/config-options/#storage-compact-full-write-cold-duration)     |
| max-concurrent-compactions         | [storage-max-concurrent-compactions](/influxdb/v2.7/reference/config-options/#storage-max-concurrent-compactions)                 |
| compact-throughput                 |                                                                                                                                   |
| compact-throughput-burst           | [storage-compact-throughput-burst](/influxdb/v2.7/reference/config-options/#storage-compact-throughput-burst)                     |
| tsm-use-madv-willneed              | [storage-tsm-use-madv-willneed](/influxdb/v2.7/reference/config-options/#storage-tsm-use-madv-willneed)                           |
| max-series-per-database            |                                                                                                                                   |
| max-values-per-tag                 |                                                                                                                                   |
| max-index-log-file-size            | [storage-max-index-log-file-size](/influxdb/v2.7/reference/config-options/#storage-max-index-log-file-size)                       |
| series-id-set-cache-size           | [storage-series-id-set-cache-size](/influxdb/v2.7/reference/config-options/#storage-series-id-set-cache-size)                     |
|                                    |                                                                                                                                   |
| **[retention]**                    |                                                                                                                                   |
| check-interval                     | [storage-retention-check-interval](/influxdb/v2.7/reference/config-options/#storage-retention-check-interval)                     |
|                                    |                                                                                                                                   |
| **[shard-precreation]**            |                                                                                                                                   |
| check-interval                     | [storage-shard-precreator-check-interval](/influxdb/v2.7/reference/config-options/#storage-shard-precreator-check-interval)       |
| advance-period                     | [storage-shard-precreator-advance-period](/influxdb/v2.7/reference/config-options/#storage-shard-precreator-advance-period)       |
|                                    |                                                                                                                                   |
| **[http]**                         |                                                                                                                                   |
| flux-enabled                       |                                                                                                                                   |
| flux-log-enabled                   | [flux-log-enabled](/influxdb/v2.7/reference/config-options/#flux-log-enabled)                                                     |
| bind-address                       | [http-bind-address](/influxdb/v2.7/reference/config-options/#http-bind-address)                                                   |
| auth-enabled                       |                                                                                                                                   |
| realm                              |                                                                                                                                   |
| log-enabled                        |                                                                                                                                   |
| suppress-write-log                 |                                                                                                                                   |
...
| write-tracing                      |                                                                                                                                   |
| pprof-enabled                      | [pprof-disabled](/influxdb/v2.7/reference/config-options/#pprof-disabled)                                                         |
| pprof-auth-enabled                 |                                                                                                                                   |
| debug-pprof-enabled                |                                                                                                                                   |
| ping-auth-enabled                  |                                                                                                                                   |
| https-enabled                      |                                                                                                                                   |
| https-certificate                  | [tls-cert](/influxdb/v2.7/reference/config-options/#tls-cert)                                                                     |
| https-private-key                  | [tls-key](/influxdb/v2.7/reference/config-options/#tls-key)                                                                       |
| shared-secret                      |                                                                                                                                   |
| max-row-limit                      |                                                                                                                                   |
...
| enqueued-write-timeout             | [http-write-timeout](/influxdb/v2.7/reference/config-options/#http-write-timeout)                                                 |
|                                    |                                                                                                                                   |
| **[logging]**                      |                                                                                                                                   |
| format                             |                                                                                                                                   |
| level                              | [log-level](/influxdb/v2.7/reference/config-options/#log-level)                                                                   |
| suppress-logo                      |                                                                                                                                   |
|                                    |                                                                                                                                   |
| **[tls]**                          |                                                                                                                                   |
| ciphers                            | [tls-strict-ciphers](/influxdb/v2.7/reference/config-options/#tls-strict-ciphers)                                                 |
| min-version                        | [tls-min-version](/influxdb/v2.7/reference/config-options/#tls-min-version)                                                       |
| max-version                        |                                                                                                                                   |
...
2.  Apply your 1.x custom settings to the comparable InfluxDB {{< current-version >}} settings using
   `influxd` flags, environment variables, or a {{< current-version >}} configuration file.
    ...
    [Configuration options](/influxdb/v2.7/reference/config-options/).
3.  **Restart `influxd`**.

## Create DBRP mappings
InfluxDB database and retention policy (DBRP) mappings associate database and
retention policy combinations with InfluxDB {{< current-version >}} [buckets](/influxdb/v2.7/reference/glossary/#bucket).
...
[Database and retention policy mapping](/influxdb/v2.7/reference/api/influxdb-1x/dbrp/)._

**To map a DBRP combination to an InfluxDB {{< current-version >}} bucket:**

1.  **Create a bucket**  
    [Create an InfluxDB {{< current-version >}} bucket](/influxdb/v2.7/organizations/buckets/create-bucket/).
...
2.  **Create a DBRP mapping**  
    Use the [`influx v1 dbrp create` command](/influxdb/v2.7/reference/cli/influx/v1/dbrp/create/)
    to create a DBRP mapping.
    Provide the following:

    - database name
    - retention policy name _(not retention period)_
    - [bucket ID](/influxdb/v2.7/organizations/buckets/view-buckets/)
...
3.  **Confirm the DBRP mapping was created**  
    Use the [`influx v1 dbrp list`](/influxdb/v2.7/reference/cli/influx/v1/dbrp/list/) to list existing DBRP mappings.
...
[`influx v1 dbrp` command documentation](/influxdb/v2.7/reference/cli/influx/v1/dbrp/).
...
Use [InfluxDB {{< current-version >}} token authentication](/influxdb/v2.7/security/tokens/) to
...
InfluxDB {{< current-version >}} provides a [1.x compatibility API](/influxdb/v2.7/reference/api/influxdb-1x/)
...
Use the InfluxDB {{< current-version >}} [`influx v1 auth create` command](/influxdb/v2.7/reference/cli/influx/v1/auth/create/)
to create a 1.x-compatible authorization that grants read/write permissions to specific {{< current-version >}} buckets.
Provide the following:

- list of [bucket IDs](/influxdb/v2.7/organizations/buckets/view-buckets/) to
...
[`influx v1 auth` command documentation](/influxdb/v2.7/reference/cli/influx/v1/auth/).
...
2. Use the **InfluxDB {{< current-version >}}** [`influx write` command](/influxdb/v2.7/reference/cli/influx/write/)
...
see [Migrate continuous queries to tasks](/influxdb/v2.7/upgrade/v1-to-v2/migrate-cqs/).
...
see [Query data with InfluxQL](/influxdb/v2.7/query-data/influxql/).
