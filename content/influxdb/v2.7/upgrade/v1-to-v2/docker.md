...
see [Automatically upgrade from InfluxDB 1.x to {{< current-version >}}](/influxdb/v2.7/upgrade/v1-to-v2/automatic-upgrade/).

### InfluxDB 2.x initialization credentials
The automated InfluxDB upgrade process bootstraps an initial admin user,
[organization](/influxdb/v2.7/reference/glossary/#organization), and
[bucket](/influxdb/v2.7/reference/glossary/#bucket) required by InfluxDB 2.x.
