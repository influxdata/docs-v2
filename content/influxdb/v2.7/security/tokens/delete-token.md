...
aliases:
  - /influxdb/v2.7/users/tokens/delete-token
menu:
  influxdb_2_7:
    name: Delete a token
...
{{< api-endpoint method="DELETE" endpoint="http://localhost:8086/api/v2/authorizations/AUTH_ID" api-ref="/influxdb/v2.7/api/#operation/DeleteAuthorizationsID" >}}
