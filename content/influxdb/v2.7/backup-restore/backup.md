...
weight: 101
related:
  - /influxdb/v2.7/backup-restore/restore/
  - /influxdb/v2.7/reference/cli/influx/backup/
products: [oss]
---

Use the [`influx backup` command](/influxdb/v2.7/reference/cli/influx/backup/) to back up
...
- [Automatically upgrade from InfluxDB 1.x to {{< current-version >}}](/influxdb/v2.7/upgrade/v1-to-v2/automatic-upgrade/)
- [Manually upgrade from InfluxDB 1.x to {{< current-version >}}](/influxdb/v2.7/upgrade/v1-to-v2/manual-upgrade/)
{{% /note %}}
...
- The **root authorization token** (the token created for the first user in the
  [InfluxDB setup process](/influxdb/v2.7/get-started/)).
