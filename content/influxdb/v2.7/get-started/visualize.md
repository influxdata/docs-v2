...
metadata: [5 / 5]
related:
  - /influxdb/v2.7/visualize-data/
  - /influxdb/v2.7/visualize-data/visualization-types/
  - /influxdb/v2.7/tools/chronograf/
  - /influxdb/v2.7/tools/grafana/
---
...
one of the available [visualization types](/influxdb/v2.7/visualize-data/visualization-types/).
...
3.  _(Optional)_ Select the visualization type from the visualization drop-down menu.
    There are many different [visualization types](/influxdb/v2.7/visualize-data/visualization-types/)
    available.
...
4.  Use the query time range selector to select an absolute time range that
    ...
    [data written in "Get started writing to InfluxDB"](/influxdb/v2.7/get-started/write/#view-the-written-data):
...
[predefined dashboard variables](/influxdb/v2.7/visualize-data/variables/#predefined-dashboard-variables),
...
4.  Select the default **Query** dashboard variable type.
    ...
    see [Variable types](/influxdb/v2.7/visualize-data/variables/variable-types/)._
5.  Enter the following Flux query to return all the different `room` tag values
    in your `get-started` bucket from the [Unix epoch](/influxdb/v2.7/reference/glossary/#unix-timestamp).
...
[Use and manage dashboard variables](/influxdb/v2.7/visualize-data/variables/)._

{{< page-nav prev="/influxdb/v2.7/get-started/process/" >}}
...
[basics of setting up, writing, querying, processing, and visualizing](/influxdb/v2.7/get-started/)
data with InfluxDB {{< current-version >}}.
Feel free to dive in deeper to each of these topics:

- [Write data to InfluxDB](/influxdb/v2.7/write-data/)
- [Query data in InfluxDB](/influxdb/v2.7/query-data/)
- [Process data with InfluxDB](/influxdb/v2.7/process-data/)
- [Visualize data with the InfluxDB UI](/influxdb/v2.7/visualize-data/)
