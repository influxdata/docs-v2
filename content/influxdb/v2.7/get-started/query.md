...
{{< api-endpoint endpoint="http://localhost:8086/api/v2/query" method="post" api-ref="/influxdb/v2.7/api/#operation/PostQuery" >}}
...
{{< api-endpoint endpoint="http://localhost:8086/query" method="post" api-ref="/influxdb/v2.7/api/v1-compatibility/#operation/PostQueryV1" >}}
