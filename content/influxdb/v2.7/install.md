...
related:
- /influxdb/v2.7/reference/cli/influx/auth/
- /influxdb/v2.7/reference/cli/influx/config/
- /influxdb/v2.7/reference/cli/influx/
- /influxdb/v2.7/security/tokens/
---
...
The InfluxDB server ([`influxd`](/influxdb/v2.7/reference/cli/influxd/)) and the
[`influx` CLI](/influxdb/v2.7/reference/cli/influx/) are packaged and
versioned separately.
For information about installing the `influx` CLI, see
[Install and use the influx CLI](/influxdb/v2.7/tools/influx-cli/).
{{% /note %}}
...
[`influx` CLI reference documentation](/influxdb/v2.7/reference/cli/influx/).
{{% /note %}}
...
the [InfluxDB HTTP API](/influxdb/v2.7/reference/api/).
...
To configure InfluxDB, see [InfluxDB configuration options](/influxdb/v2.7/reference/config-options/), and the [`influxd` documentation](/influxdb/v2.7/reference/cli/influxd) for information about
...
see [File system layout](/influxdb/v2.7/reference/internals/file-system-layout/?t=Linux#installed-as-a-package).
...
See InfluxDB [configuration options](/influxdb/v2.7/reference/config-options/) for more information.
...
_See the [`influxd` documentation](/influxdb/v2.7/reference/cli/influxd) for information about
available flags and options._
...
(Find more about configuring InfluxDB [here](https://docs.influxdata.com/influxdb/v2.7/reference/config-options/).)
...
Follow the [Linux installation instructions](/influxdb/v2.7/install/?t=Linux)
...
- [InfluxDB OSS](/influxdb/v2.7/), running on a 64-bit system
...
The [`influx` CLI](/influxdb/v2.7/reference/cli/influx/) lets you manage InfluxDB
from your command line.

<a class="btn" href="/influxdb/v2.7/tools/influx-cli/" target="_blank">Download and install the influx CLI</a>
...
- An admin [authorization](/influxdb/v2.7/security/tokens/) with the following properties:
  - The username and password that you provide.
  - An API token (_[operator token](/influxdb/v2.7/security/tokens/#operator-token)_).
...
- **`INFLUX_ORG`**: [your organization name](/influxdb/v2.7/organizations/view-orgs/).
- **`INFLUX_API_TOKEN`**: [your API token](/influxdb/v2.7/security/tokens/view-tokens/).
...
For more detail about configuration profiles, see [`influx config`](/influxdb/v2.7/reference/cli/influx/config/).

Once you have the `default` configuration profile, you're ready to [create All-Access tokens](#create-all-access-tokens)
or get started [collecting and writing data](/influxdb/v2.7/write-data).
...
To run the InfluxDB setup process with your automation scripts, pass [flags](/influxdb/v2.7/reference/cli/influx/setup/#flags)
...
and _[operator token](/influxdb/v2.7/security/tokens/#operator-token)_.
...
Because [Operator tokens](/influxdb/v2.7/security/tokens/#operator-token)
have full read and write access to all organizations in the database,
we recommend
[creating an All-Access token](/influxdb/v2.7/security/tokens/create-token/)
