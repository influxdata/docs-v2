...
See an overview of [notebook concepts](/influxdb/v2.7/notebooks/overview/#notebook-concepts), [notebook controls](/influxdb/v2.7/notebooks/overview/#notebook-controls), and [notebook cell types](/influxdb/v2.7/notebooks/overview/#notebook-cell-types) also know as the basic building blocks of a notebook.
...
- **{{< caps >}}Flux Script{{< /caps >}}**: Enter a raw Flux script.
  ...
  Data source cells work like the **Query Builder** or **Script Editor** in Data Explorer. For more information, see how to [query data with Flux and the Data Explorer](/influxdb/v2.7/query-data/execute-queries/data-explorer/#query-data-with-flux-and-the-data-explorer).
...
- **{{< caps >}}Alert{{< /caps >}}**: Set up alerts. See how to [monitor data and send alerts](/influxdb/v2.7/monitor-alert/).
- **{{< caps >}}Tasks{{< /caps >}}**: Use the notebook to set up and export a task. See how to [manage tasks in InfluxDB](/influxdb/v2.7/process-data/manage-tasks/).
