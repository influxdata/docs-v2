...
influxdb/v2.7/tags: [client libraries, python]
aliases:
  - /influxdb/v2.7/reference/api/client-libraries/python/
  - /influxdb/v2.7/reference/api/client-libraries/python-cl-guide/
  - /influxdb/v2.7/tools/client-libraries/python/
weight: 201
---
...
We are going to write some data in [line protocol](/influxdb/v2.7/reference/syntax/line-protocol/) using the Python library.
...
2. Define a few variables with the name of your [bucket](/influxdb/v2.7/organizations/buckets/), [organization](/influxdb/v2.7/organizations/), and [token](/influxdb/v2.7/security/tokens/).
...
5. Create a [point](/influxdb/v2.7/reference/glossary/#point) object and write it to InfluxDB using the `write` method of the API writer object. The write method requires three parameters: `bucket`, `org`, and `record`.
