...
weight: 100
aliases:
  - /influxdb/v2.7/reference/api/client-libraries/nodejs/install
---
...
Once you've installed the Javascript client library, you're ready to [write data](/influxdb/v2.7/api-guide/client-libraries/nodejs/write/) to InfluxDB or [get started](#get-started-with-examples) with other examples from the client library.
