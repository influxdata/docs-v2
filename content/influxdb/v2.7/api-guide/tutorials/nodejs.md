...
[create an _All-Access_ token](/influxdb/v2.7/security/tokens/create-token/)
...
1. Create a Flux query that gets the last row of each [series](/influxdb/v2.7/reference/glossary#series) that contains a `deviceauth` measurement.
...
To learn more about API tokens and authorizations, see [Manage API tokens](/influxdb/v2.7/security/tokens/)
