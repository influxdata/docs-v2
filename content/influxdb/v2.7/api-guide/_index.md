...
- [API Quick Start](/influxdb/v2.7/api-guide/api_intro/)
...
<a class="btn" href="/influxdb/v2.7/api/">InfluxDB OSS {{< current-version >}} API documentation</a>
...
To view the API documentation locally, [start InfluxDB](/influxdb/v2.7/get-started/#start-influxdb)
...
The InfluxDB v2 API includes [InfluxDB 1.x compatibility endpoints](/influxdb/v2.7/reference/api/influxdb-1x/)
