...
To update the notification endpoint selected for a notification rule, see [update notification rules](/influxdb/v2.7/monitor-alert/notification-rules/update/).
...
2. Update details as needed, and then click **Edit Notification Endpoint**.
   For details about each field, see [Create notification endpoints](/influxdb/v2.7/monitor-alert/notification-endpoints/create/).
