...
aliases:
  - /influxdb/v2.7/influxdb-templates/monitor/
related:
...
- Command line access to a machine [running InfluxDB OSS 2.x](/influxdb/v2.7/install/) and permissions to install Telegraf on this machine
