...
aliases: 
  - /influxdb/v2.7/query-data/common-queries/count_unique_values_for_column/
  - /influxdb/v2.7/query-data/common-queries/recalculate_value_column/
  - /influxdb/v2.7/query-data/common-queries/calculate_new_column/
menu:
  influxdb_2_7:
...
{{% note %}}
These examples use [NOAA water sample data](/influxdb/v2.7/reference/sample-data/#noaa-water-sample-data).
{{% /note %}}
