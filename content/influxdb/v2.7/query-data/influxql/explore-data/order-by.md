...
By default, InfluxDB returns results in ascending time order; the first [point](/influxdb/v2.7/reference/glossary/#point)
returned has the oldest [timestamp](/influxdb/v2.7/reference/glossary/#timestamp) and
...
`h2o_feet` [measurement](/influxdb/v2.7/reference/glossary/#measurement) first.
...
[`ORDER BY time DESC`](/influxdb/v2.7/query-data/influxql/explore-data/order-by/#order-by-time-desc) returns the most recent 12-minute time intervals
first.
