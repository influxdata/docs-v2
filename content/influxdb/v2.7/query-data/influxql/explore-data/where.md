...
description: >
  Use the `WHERE` clause to filter data based on [fields](/influxdb/v2.7/reference/glossary/#field), [tags](/influxdb/v2.7/reference/glossary/#tag), and/or [timestamps](/influxdb/v2.7/reference/glossary/#timestamp).
menu:
  influxdb_2_7:
    name: WHERE clause
    parent: Explore data
...
[fields](/influxdb/v2.7/reference/glossary/#field),
[tags](/influxdb/v2.7/reference/glossary/#tag), and/or
[timestamps](/influxdb/v2.7/reference/glossary/#timestamp).
...
The `WHERE` clause supports comparisons against string, boolean, float, and integer [field values](/influxdb/v2.7/reference/glossary/#field-value).
...
Single quote [tag values](/influxdb/v2.7/reference/glossary/#tag-value) in
the `WHERE` clause.
...
range is between `1677-09-21 00:12:43.145224194` UTC and [`now()`](/influxdb/v2.7/reference/glossary/#now).
...
[tag key](/influxdb/v2.7/reference/glossary/#tag-key) `location` is set to `santa_monica`.
...
The query returns data from the `h2o_feet` measurement with [timestamps](/influxdb/v2.7/reference/glossary/#timestamp)
