...
related:
  ...
  - /influxdb/v2.7/query-data/flux/conditional-logic/
  - /influxdb/v2.7/query-data/flux/regular-expressions/
list_code_example: |
  ```js
...
## The filter() function
`filter()` has an `fn` parameter that expects a [predicate function](/influxdb/v2.7/reference/glossary/#predicate-function),
an anonymous function comprised of one or more [predicate expressions](/influxdb/v2.7/reference/glossary/#predicate-expression).
...
1. Use `from()` to define your [bucket](/influxdb/v2.7/reference/glossary/#bucket).
