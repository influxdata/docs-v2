...
influxdb/v2.7/tags: [functions, custom, flux, aggregates]
menu:
  influxdb_2_7:
...
weight: 301
aliases:
  - /influxdb/v2.7/query-data/guides/custom-functions/custom-aggregate/
related:
...
[Creating custom functions](/influxdb/v2.7/query-data/flux/custom-functions)
