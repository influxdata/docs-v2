...
{{% note %}}
For example results, use the [bird migration sample data](/influxdb/v2.7/reference/sample-data/#bird-migration-sample-data)
...
The following example uses the [sample bird migration data](/influxdb/v2.7/query-data/flux/geo/#sample-data)
