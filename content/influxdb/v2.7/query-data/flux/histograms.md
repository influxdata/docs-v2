...
weight: 210
aliases:
  - /influxdb/v2.7/query-data/guides/histograms/
related:
...
The [Histogram visualization type](/influxdb/v2.7/visualize-data/visualization-types/histogram/)
...
Use the [Histogram visualization controls](/influxdb/v2.7/visualize-data/visualization-types/histogram/#histogram-controls)
