...
menu:
  influxdb_2_7:
    ...
    name: Median
influxdb/v2.7/tags: [query, median]
related:
  - /influxdb/v2.7/query-data/flux/percentile-quantile/
...
{{% note %}}
The examples below use the [example data variable](/influxdb/v2.7/query-data/flux/#example-data-variable).
{{% /note %}}
...
It is primarily used to [downsample data](/influxdb/v2.7/process-data/common-tasks/downsample-data/).
