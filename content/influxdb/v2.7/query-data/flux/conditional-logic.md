...
influxdb/v2.7/tags: [conditionals, flux]
menu:
  influxdb_2_7:
...
weight: 220
aliases:
  - /influxdb/v2.7/query-data/guides/conditional-logic/
related:
  - /influxdb/v2.7/query-data/flux/query-fields/
...
The following example uses an example `metric` [dashboard variable](/influxdb/v2.7/visualize-data/variables/)
