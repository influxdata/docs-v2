...
InfluxDB API endpoint](/influxdb/v2.7/api/#operation/GetTasksIDLogs) to view the log events for a task and exclude additional task metadata.
...
InfluxDB API endpoint](/influxdb/v2.7/api/#operation/GetTasksIDRuns) to view a task's run history.
...
endpoint](/influxdb/v2.7/api/#operation/GetTasksIDRunsIDLogs).
