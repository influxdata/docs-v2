...
description: >
  InfluxDB automatically creates a new stack each time you [apply an InfluxDB template](/influxdb/v2.7/influxdb-templates/use/)
  **without providing a stack ID**.
  To manually create or initialize a new stack, use the [`influx stacks init` command](/influxdb/v2.7/reference/cli/influx/stacks/init/).
menu:
  influxdb_2_7:
...
weight: 202
related:
  - /influxdb/v2.7/reference/cli/influx/stacks/init/
list_code_example: |
  ```sh
  influx apply \
    -o example-org \
...
To automatically create a new stack when [applying an InfluxDB template](/influxdb/v2.7/influxdb-templates/use/)
...
Use the [`influx stacks init` command](/influxdb/v2.7/reference/cli/influx/stacks/init/)
