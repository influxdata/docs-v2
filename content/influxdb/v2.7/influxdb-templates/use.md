...
related:
  ...
  - /influxdb/v2.7/reference/cli/influx/template/
  - /influxdb/v2.7/reference/cli/influx/template/validate/
---
...
use the [`influx template` command](/influxdb/v2.7/reference/cli/influx/template/).
...
the [`influx template validate` command](/influxdb/v2.7/reference/cli/influx/template/validate/).
...
## Apply templates
Use the [`influx apply` command](/influxdb/v2.7/reference/cli/influx/apply/) to install templates
...
For more information, see [InfluxDB stacks](/influxdb/v2.7/influxdb-templates/stacks/).
{{% /note %}}
...
Some templates include [environment references](/influxdb/v2.7/influxdb-templates/create/#include-user-definable-resource-names) that let you provide custom resource names.
...
Some templates use [secrets](/influxdb/v2.7/security/secrets/) in queries.
...
_To add a secret after applying a template, see [Add secrets](/influxdb/v2.7/security/secrets/manage-secrets/add/)._
