...
description: >
  ...
  [1.x compatibility API](/influxdb/v2.7/reference/api/influxdb-1x/).
menu:
  influxdb_2_7:
    name: Use Chronograf
...
3. Enter your InfluxDB connection credentials:
    ...
    - **Organization:** InfluxDB [organization](/influxdb/v2.7/organizations/)
    - **Token:** InfluxDB [API token](/influxdb/v2.7/security/tokens/)
    - **Telegraf Database Name:** InfluxDB [bucket](/influxdb/v2.7/organizations/buckets/)
...
For information, see [DBRP mapping](/influxdb/v2.7/reference/api/influxdb-1x/dbrp/){{% oss-only %}}.{{% /oss-only %}}
{{% cloud-only %}}and [Create DBRP mappings](/influxdb/v2.7/query-data/influxql/dbrp/#create-dbrp-mappings).{{% /cloud-only %}}
      {{% /note %}}
...
- [InfluxDB CLI](/influxdb/v2.7/reference/cli/influx/)
- [InfluxDB v2 API](/influxdb/v2.7/reference/api/)

### Limited InfluxQL support
InfluxDB Cloud and InfluxDB OSS {{< current-version >}} support InfluxQL **read-only** queries.
For more information, see [InfluxQL support](/influxdb/v2.7/query-data/influxql/#influxql-support).
