...
related:
  - /influxdb/v2.7/reference/cli/influx/v1/shell/
---
...
Use the [`influx v1 shell` command](/influxdb/v2.7/reference/cli/influx/v1/shell/)
...
- {{% oss-only %}}[InfluxDB host](/influxdb/v2.7/reference/urls/){{% /oss-only %}}
  {{% cloud-only %}}[InfluxDB Cloud region URL](/influxdb/cloud/reference/regions/){{% /cloud-only %}}
- [Organization name or ID](/influxdb/v2.7/organizations/view-orgs/)
- [API token](/influxdb/v2.7/security/tokens/)
...
[InfluxQL support in InfluxDB {{< current-version >}}](/influxdb/v2.7/query-data/influxql/#influxql-support).
