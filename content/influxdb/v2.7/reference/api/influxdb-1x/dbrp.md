...
related:
  ...
  - /influxdb/v2.7/reference/api/influxdb-1x/write
  - /influxdb/v2.7/api/#tag/DBRPs, InfluxDB v2 API /dbrps endpoint
...
[buckets](/influxdb/v2.7/reference/glossary/#bucket).
...
[1.x compatibility API](/influxdb/v2.7/reference/api/influxdb-1x/) requests to route operations to a bucket.
...
For more information, see [Create DBRP mappings](/influxdb/v2.7/query-data/influxql/dbrp/#create-dbrp-mappings).
{{% /note %}}
...
When you [create a bucket](/influxdb/v2.7/organizations/buckets/create-bucket/),
...
[`/write` compatibility endpoint](/influxdb/v2.7/reference/api/influxdb-1x/write/),
...
using the [`/query` compatibility endpoint](/influxdb/v2.7/reference/api/influxdb-1x/query/),
...
- If no mapped bucket exists, InfluxDB returns an error.
  See how to [Create DBRP mappings](/influxdb/v2.7/query-data/influxql/dbrp/#create-dbrp-mappings).

_For more information on the DBRP mapping API, see the [`/api/v2/dbrps` endpoint documentation](/influxdb/v2.7/api/#tag/DBRPs)._
