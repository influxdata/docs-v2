...
- **replicationq**: Store the replication queue for the [InfluxDB replication service](/influxdb/v2.7/write-data/replication/).
...
To customize this path, use the [engine-path](/influxdb/v2.7/reference/config-options/#engine-path)
...
To customize this path, use the [bolt-path](/influxdb/v2.7/reference/config-options/#bolt-path)
configuration option.

#### Configs path
File path to [`influx` CLI connection configurations](/influxdb/v2.7/reference/cli/influx/config/) (configs).
...
[upgrade process](/influxdb/v2.7/upgrade/v1-to-v2/docker/).
{{% /note %}}
