...
The `influx server-config` command displays the InfluxDB runtime [server configuration](/influxdb/v2.7/reference/config-options/).

{{% note %}}
To display the server configuration, you must use an [operator token](/influxdb/v2.7/security/tokens/#operator-token).
{{% /note %}}
