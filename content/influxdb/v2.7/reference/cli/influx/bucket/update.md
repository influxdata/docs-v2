...
weight: 201
aliases:
  - /influxdb/v2.7/reference/cli/influx/bucket/update/
related:
  - /influxdb/v2.7/organizations/buckets/update-bucket/
...
| `-r` | `--retention`            | New duration bucket will retain data. For detail, see [Retention periods](/influxdb/v2.7/reference/cli/influx/bucket/update/#retention-periods).                                  | duration   |                       |
