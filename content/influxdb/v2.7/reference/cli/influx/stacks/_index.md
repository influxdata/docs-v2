...
weight: 101
aliases:
  - /influxdb/v2.7/reference/cli/influx/pkg/stack/list/
influxdb/v2.7/tags: [templates]
cascade:
  related:
    - /influxdb/v2.7/influxdb-templates/stacks/
...
|:-------                                                      |:-----------        |
| [init](/influxdb/v2.7/reference/cli/influx/stacks/init/)     | Initialize a stack |
| [remove](/influxdb/v2.7/reference/cli/influx/stacks/remove/) | Remove a stack     |
