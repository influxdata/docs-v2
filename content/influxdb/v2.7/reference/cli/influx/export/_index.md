...
weight: 101
aliases:
  - /influxdb/v2.7/reference/cli/influx/pkg/export/
related:
...
|:----------                                                 |:-----------                                                |
| [all](/influxdb/v2.7/reference/cli/influx/export/all/)     | Export all resources in an organization as a template      |
| [stack](/influxdb/v2.7/reference/cli/influx/export/stack/) | Export all resources associated with a stack as a template |
