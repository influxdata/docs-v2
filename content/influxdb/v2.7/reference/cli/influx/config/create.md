...
To view CLI connection configurations after creating them, use [influx config list](/influxdb/v2.7/reference/cli/influx/config/list/).

{{% note %}}
**Note:** If you create multiple connection configurations (for example, separate admin and user configurations), use [`influx config <config-name>`](/influxdb/v2.7/reference/cli/influx/config/) to switch to the configuration you want to use.
{{% /note %}}
