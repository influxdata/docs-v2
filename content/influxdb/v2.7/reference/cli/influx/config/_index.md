...
|:----                                                         |:-----------                              |
| [create](/influxdb/v2.7/reference/cli/influx/config/create/) | Create a connection configuration        |
| [list](/influxdb/v2.7/reference/cli/influx/config/list/)     | List connection configurations           |
| [delete](/influxdb/v2.7/reference/cli/influx/config/rm/)     | Delete a connection configuration        |
| [set](/influxdb/v2.7/reference/cli/influx/config/set/)       | Set or update a connection configuration |
