...
related:
  ...
  - /influxdb/v2.7/write-data/replication
---
...
|:--------------------------------------------------------------|--------------------------------------|
| [`create`](/influxdb/v2.7/reference/cli/influx/remote/create) | Create a new remote connection       |
| [`delete`](/influxdb/v2.7/reference/cli/influx/remote/delete) | Delete a remote connection |
| [`list`](/influxdb/v2.7/reference/cli/influx/remote/list)     | List remote connections          |
| [`update`](/influxdb/v2.7/reference/cli/influx/remote/update) | Update a remote connection |
