...
The `influx write` command writes data to InfluxDB via stdin or from a specified file.
Write data using [line protocol](/influxdb/v2.7/reference/syntax/line-protocol),
[annotated CSV](/influxdb/v2.7/reference/syntax/annotated-csv), or
[extended annotated CSV](/influxdb/v2.7/reference/syntax/annotated-csv/extended/).
...
#### Line protocol
In **line protocol**, the [structure of the line data](/influxdb/v2.7/reference/syntax/line-protocol/#elements-of-line-protocol)
...
[annotation rows](/influxdb/v2.7/reference/syntax/annotated-csv/#annotations).

#### Extended annotated CSV
In **extended annotated CSV**, measurements, fields, and values and their types are determined by
[CSV annotations](/influxdb/v2.7/reference/syntax/annotated-csv/extended/#csv-annotations).
{{% /note %}}

## Subcommands
| Subcommand                                                 | Description                         |
|:----------                                                 |:-----------                         |
| [dryrun](/influxdb/v2.7/reference/cli/influx/write/dryrun) | Write to stdout instead of InfluxDB |
...
| `-p` | `--precision`       | [Precision](/influxdb/v2.7/write-data/#timestamp-precision) of the timestamps (default `ns`) |   string    | `INFLUX_PRECISION`    |
