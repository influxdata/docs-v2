...
aliases:
  - /influxdb/v2.7/reference/cli/influx/pkg/summary/
cascade:
  related:
    - /influxdb/v2.7/influxdb-templates/
...
|:----------                                                        |:-----------         |
| [validate](/influxdb/v2.7/reference/cli/influx/template/validate) | Validate a template |
