...
Related entries: [line protocol](/influxdb/v2.7/reference/syntax/line-protocol/), [point](#point)
...
Learn how to [create a check](/influxdb/v2.7/monitor-alert/checks/create/).
...
For more detail, see [Annotated CSV](/influxdb/v2.7/reference/syntax/annotated-csv/).
...
- [Flux](/influxdb/v2.7/reference/flux/language/types/)
...
See [line protocol](/influxdb/v2.7/reference/syntax/line-protocol/).
...
Learn how to [create a notification endpoint](/influxdb/v2.7/monitor-alert/notification-endpoints/create).
...
Learn how to [create a notification rule](/influxdb/v2.7/monitor-alert/notification-rules/create).
...
In Flux, you can process data with [InfluxDB tasks](/influxdb/v2.7/process-data/get-started/).
...
See [Query data in InfluxDB](/influxdb/v2.7/query-data/).
...
See [Flux REPL](/influxdb/v2.7/tools/flux-repl/) for information on building and using the REPL.
...
- [Manage buckets](/influxdb/v2.7/organizations/buckets/)
...
Generate a step-plot using the step [interpolation option for line graphs](/influxdb/v2.7/visualize-data/visualization-types/graph/#options).
...
For more information, see [Process Data with InfluxDB tasks](/influxdb/v2.7/process-data/).
...
Related entries: [Automatically configure Telegraf](/influxdb/v2.7/write-data/no-code/use-telegraf/auto-config/), [Manually configure Telegraf](/influxdb/v2.7/write-data/no-code/use-telegraf/manual-config/), [Telegraf plugins](/{{< latest "telegraf" >}}/plugins//), [Use Telegraf to collect data](/influxdb/v2.7/write-data/no-code/use-telegraf/), [View a Telegraf configuration](/influxdb/v2.7/telegraf-configs/view/)
...
Related entries: [Create a token](/influxdb/v2.7/security/tokens/create-token/).
...
Specify timestamp precision when [writing data to InfluxDB](/influxdb/v2.7/write-data/).
...
For information about how to window in Flux, see [Window and aggregate data with Flux](/influxdb/v2.7/query-data/flux/window-aggregate/).
