...
Use the [`influx` CLI](/influxdb/v2.7/reference/cli/influx/) and the
[`influx user password` command](/influxdb/v2.7/reference/cli/influx/user/password/)
command to update a user's password.
For more information, see
[Change your password](/influxdb/v2.7/users/change-password/).
...
- The [`/health` API endpoint](/influxdb/v2.7/api/#tag/Health) returns a JSON
...
- The [`/metrics` API endpoint](/influxdb/v2.7/api/#tag/Metrics) provides internal
  InfluxDB metrics in Prometheus exposition format. Use [Telegraf](/{{< latest "telegraf" >}}/),
  [InfluxDB scrapers](/influxdb/v2.7/write-data/no-code/scrape-data/), or the Flux
  ...
  For more information, see [Monitor InfluxDB OSS using a template](/influxdb/v2.7/monitor-alert/templates/monitor/)
...
For more information about each token type, see [Manage API tokens](/influxdb/v2.7/security/tokens/).
...
For more information, see [InfluxDB Shards and shard groups](/influxdb/v2.7/reference/internals/shards/).
...
For more information, see [Data retention](/influxdb/v2.7/reference/internals/data-retention/).
...
For more information, see [Handle duplicate data points](/influxdb/v2.7/write-data/best-practices/duplicate-points/).
...
[duplicate points](/influxdb/v2.7/write-data/best-practices/duplicate-points/).
...
- **Use a longer [shard group duration](/influxdb/v2.7/reference/internals/shards/#shard-group-duration)
...
- **Temporarily lower the
  [`storage-cache-snapshot-write-cold-duration` configuration setting](/influxdb/v2.7/reference/config-options/#storage-cache-snapshot-write-cold-duration)
...
[1.x compatiblity API](/influxdb/v2.7/reference/api/influxdb-1x/) which replicates
...
(configured as part of a [DBRP mapping](/influxdb/v2.7/query-data/influxql/)).
...
the default time range is `1677-09-21 00:12:43.145224194` UTC to [`now()`](/influxdb/v2.7/reference/glossary/#now).
...
[`WHERE` clause](/influxdb/v2.7/query_language/explore-data/#the-where-clause).
For example:
...
[use Flux](/influxdb/v2.7/reference/syntax/flux/flux-vs-influxql/#math-across-measurements).
...
Use the `_field` label in your [delete predicate](/influxdb/v2.7/reference/syntax/delete-predicate/)
...
Use the `_measurement` label in your [delete predicate](/influxdb/v2.7/reference/syntax/delete-predicate/)
...
To delete multiple measurements, [issue a delete request](/influxdb/v2.7/write-data/delete-data/)
...
[Series cardinality](/influxdb/v2.7/reference/glossary/#series-cardinality) is
...
InfluxDB maintains an in-memory index of every [series](/influxdb/v2.7/reference/glossary/#series)\.
...
InfluxDB maintains an in-memory index of every [series](/influxdb/v2.7/reference/glcloudary/#series).
...
See [Resolve high series cardinality](/influxdb/v2.7/write-data/best-practices/resolve-high-cardinality/)
...
1.  Use the **`influx` CLI** or **InfluxDB {{< current-version >}} API** to delete points
    associated with the series. See [Delete data](/influxdb/v2.7/write-data/delete-data/)
    for more information.
2.  Use the [`influxd inspect build-tsi` tool](/influxdb/v2.7/reference/cli/influxd/inspect/build-tsi/)
