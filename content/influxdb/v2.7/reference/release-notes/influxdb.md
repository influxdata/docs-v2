...
- Add the following `influxd` utilities:
  - [`influxd inspect check-schema`](/influxdb/v2.7/reference/cli/influxd/inspect/check-schema/)
  - [`influxd inspect merge-schema`](/influxdb/v2.7/reference/cli/influxd/inspect/merge-schema/)
  - [`influxd inspect report-db`](/influxdb/v2.7/reference/cli/influxd/inspect/report-db/)
- Validate packages during the build process.

### Bug Fixes

- Optimize [`SHOW FIELD KEY CARDINALITY`](/influxdb/v2.7/query-data/influxql/explore-schema/#show-field-key-cardinality)
  InfluxQL command.
...
- Support bucket names in the `replications` API and allow [InfluxDB 1.x DBRP](/influxdb/v2.7/query-data/influxql/dbrp) names as bucket names.
