...
Use the [`influx user list` command](/influxdb/v2.7/reference/cli/influx/user/list)
to view users.
...
See the [`influx user list` documentation](/influxdb/v2.7/reference/cli/influx/user/list)
