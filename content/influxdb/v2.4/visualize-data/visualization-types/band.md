...
2. Enter your query (see [Explore data with Flux and the Data Explorer](/influxdb/v2.4/visualize-data/explore-metrics/#explore-data-with-flux-and-the-data-explorer)). You must include the aggregate functions used to determine the Band Plot visualization boundaries in your query.
