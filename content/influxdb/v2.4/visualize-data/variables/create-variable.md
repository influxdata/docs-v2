...
_For information about variable types, see [Variable types](/influxdb/v2.4/visualize-data/variables/variable-types/)._
...
[Query dashboard variables](/influxdb/v2.4/visualize-data/variables/variable-types/#query).
The [Table visualization type](/influxdb/v2.4/visualize-data/visualization-types/table/) and
...
3. Use the [Table visualization type](/influxdb/v2.4/visualize-data/visualization-types/table/)
...
_For information about common Query variables, see [Common variable queries](/influxdb/v2.4/visualize-data/variables/common-variables/)._
...
4. Select your variable type. For details on each type, see [Variable types](/influxdb/v2.4/visualize-data/variables/variable-types/).
