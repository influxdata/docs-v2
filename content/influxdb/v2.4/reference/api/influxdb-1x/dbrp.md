...
[buckets](/influxdb/v2.4/reference/glossary/#bucket).
...
For more information, see [Create DBRP mappings](/influxdb/v2.4/query-data/influxql/dbrp/#create-dbrp-mappings).
{{% /note %}}
...
When you [create a bucket](/influxdb/v2.4/organizations/buckets/create-bucket/),
...
- If no mapped bucket exists, InfluxDB returns an error.
  See how to [Create DBRP mappings](/influxdb/v2.4/query-data/influxql/dbrp/#create-dbrp-mappings).
