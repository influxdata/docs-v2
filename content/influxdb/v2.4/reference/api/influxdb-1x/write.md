...
Use the `POST` request method to write [line protocol](/influxdb/v2.4/reference/syntax/line-protocol/)
...
### precision
The precision of [Unix timestamps](/influxdb/v2.4/reference/glossary/#unix-timestamp) in the line protocol.
...
- *`INFLUX_USERNAME`*: [InfluxDB 1.x username](/influxdb/v2.4/reference/api/influxdb-1x/#manage-credentials)
- *`INFLUX_PASSWORD_OR_TOKEN`*: [InfluxDB 1.x password or InfluxDB API token](/influxdb/v2.4/reference/api/influxdb-1x/#manage-credentials)
- *`INFLUX_API_TOKEN`*: your [InfluxDB API token](/influxdb/v2.4/reference/glossary/#token)
