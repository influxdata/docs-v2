...
- To demonstrate Flux queries in [Common queries](/influxdb/v2.4/query-data/common-queries/) and
[Common tasks](/influxdb/v2.4/process-data/common-tasks/)
- To demonstrate InfluxQL queries in [Query data with InfluxQL](/influxdb/v2.4/query-data/influxql/)
