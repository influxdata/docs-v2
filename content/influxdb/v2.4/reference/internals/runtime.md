...
| Option  | Include by |
|:--------|:-----------|
| Profile CPU | Pass a [duration of seconds](/influxdb/v2.4/reference/glossary/#duration) with the `cpu` query parameter in your request URL |
...
| Option  | Include by |
|:--------|:-----------|
| Seconds to sample | Pass an [unsigned integer](/influxdb/v2.4/reference/glossary/#unsigned-integer) with the `seconds` query parameter in your request URL |
...
| Option  | Include by |
|:--------|:-----------|
| Seconds to sample (default `30`) | Pass an [unsigned integer](/influxdb/v2.4/reference/glossary/#unsigned-integer) with the `seconds` query parameter in your request URL |
...
See how to [view your runtime server configuration](/influxdb/v2.4/reference/config-options/#view-your-runtime-server-configuration).
