...
## Shard groups
A shard group belongs to an InfluxDB [bucket](/influxdb/v2.4/reference/glossary/#bucket) and contains time series data for a specific time range defined by
...
the [retention period](/influxdb/v2.4/reference/glossary/#retention-period)
of the bucket:
...
flag with the [`influx bucket create`](/influxdb/v2.4/reference/cli/influx/bucket/create/#create-a-custom-shard-group-duration)
and [`influx bucket update`](/influxdb/v2.4/reference/cli/influx/bucket/update//#update-the-shard-group-duration-of-a-bucket) commands.
...
[`influx bucket list` command](/influxdb/v2.4/reference/cli/influx/bucket/list/).
...
- [`storage-shard-precreator-advance-period`](/influxdb/v2.4/reference/config-options/#storage-shard-precreator-advance-period)
- [`storage-shard-precreator-check-interval`](/influxdb/v2.4/reference/config-options/#storage-shard-precreator-check-interval)
...
- [`storage-compact-full-write-cold-duration`](/influxdb/v2.4/reference/config-options/#storage-compact-full-write-cold-duration)
- [`storage-compact-throughput-burst`](/influxdb/v2.4/reference/config-options/#storage-compact-throughput-burst)
- [`storage-max-concurrent-compactions`](/influxdb/v2.4/reference/config-options/#storage-max-concurrent-compactions)
- [`storage-max-index-log-file-size`](/influxdb/v2.4/reference/config-options/#storage-max-index-log-file-size)
- [`storage-series-file-max-concurrent-snapshot-compactions`](/influxdb/v2.4/reference/config-options/#storage-series-file-max-concurrent-snapshot-compactions)
- [`storage-series-file-max-concurrent-snapshot-compactions`](/influxdb/v2.4/reference/config-options/#storage-series-file-max-concurrent-snapshot-compactions)
...
- [`storage-retention-check-interval`](/influxdb/v2.4/reference/config-options/#storage-retention-check-interval)
