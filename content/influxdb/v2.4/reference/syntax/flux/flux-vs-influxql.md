...
aliases:
  - /influxdb/v2.4/reference/flux/flux-vs-influxql/
menu:
  influxdb_2_4_ref:
...
Flux is an alternative to [InfluxQL](/influxdb/v2.4/query-data/influxql/)
...
_For an in-depth walkthrough of using the `join()` function, see [how to join data with Flux](/influxdb/v2.4/query-data/flux/join/)._
...
_For an in-depth walkthrough of querying SQL data, see [Query SQL data sources](/influxdb/v2.4/query-data/flux/sql/)._
...
_For more examples, see [how to create histograms with Flux](/influxdb/v2.4/query-data/flux/histograms/)._
