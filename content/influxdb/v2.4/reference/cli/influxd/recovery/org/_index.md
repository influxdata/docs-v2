...
| :------------------------------------------------------------------ | :----------------- |
| [create](/influxdb/v2.4/reference/cli/influxd/recovery/org/create/) | Create new org     |
| [list](/influxdb/v2.4/reference/cli/influxd/recovery/org/list/)     | List organizations |
