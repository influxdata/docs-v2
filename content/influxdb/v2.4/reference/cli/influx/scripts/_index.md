...
|:----------                                                       |:-----------     |
| [create](/influxdb/v2.4/reference/cli/influx/scripts/create)     | Create script   |
| [delete](/influxdb/v2.4/reference/cli/influx/scripts/delete)     | Delete script   |
| [invoke](/influxdb/v2.4/reference/cli/influx/scripts/invoke)     | Invoke script   |
| [list](/influxdb/v2.4/reference/cli/influx/scripts/list)         | List scripts    |
| [retrieve](/influxdb/v2.4/reference/cli/influx/scripts/retrieve) | Retrieve script |
| [update](/influxdb/v2.4/reference/cli/influx/scripts/update)     | Update script   |
