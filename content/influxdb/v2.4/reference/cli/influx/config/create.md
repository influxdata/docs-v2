...
{{% note %}}
**Note:** If you create multiple config profiles (for example, separate admin and user configs), use [influx config set](/influxdb/v2.4/reference/cli/influx/config/set/) to switch to the config profile you want to use.
{{% /note %}}
