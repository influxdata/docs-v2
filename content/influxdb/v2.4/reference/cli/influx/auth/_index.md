...
menu:
  influxdb_2_4_ref:
    ...
    parent: influx
weight: 101
influxdb/v2.4/tags: [authentication]
cascade:
  related:
...
|:----------                                                    |:-----------                     |
| [active](/influxdb/v2.4/reference/cli/influx/auth/active)     | Activate API token   |
| [create](/influxdb/v2.4/reference/cli/influx/auth/create)     | Create API token     |
| [delete](/influxdb/v2.4/reference/cli/influx/auth/delete)     | Delete API token     |
| [list](/influxdb/v2.4/reference/cli/influx/auth/list)         | List API tokens      |
| [inactive](/influxdb/v2.4/reference/cli/influx/auth/inactive) | Inactivate API token |
