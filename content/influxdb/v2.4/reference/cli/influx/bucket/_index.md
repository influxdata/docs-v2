...
|:----------                                                  |:-----------   |
| [create](/influxdb/v2.4/reference/cli/influx/bucket/create) | Create bucket |
| [delete](/influxdb/v2.4/reference/cli/influx/bucket/delete) | Delete bucket |
| [list](/influxdb/v2.4/reference/cli/influx/bucket/list)     | List buckets  |
| [update](/influxdb/v2.4/reference/cli/influx/bucket/update) | Update bucket |
