...
menu:
  influxdb_2_4_ref:
    ...
    parent: influx
weight: 101
influxdb/v2.4/tags: [buckets, bucket-schema]
cascade:
  related:
...
| :----------------------------------------------------------------- | :--------------------- |
| [create](/influxdb/v2.4/reference/cli/influx/bucket-schema/create) | Create a bucket schema |
| [list](/influxdb/v2.4/reference/cli/influx/bucket-schema/list)     | List bucket schemas    |
| [update](/influxdb/v2.4/reference/cli/influx/bucket-schema/update) | Update a bucket schema |
