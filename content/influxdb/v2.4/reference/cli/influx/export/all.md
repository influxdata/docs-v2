...
weight: 201
aliases:
  - /influxdb/v2.4/reference/cli/influx/pkg/export/all/
related:
...
For information about creating an All-Access API token, see [Create an API token](/influxdb/v2.4/security/tokens/create-token/).
{{% /note %}}
...
[template resources](/influxdb/v2.4/influxdb-templates/#template-resources).
