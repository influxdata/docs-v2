...
The `influx delete` command deletes [points](/influxdb/v2.4/reference/glossary/#point)
...
| `-p` | `--predicate`     | InfluxQL-like predicate string (see [Delete predicate](/influxdb/v2.4/reference/syntax/delete-predicate)) | string     |                       |
