...
aliases:
  - /influxdb/v2.4/write-data/no-code/use-telegraf/auto-config/view-telegraf-config/
  - /influxdb/v2.4/collect-data/use-telegraf/auto-config/view-telegraf-config
---
...
## Use the influx CLI
Use the [`influx telegrafs` command](/influxdb/v2.4/reference/cli/influx/telegrafs/) to
