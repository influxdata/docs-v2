...
To learn the benefits and concepts of notebooks, see [Overview of Notebooks](/influxdb/v2.4/notebooks/overview/).
...
6. To define your data source query, do one of the following:
   ...
   - If your notebook uses a **Flux Script** cell, enter or paste a [Flux script](/influxdb/v2.4/query-data/flux/).
7. {{% oss-only %}}
...
- To change your [visualization type](/influxdb/v2.4/visualize-data/visualization-types/), select a new type from the drop-down list at the top of the cell.
...
Add a [data source cell](/influxdb/v2.4/notebooks/overview/#data-source) to pull information into your notebook.
...
A validation cell uses the **Table** [visualization type](/influxdb/v2.4/visualize-data/visualization-types/) to display query results from a data source cell.
...
Add a visualization cell to render query results as a [Visualization type](/influxdb/v2.4/visualize-data/visualization-types/).
...
For detail on available visualization types and how to use them, see [Visualization types](/influxdb/v2.4/visualize-data/visualization-types/).

## Add an action cell

Add an [action cell](/influxdb/v2.4/notebooks/overview/#action) to create an [alert](/influxdb/v2.4/monitor-alert/)
{{% cloud-only %}}or{{% /cloud-only %}}{{% oss-only %}},{{% /oss-only %}} process data with a [task](/influxdb/v2.4/process-data/manage-tasks/)
...
To add an [alert](/influxdb/v2.4/monitor-alert/) to your notebook, do the following:
...
To add a [task](/influxdb/v2.4/process-data/manage-tasks/) to your notebook, do the following:
