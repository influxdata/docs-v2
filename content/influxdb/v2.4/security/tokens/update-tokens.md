...
aliases:
  - /influxdb/v2.4/users/tokens/update-tokens
menu:
  influxdb_2_4:
    name: Update a token
...
Use the [`influx auth active` command](/influxdb/v2.4/reference/cli/influx/auth/active)
to activate a token.
...
```
To get the current status of a token, use the JSON output of the [`influx auth list` command](/influxdb/v2.4/reference/cli/influx/auth/list).
...
Use the [`influx auth inactive` command](/influxdb/v2.4/reference/cli/influx/auth/active)
...
[{{< api-endpoint method="PATCH" endpoint="http://localhost:8086/api/v2/authorizations/AUTH_ID" >}}](/influxdb/v2.4/api/#operation/PatchAuthorizationsID)
