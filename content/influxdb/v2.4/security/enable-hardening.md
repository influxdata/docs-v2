...
influxdb/v2.4/tags: [security, hardening]
---
...
[`hardening-enabled` configuration option](/influxdb/v2.4/reference/config-options/#hardening-enabled)
...
[template fetching](/influxdb/v2.4/influxdb-templates/) and
[notification endpoints](influxdb/v2.4/monitor-alert/notification-endpoints/)
