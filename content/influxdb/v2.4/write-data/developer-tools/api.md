...
| Timestamp precision  | Use the [`precision`](/influxdb/v2.4/tools/influxql-shell/#precision) query parameter in your request URL. Default is `ns`. |
...
[InfluxDB API Write documentation](/influxdb/v2.4/api/#operation/PostWrite)._
