...
weight: 101
description: >
  Use Telegraf to collect and write data to InfluxDB v2.4.
...
aliases:
  ...
  - /influxdb/v2.4/write-data/use-telegraf/
menu:
  influxdb_2_4:
    name: Telegraf (agent)
...
This article describes how to use Telegraf to collect and store data in InfluxDB v2.4.
