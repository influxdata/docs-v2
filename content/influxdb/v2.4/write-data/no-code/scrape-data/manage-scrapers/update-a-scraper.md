...
aliases:
  - /influxdb/v2.4/collect-data/scrape-data/manage-scrapers/update-a-scraper
  - /influxdb/v2.4/write-data/scrape-data/manage-scrapers/update-a-scraper
menu:
  influxdb_2_4:
...
To modify either, [create a new scraper](/influxdb/v2.4/write-data/no-code/scrape-data/manage-scrapers/create-a-scraper).
{{% /note %}}
