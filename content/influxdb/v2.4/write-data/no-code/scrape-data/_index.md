...
aliases:
  - /influxdb/v2.4/collect-data/scraper-metrics-endpoint
  - /influxdb/v2.4/collect-data/scrape-data
  - /influxdb/v2.4/write-data/scrape-data
  - /influxdb/v2.4/write-data/scrapable-endpoints
influxdb/v2.4/tags: [scraper]
menu:
  influxdb_2_4:
    name: Scrape data
