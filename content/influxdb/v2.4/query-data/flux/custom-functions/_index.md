...
influxdb/v2.4/tags: [functions, custom, flux]
menu:
  influxdb_2_4:
...
weight: 220
aliases:
  - /influxdb/v2.4/query-data/guides/custom-functions/
list_code_example: |
  ```js
...
function operations and variables inside of a [block (`{}`)](/influxdb/v2.4/reference/flux/language/blocks/)
