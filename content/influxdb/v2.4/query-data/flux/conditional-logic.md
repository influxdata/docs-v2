...
influxdb/v2.4/tags: [conditionals, flux]
menu:
  influxdb_2_4:
...
weight: 220
aliases:
  - /influxdb/v2.4/query-data/guides/conditional-logic/
related:
  - /influxdb/v2.4/query-data/flux/query-fields/
...
The following example uses an example `metric` [dashboard variable](/influxdb/v2.4/visualize-data/variables/)
