...
weight: 220
aliases:
  - /influxdb/v2.4/query-data/guides/manipulate-timestamps/
  - /influxdb/v2.4/query-data/flux/manipulate-timestamps/
related:
...
to convert a [Unix **nanosecond** timestamp](/influxdb/v2.4/reference/glossary/#unix-timestamp)
to an [RFC3339 timestamp](/influxdb/v2.4/reference/glossary/#rfc3339-timestamp).
