...
- [Technical analysis](/influxdb/v2.4/query-data/influxql/view-functions/technical-analysis/)
  - [CHANDE_MOMENTUM_OSCILLATOR()](/influxdb/v2.4/query-data/influxql/view-functions/technical-analysis/#chande-momentum-oscillator)
  - [EXPONENTIAL_MOVING_AVERAGE()](/influxdb/v2.4/query-data/influxql/view-functions/technical-analysis/#exponential-moving-average)
  - [DOUBLE_EXPONENTIAL_MOVING_AVERAGE()](/influxdb/v2.4/query-data/influxql/view-functions/technical-analysis/#double-exponential-moving-average)
  - [KAUFMANS_EFFICIENCY_RATIO()](/influxdb/v2.4/query-data/influxql/view-functions/technical-analysis/#kaufmans-efficiency-ratio)
  ...
  - [TRIPLE_EXPONENTIAL_MOVING_AVERAGE()](/influxdb/v2.4/query-data/influxql/view-functions/technical-analysis/#triple-exponential-moving-average)
  - [TRIPLE_EXPONENTIAL_DERIVATIVE()](/influxdb/v2.4/query-data/influxql/view-functions/technical-analysis/#triple-exponential-derivative)
  - [RELATIVE_STRENGTH_INDEX()](/influxdb/v2.4/query-data/influxql/view-functions/technical-analysis/#relative-strength-index)
  - [HOLT_WINTERS()](/influxdb/v2.4/query-data/influxql/view-functions/technical-analysis/#holt-winters)
