...
influxdb/v2.4/tags: [flux, transform, query]
menu:
  influxdb_2_4:
    name: Transform data
...
When [querying data from InfluxDB](/influxdb/v2.4/query-data/get-started/query-influxdb),
...
## Query data
Use the query built in the previous [Query data from InfluxDB](/influxdb/v2.4/query-data/get-started/query-influxdb)
...
You can also [create custom functions](/influxdb/v2.4/query-data/flux/custom-functions) in your Flux queries.
...
view the [Window and aggregate data](/influxdb/v2.4/query-data/flux/window-aggregate) guide._

---

{{< page-nav prev="/influxdb/v2.4/query-data/get-started/query-influxdb/" >}}
