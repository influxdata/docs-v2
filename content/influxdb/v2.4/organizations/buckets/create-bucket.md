...
Use the [`influx bucket create` command](/influxdb/v2.4/reference/cli/influx/bucket/create)
...
instance _(see [InfluxDB URLs](/influxdb/v2.4/reference/urls/))_.
...
[InfluxDB API Buckets documentation](/influxdb/v2.4/api/#operation/PostBuckets)._
