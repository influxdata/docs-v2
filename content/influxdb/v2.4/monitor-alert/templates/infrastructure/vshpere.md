...
- one [dashboard](/influxdb/v2.4/reference/glossary/#dashboard): **vsphere**
- one [bucket](/influxdb/v2.4/reference/glossary/#bucket): `vsphere`
- label: vsphere
- one [Telegraf configuration](/influxdb/v2.4/telegraf-configs/): InfluxDB v2 output plugin, vSphere input plugin
- one variable: `bucket`
...
2. [Install Telegraf](/{{< latest "telegraf" >}}/introduction/installation/) on a server with network access to both the vSphere host and [InfluxDB v2 API](/influxdb/v2.4/reference/api/).
