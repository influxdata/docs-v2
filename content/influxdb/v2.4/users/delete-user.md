...
[Remove a member from an organization](/influxdb/v2.4/organizations/members/remove-member/).
{{% /warn %}}
...
Use the [`influx user delete` command](/influxdb/v2.4/reference/cli/influx/user/delete)
