...
{{% note %}}
You can also use the [InfluxDB checks and notifications system](/influxdb/v2.4/monitor-alert/)
...
This grouping is important as you [aggregate data](#aggregate-data).
