---
title: Manually upgrade from InfluxDB 1.x to 2.2
list_title: Manually upgrade from 1.x to 2.2
description: >
  To manually upgrade from InfluxDB 1.x to InfluxDB 2.2, migrate data, create
