---
title: Upgrade from InfluxDB 2.x to InfluxDB 2.2
description: >
...
### Manually upgrade
To manually upgrade, [download and install the latest version of InfluxDB {{< current-version >}} for macOS](/influxdb/v2.2/install/#manually-download-and-install)
...
[Download and install the latest version of InfluxDB {{< current-version >}} for Linux](/influxdb/v2.2/install/?t=Linux#download-and-install-influxdb-v21)
...
[Download and install the latest version of InfluxDB {{< current-version >}} for Windows](/influxdb/v2.2/install/?t=Windows)
in place of current 2.x version.
