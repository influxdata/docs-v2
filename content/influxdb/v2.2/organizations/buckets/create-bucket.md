...
Use the [`influx bucket create` command](/influxdb/v2.2/reference/cli/influx/bucket/create)
...
instance _(see [InfluxDB URLs](/influxdb/v2.2/reference/urls/))_.
...
[InfluxDB API Buckets documentation](/influxdb/v2.2/api/#operation/PostBuckets)._
