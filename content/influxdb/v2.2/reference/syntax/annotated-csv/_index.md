...
[`influx write` command](/influxdb/v2.2/reference/cli/influx/write/) to write annotated CSV to InfluxDB.
...
[line protocol data types and format](/influxdb/v2.2/reference/syntax/line-protocol/#data-types-and-format)._
...
Time column values should be **Unix timestamps** (in an [accepted timestamp precision](/influxdb/v2.2/write-data/#timestamp-precision)),
