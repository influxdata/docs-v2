...
description: >
  ...
  how CSV data should be converted to [line protocol](/influxdb/v2.2/reference/syntax/line-protocol/)
...
weight: 201
influxdb/v2.2/tags: [csv, syntax, write]
related:
...
Extended annotated CSV supports all [Annotated CSV](/influxdb/v2.2/reference/syntax/annotated-csv/)
annotations.

{{% warn %}}
The Flux [`csv.from` function](/{{< latest "flux" >}}/stdlib/csv/from/) only supports
[annotated CSV](/influxdb/v2.2/reference/syntax/annotated-csv/), not extended annotated CSV.
{{% /warn %}}
...
### datatype
Use the `#datatype` annotation to specify the [line protocol element](/influxdb/v2.2/reference/syntax/line-protocol/#elements-of-line-protocol)
a column represents.
...
The `influx write` command converts timestamps to [Unix timestamps](/influxdb/v2.2/reference/glossary/#unix-timestamp).
...
use the [`influx write --precision` flag](/influxdb/v2.2/reference/cli/influx/write/#flags)
to specify the [timestamp precision](/influxdb/v2.2/reference/glossary/#precision).
{{% /note %}}
...
see [Line protocol data types and formats](/influxdb/v2.2/reference/syntax/line-protocol/#data-types-and-format).
...
##### string
Column is a **[string](/influxdb/v2.2/reference/glossary/#string) field**.

##### double
Column is a **[float](/influxdb/v2.2/reference/glossary/#float) field**.
...
##### long
Column is an **[integer](/influxdb/v2.2/reference/glossary/#integer) field**.
...
##### unsignedLong
Column is an **[unsigned integer (uinteger)](/influxdb/v2.2/reference/glossary/#unsigned-integer) field**.
If column values contain separators such as periods (`.`) or commas (`,`), specify
...
##### boolean
Column is a **[boolean](/influxdb/v2.2/reference/glossary/#boolean) field**.
If column values are not [supported boolean values](/influxdb/v2.2/reference/syntax/line-protocol/#boolean),
...
[line protocol elements](/influxdb/v2.2/reference/syntax/line-protocol/#elements-of-line-protocol)
