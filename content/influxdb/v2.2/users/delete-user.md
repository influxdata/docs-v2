...
[Remove a member from an organization](/influxdb/v2.2/organizations/members/remove-member/).
{{% /warn %}}
...
Use the [`influx user delete` command](/influxdb/v2.2/reference/cli/influx/user/delete)
