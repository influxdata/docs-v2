...
Use the [`influx write` command](/influxdb/v2.2/reference/cli/influx/write/) to write CSV data
to InfluxDB. Include [Extended annotated CSV](/influxdb/v2.2/reference/syntax/annotated-csv/extended/)
annotations to specify how the data translates into [line protocol](/influxdb/v2.2/reference/syntax/line-protocol/).
...
- [Use Telegraf to write data](/influxdb/v2.2/write-data/no-code/use-telegraf/)
...
The `influx write` command supports [Extended annotated CSV](/influxdb/v2.2/reference/syntax/annotated-csv/extended)
...
- [measurement](/influxdb/v2.2/reference/syntax/line-protocol/#measurement)
- [field set](/influxdb/v2.2/reference/syntax/line-protocol/#field-set)
- [timestamp](/influxdb/v2.2/reference/syntax/line-protocol/#timestamp) _(Optional but recommended)_
- [tag set](/influxdb/v2.2/reference/syntax/line-protocol/#tag-set) _(Optional)_

Use CSV annotations to specify which of these elements each column represents.

## Write raw query results back to InfluxDB
Flux returns query results in [annotated CSV](/influxdb/v2.2/reference/syntax/annotated-csv/).
...
[element required to write to InfluxDB](/influxdb/v2.2/reference/syntax/line-protocol/#elements-of-line-protocol)
...
### Define constants
Use the Extended annotated CSV [`#constant` annotation](/influxdb/v2.2/reference/syntax/annotated-csv/extended/#constant)
...
Extended annotated CSV supports [annotation shorthand](/influxdb/v2.2/reference/syntax/annotated-csv/extended/#annotation-shorthand),
...
### Ignore columns
Use the Extended annotated CSV [`#datatype ignored` annotation](/influxdb/v2.2/reference/syntax/annotated-csv/extended/#ignored)
...
or contain group separators, [define your numeric format](/influxdb/v2.2/reference/syntax/annotated-csv/extended/#double)
...
You can also [define a custom column separator](/influxdb/v2.2/reference/syntax/annotated-csv/extended/#define-custom-column-separator).
{{% /note %}}
...
Line protocol supports only [specific boolean values](/influxdb/v2.2/reference/syntax/line-protocol/#boolean).
If your CSV data contains boolean values that line protocol does not support,
[define your boolean format](/influxdb/v2.2/reference/syntax/annotated-csv/extended/#boolean)
...
If using a different timestamp format, [define your timestamp format](/influxdb/v2.2/reference/syntax/annotated-csv/extended/#datetime)
...
The example below writes [NOAA water sample data](/influxdb/v2.2/reference/sample-data/#noaa-water-sample-data) to an example `noaa` bucket in an example organization:
...
See [annotations](/influxdb/v2.2/reference/syntax/annotated-csv/#annotations) for more information.
...
See an example of valid syntax for [annotated CSV in Flux](/influxdb/v2.2/reference/syntax/annotated-csv/#annotated-csv-in-flux).
