...
the [`task.every` option](/influxdb/v2.5/process-data/task-options/#every).
...
If the migration task fails, [view your task logs](/influxdb/v2.5/process-data/manage-tasks/task-run-history/)
