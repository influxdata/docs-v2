...
- [Telegraf](/influxdb/v2.5/write-data/no-code/use-telegraf/)
- [InfluxDB client libraries](/influxdb/v2.5/api-guide/client-libraries/)
- [InfluxDB scrapers](/influxdb/v2.5/write-data/no-code/scrape-data/)
{{% /note %}}
...
_Specify timestamp precision when [writing to InfluxDB](/influxdb/v2.5/write-data/#timestamp-precision)._
...
Each [InfluxDB client library](/influxdb/v2.5/api-guide/client-libraries/) provides
...
For specific instructions, see the [InfluxDB client libraries documentation](/influxdb/v2.5/api-guide/client-libraries/).
{{% /tab-content %}}
{{% tab-content %}}
...
Use the [`influx write`](/influxdb/v2.5/reference/cli/influx/write/) `--rate-limit` flag to control the rate of writes.
...
The `--rate-limit` flag can be also used with [`influx write dryrun`](/influxdb/v2.5/reference/cli/influx/write/dryrun/).
