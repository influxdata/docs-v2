...
seotitle: Automatically configure Telegraf for InfluxDB v2.5
description: >
...
aliases:
  - /influxdb/v2.5/collect-data/use-telegraf/auto-config
  - /influxdb/v2.5/write-data/use-telegraf/auto-config
menu:
  influxdb_2_5:
...
Requests to the [InfluxDB v2 API](/influxdb/v2.5/reference/api/) must include an API token.
A token identifies specific permissions to the InfluxDB instance.

### Configure your token as an environment variable

1. Find your API token. _For information about viewing tokens, see [View tokens](/influxdb/v2.5/security/tokens/view-tokens/)._
...
[Telegraf configurations](/influxdb/v2.5/telegraf-configs/).
