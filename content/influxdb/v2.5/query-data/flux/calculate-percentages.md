...
description: >
  Use [`pivot()` or `join()`](/influxdb/v2.5/query-data/flux/mathematic-operations/#pivot-vs-join)
...
weight: 209
aliases:
 - /influxdb/v2.5/query-data/guides/calculate-percentages/
related:
  - /influxdb/v2.5/query-data/flux/mathematic-operations
...
2. Use [`pivot()` or `join()`](/influxdb/v2.5/query-data/flux/mathematic-operations/#pivot-vs-join)
...
_See [Pivot vs join](/influxdb/v2.5/query-data/flux/mathematic-operations/#pivot-vs-join)._
{{% /note %}}
...
1. Ensure measurements are in the same [bucket](/influxdb/v2.5/reference/glossary/#bucket).
