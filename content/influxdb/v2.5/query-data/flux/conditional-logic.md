...
influxdb/v2.5/tags: [conditionals, flux]
menu:
  influxdb_2_5:
...
weight: 220
aliases:
  - /influxdb/v2.5/query-data/guides/conditional-logic/
related:
...
The following example uses an example `metric` [dashboard variable](/influxdb/v2.5/visualize-data/variables/)
