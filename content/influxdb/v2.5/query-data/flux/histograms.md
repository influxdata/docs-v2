...
weight: 210
aliases:
  - /influxdb/v2.5/query-data/guides/histograms/
related:
...
The [Histogram visualization type](/influxdb/v2.5/visualize-data/visualization-types/histogram/)
...
Use the [Histogram visualization controls](/influxdb/v2.5/visualize-data/visualization-types/histogram/#histogram-controls)
