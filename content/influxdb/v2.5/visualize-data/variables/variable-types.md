...
_For examples of dashboard variable queries, see [Common variable queries](/influxdb/v2.5/visualize-data/variables/common-variables)._
...
- Do not use any [predefined dashboard variables](/influxdb/v2.5/visualize-data/variables/#predefined-dashboard-variables) in variable queries.
{{% /note %}}
...
_For more on using dashboard variables, see [Use and manage variables](/influxdb/v2.5/visualize-data/variables/)._
