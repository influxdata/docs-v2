...
For more information, see [InfluxDB key concepts](/influxdb/v2.5/reference/key-concepts/data-elements/).
{{% /note %}}

## \_monitoring system bucket
The `_monitoring` system bucket stores InfluxDB data used to
[monitor data and send alerts](/influxdb/v2.5/monitor-alert/).
...
The `_tasks` system bucket stores data related to [InfluxDB task](/influxdb/v2.5/process-data/) executions.
