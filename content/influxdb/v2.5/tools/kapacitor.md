...
[InfluxDB 1.x compatibility API](/influxdb/v2.5/reference/api/influxdb-1x/), so
...
or [InfluxDB OSS URLs](/influxdb/v2.5/reference/urls/).
...
- **password:** InfluxDB [API token](/influxdb/v2.5/security/tokens/)
...
For information about token permissions, see [Create a token](/influxdb/v2.5/security/tokens/create-token/).
{{% /warn %}}
...
2. [Create a DBRP mapping](/influxdb/v2.5/query-data/influxql/dbrp/#create-dbrp-mappings). 
...
For more information, see [DBRP mapping](/influxdb/v2.5/reference/api/influxdb-1x/dbrp/){{% oss-only %}}.{{% /oss-only %}}
