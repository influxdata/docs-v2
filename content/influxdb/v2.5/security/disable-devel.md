...
influxdb/v2.6/tags: [security, development]
---
...
- [Disable /debug/pprof](/influxdb/v2.6/reference/config-options/#pprof-disabled). This endpoint provides runtime profiling data.
- [Disable /metrics](/influxdb/v2.6/reference/config-options/#metrics-disabled). This endpoint exposes [internal InfluxDB metrics](/influxdb/v2.2/reference/internals/metrics/).
- [Disable UI](/influxdb/v2.6/reference/config-options/#ui-disabled). The user interface for InfluxDB.
