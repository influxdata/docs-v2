...
- **expression_y**: Expression to identify the `y` numeric value or one or more
  ...
  Can be a number literal, [field key](/influxdb/cloud-serverless/reference/glossary/#field-key),
  constant, or wildcard (`*`).
  Supports numeric field types.
...
Returns the running total of subsequent [field values](/influxdb/cloud-serverless/reference/glossary/#field-value).
...
Returns the rate of change between subsequent [field values](/influxdb/cloud-serverless/reference/glossary/#field-value)
per `unit`.
...
- **unit**: Unit of time to use to calculate the rate of change.
  Supports [duration literals](/influxdb/cloud-serverless/reference/influxql/#durations).
...
Returns the result of subtraction between subsequent [field values](/influxdb/cloud-serverless/reference/glossary/#field-value).
...
Returns the rolling average across a window of subsequent [field values](/influxdb/cloud-serverless/reference/glossary/#field-value).
