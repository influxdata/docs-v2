...
{{% note %}}
Upgrade to InfluxDB v3 to use new client libraries compatible with InfluxDB write APIs, SQL, and InfluxQL. For more information, see [InfluxDB client libraries](/influxdb/cloud-serverless/reference/client-libraries/v3/).
{{% /note %}}
