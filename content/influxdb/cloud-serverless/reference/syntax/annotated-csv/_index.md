...
[`influx write` command](/influxdb/cloud-serverless/reference/cli/influx/write/) to write annotated CSV to InfluxDB.
...
[line protocol data types and format](/influxdb/cloud-serverless/reference/syntax/line-protocol/#data-types-and-format)._
