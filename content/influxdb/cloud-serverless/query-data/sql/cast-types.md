...
related:
  - /influxdb/cloud-serverless/reference/sql/data-types/
list_code_example: |
  ```sql
  -- CAST clause
...
[get started sample data](/influxdb/cloud-serverless/get-started/write/#construct-line-protocol)
and: 
...
- **Timestamps**: Returns the equivalent
  [nanosecond epoch timestamp](/influxdb/cloud-serverless/reference/glossary/#unix-timestamp).
