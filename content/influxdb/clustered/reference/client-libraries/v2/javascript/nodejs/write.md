...
- [Install the client library and other dependencies](/influxdb/clustered/api-guide/client-libraries/nodejs/install/).

### Write data with the client library

1. Instantiate a client by calling the `new InfluxDB()` constructor with your InfluxDB URL and database token (environment variables you already set in the [Install section](/influxdb/clustered/api-guide/client-libraries/nodejs/install/)).
