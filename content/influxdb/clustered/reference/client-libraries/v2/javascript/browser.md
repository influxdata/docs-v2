...
For more examples, see how to [write data using the JavaScript client library for Node.js](/influxdb/clustered/reference/client-libraries/v2/javascript/nodejs/write/).
