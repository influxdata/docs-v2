...
[Random numbers sample dataset](/influxdb/clustered/reference/sample-data/#random-numbers-sample-data)._
...
_The following example uses the
[Table value constructor](/influxdb/clustered/reference/sql/table-value-constructor/)
