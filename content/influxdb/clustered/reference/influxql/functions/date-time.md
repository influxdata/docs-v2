...
_Supported only in the [`WHERE` clause](/influxdb/clustered/reference/influxql/where/)._
...
Used in the [`GROUP BY` clause](/influxdb/clustered/reference/influxql/group-by/)
...
_Supported only in the [`GROUP BY` clause](/influxdb/clustered/reference/influxql/group-by/)._
...
[Bitcoin price sample dataset](/influxdb/clustered/reference/sample-data/#bitcoin-price-data).
...
_Supported only in the [time zone clause](/influxdb/clustered/reference/influxql/time-and-timezone/#time-zone-clause)._
