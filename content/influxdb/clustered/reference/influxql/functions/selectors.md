...
Returns the [field value](/influxdb/clustered/reference/glossary/#field-value) with the oldest timestamp.
...
Returns the [field value](/influxdb/clustered/reference/glossary/#field-value) with the most recent timestamp.
...
Returns the greatest [field value](/influxdb/clustered/reference/glossary/#field-value).
...
Returns the lowest [field value](/influxdb/clustered/reference/glossary/#field-value).
...
- `PERCENTILE(example_field, 50)` is nearly equivalent to
  [`MEDIAN(example_field)`](/influxdb/clustered/reference/influxql/functions/aggregates/#median),
