...
menu:
  influxdb_clustered:
    parent: Reference
influxdb/clustered/tags: [glossary]
---
...
[InfluxDB data organization](/influxdb/clustered/get-started/#data-organization)
...
[SQL functions](/inflxudb/clustered/reference/sql/functions/).
...
See [line protocol](/influxdb/clustered/reference/syntax/line-protocol/).
...
are not part of the InfluxDB Clustered data model.
...
[Elements of line protocol](/influxdb/clustered/reference/syntax/line-protocol/#elements-of-line-protocol).
...
Specify timestamp precision when [writing data to InfluxDB](/influxdb/clustered/write-data/).
