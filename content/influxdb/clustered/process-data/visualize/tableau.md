...
aliases:
  ...
  - /influxdb/clustered/query-data/sql/execute-queries/tableau/
  - /influxdb/clustered/process-data/tools/tableau/
related:
  - /influxdb/clustered/visualize-data/tableau/
metadata: [SQL only]
---
...
Setting `useSystemTrustStore=false` is only necessary on macOS and doesn't actually affect the security of the connection to Tableau.
    ...
    - **Password**: [database token](/influxdb/clustered/admin/tokens/#database-tokens)
