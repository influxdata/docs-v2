...
The following example uses the [InfluxDB client library for Python](/influxdb/clustered/reference/client-libraries/v3/python/) to query an {{% cloud-name %}} database,
