...
To resolve this, log in to a meta node and use the [`influxd-ctl update-data`](/enterprise_influxdb/v1.9/administration/cluster-commands/#update-data) command
...
[Provision and start a new meta node](/enterprise_influxdb/v1.9/production_installation/meta_node_installation/), but **do not** add it to the cluster yet.
...
[Provision and start a new data node](/enterprise_influxdb/v1.9/production_installation/data_node_installation/), but **do not** add it to your cluster yet.
