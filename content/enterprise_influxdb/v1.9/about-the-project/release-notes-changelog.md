...
- Improved [ingress metrics](/enterprise_influxdb/v1.9/administration/config-data-nodes/#ingress-metric-by-login-enabled--false) to track points written by measurement and by login.
...
<!-- 
Verify these... missing from Flux release notes?
This includes:
