...
menu:
  enterprise_influxdb_1_11:
    ...
    weight: 2
aliases:
  - /enterprise_influxdb/v1.11/flux/getting-started/
  - /enterprise_influxdb/v1.11/flux/introduction/getting-started/
...
_For information about downloading and installing InfluxDB, see [InfluxDB installation](/enterprise_influxdb/v1.11/introduction/installation)._
...
You have multiple [options for writing and running Flux queries](/enterprise_influxdb/v1.11/flux/guides/execute-queries/),
...
<div class="page-nav-btns">
  <a class="btn next" href="/enterprise_influxdb/v1.11/flux/get-started/query-influxdb/">Query InfluxDB with Flux</a>
</div>
