...
menu:
  enterprise_influxdb_1_11:
    ...
    weight: 1
aliases:
  - /enterprise_influxdb/v1.11/flux/getting-started/query-influxdb/
...
_**If you haven't already, make sure to install InfluxDB v1.8+, [enable Flux](/enterprise_influxdb/v1.11/flux/installation),
and choose a [tool for writing Flux queries](/enterprise_influxdb/v1.11/flux/get-started#tools-for-working-with-flux).**_

The following queries can be executed using any of the methods described in
[Execute Flux queries](/enterprise_influxdb/v1.11/flux/execute-queries/).
...
It requires a [`bucket`](/enterprise_influxdb/v1.11/flux/get-started/#buckets) parameter.
...
<div class="page-nav-btns">
  <a class="btn prev" href="/enterprise_influxdb/v1.11/flux/get-started/">Get started with Flux</a>
  <a class="btn next" href="/enterprise_influxdb/v1.11/flux/get-started/transform-data/">Transform your data</a>
</div>
