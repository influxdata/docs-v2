...
weight: 1
aliases:
  - /enterprise_influxdb/v1.11/flux/guides/executing-queries/
  - /enterprise_influxdb/v1.11/flux/guides/execute-queries/
...
## Influx CLI
To start an interactive Flux read-eval-print-loop (REPL) with the InfluxDB Enterprise 1.8+
