...
- The [Flux REPL](/enterprise_influxdb/v1.11/flux/guides/execute-queries/#influx-cli) does not currently support
...
to extract the **first** table whose [group key](/enterprise_influxdb/v1.11/flux/get-started/#group-keys)
...
Use [dot notation](/enterprise_influxdb/v1.11/flux/get-started/syntax-basics/#records) to reference
keys in the record.
