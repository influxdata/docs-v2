...
2. Use [`pivot()` or `join()`](/enterprise_influxdb/v1.11/flux/guides/mathematic-operations/#pivot-vs-join)
...
_See [Pivot vs join](/enterprise_influxdb/v1.11/flux/guides/mathematic-operations/#pivot-vs-join)._
{{% /note %}}
...
1. Ensure measurements are in the same [bucket](/enterprise_influxdb/v1.11/flux/get-started/#buckets).
