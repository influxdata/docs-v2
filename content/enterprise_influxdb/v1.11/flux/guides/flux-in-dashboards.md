...
_**Chronograf v1.8+** and **InfluxDB v1.8 with [Flux enabled](/enterprise_influxdb/v1.11/flux/installation)**
...
> [Flux enabled](/enterprise_influxdb/v1.11/flux/installation).
...
[windowing and aggregation](/enterprise_influxdb/v1.11/flux/guides/window-aggregate) operations with dashboard refreshes.
