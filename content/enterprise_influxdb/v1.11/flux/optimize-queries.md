...
aliases:
  - /enterprise_influxdb/v1.11/flux/guides/optimize-queries
---
...
The following pushdowns are supported in InfluxDB Enterprise 1.11+.
...
Depending on the number of series returned after `filter()`([cardinality](/enterprise_influxdb/v1.11/concepts/glossary/#series-cardinality)),
