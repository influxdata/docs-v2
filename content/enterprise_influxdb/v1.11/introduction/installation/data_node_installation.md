...
aliases:
    - /enterprise_influxdb/v1.11/installation/data_node_installation/
    - /enterprise_influxdb/v1.11/introduction/installation/installation/data_node_installation/
menu:
...
[Installing meta nodes](/enterprise_influxdb/v1.11/introduction/installation/installation/meta_node_installation/).
Bad things can happen if you complete the following steps without meta nodes.
{{% /warn %}}

## Data node setup description and requirements

The installation process sets up two [data nodes](/enterprise_influxdb/v1.11/concepts/glossary#data-node)
...
See the [Clustering guide](/enterprise_influxdb/v1.11/concepts/clustering/#optimal-server-counts)
...
data nodes on port `8086` (the default port for the [HTTP API](/enterprise_influxdb/v1.11/tools/api/)).
...
Check the [logs](/enterprise_influxdb/v1.11/administration/logs/)
...
[previous document](/enterprise_influxdb/v1.11/introduction/meta_node_installation/), run:
...
To create an admin user, use the [`influx` CLI](/enterprise_influxdb/v1.11/tools/influx-cli/), and run the following:
...
- Set up [authentication](/enterprise_influxdb/v1.11/administration/configure/security/authentication/).
  Once you cluster is configured for authentication,
  if you want to add more users in addition to admin user,
  see [Manage users and permissions](/enterprise_influxdb/v1.11/administration/manage/users-and-permissions/).
- [Enable TLS](/enterprise_influxdb/v1.11/guides/enable-tls/).
- [Set up Chronograf](/enterprise_influxdb/v1.11/introduction/installation/installation/chrono_install)
