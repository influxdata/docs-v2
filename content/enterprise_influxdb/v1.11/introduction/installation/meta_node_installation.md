...
aliases:
    - /enterprise_influxdb/v1.11/installation/meta_node_installation/
    - /enterprise_influxdb/v1.11/introduction/installation/installation/meta_node_installation/
menu:
...
1. Review [meta node setup and requirements](#meta-node-setup-and-requirements)
...
The installation process sets up three [meta nodes](/enterprise_influxdb/v1.11/concepts/glossary/#meta-node), with each meta node running on its own server.
...
See the
[Clustering in InfluxDB Enterprise](/enterprise_influxdb/v1.11/concepts/clustering/)
...
After your meta nodes are part of your cluster, [install data nodes](/enterprise_influxdb/v1.11/introduction/installation/installation/data_node_installation/).
