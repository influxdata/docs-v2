...
[LDAP authentication](/enterprise_influxdb/v1.11/administration/configure/security/ldap/),
[fine-grained authorization](/enterprise_influxdb/v1.11/administration/manage/users-and-permissions/fine-grained-authorization/),
[incremental backup](/enterprise_influxdb/v1.11/administration/backup-and-restore/#perform-an-incremental-backup)
...
and the accompanying [`influxd-ctl` utility](/enterprise_influxdb/v1.11/tools/influxd-ctl/)
...
7. **Create an admin user**:
    ...
    1.  Use the [`influx` CLI](/enterprise_influxdb/v1.11/tools/influx-cli/) to
...
- [Write data with the InfluxDB API](/enterprise_influxdb/v1.11/guides/write_data/).
