...
menu:
  enterprise_influxdb_1_11:
    ...
    parent: InfluxQL
aliases:
  - /enterprise_influxdb/v1.11/query_language/schema_exploration/
v2: /influxdb/v2.0/query-data/flux/explore-schema/
---

InfluxQL is an SQL-like query language for interacting with data in InfluxDB.
The following sections cover useful query syntax for exploring your [schema](/enterprise_influxdb/v1.11/concepts/glossary/#schema).
...
## `SHOW DATABASES`
Returns a list of all [databases](/enterprise_influxdb/v1.11/concepts/glossary/#database) on your instance.
...
Returns a list of [retention policies](/enterprise_influxdb/v1.11/concepts/glossary/#retention-policy-rp) for the specified [database](/enterprise_influxdb/v1.11/concepts/glossary/#database).
...
database with `USE <database_name>` in the [CLI](/enterprise_influxdb/v1.11/tools/influx-cli/use-influx/) or with the `db` query
string parameter in the [InfluxDB API](/enterprise_influxdb/v1.11/tools/api/#query-string-parameters) request.
...
The `autogen` retention policy has an infinite [duration](/enterprise_influxdb/v1.11/concepts/glossary/#duration),
a seven-day [shard group duration](/enterprise_influxdb/v1.11/concepts/glossary/#shard-group),
a [replication factor](/enterprise_influxdb/v1.11/concepts/glossary/#replication-factor)
...
Returns a list of [series](/enterprise_influxdb/v1.11/concepts/glossary/#series) for
the specified [database](/enterprise_influxdb/v1.11/concepts/glossary/#database).
...
[`FROM` clause](/enterprise_influxdb/v1.11/query_language/explore-data/#the-basic-select-statement),
[`LIMIT` clause](/enterprise_influxdb/v1.11/query_language/explore-data/#the-limit-clause),
[`OFFSET` clause](/enterprise_influxdb/v1.11/query_language/explore-data/#the-offset-clause),
and on [Regular Expressions in Queries](/enterprise_influxdb/v1.11/query_language/explore-data/#regular-expressions).
...
The query's output is similar to the [line protocol](/enterprise_influxdb/v1.11/concepts/glossary/#influxdb-line-protocol) format.
Everything before the first comma is the [measurement](/enterprise_influxdb/v1.11/concepts/glossary/#measurement) name.
Everything after the first comma is either a [tag key](/enterprise_influxdb/v1.11/concepts/glossary/#tag-key) or a [tag value](/enterprise_influxdb/v1.11/concepts/glossary/#tag-value).
...
Returns a list of [measurements](/enterprise_influxdb/v1.11/concepts/glossary/#measurement)
for the specified [database](/enterprise_influxdb/v1.11/concepts/glossary/#database).
...
Returns a list of [tag keys](/enterprise_influxdb/v1.11/concepts/glossary/#tag-key)
associated with the specified [database](/enterprise_influxdb/v1.11/concepts/glossary/#database).
...
Returns the list of [tag values](/enterprise_influxdb/v1.11/concepts/glossary/#tag-value)
for the specified [tag key(s)](/enterprise_influxdb/v1.11/concepts/glossary/#tag-key) in the database.
...
`ON <database_name>` is optional.
If the query does not include `ON <database_name>`, you must specify the
database with `USE <database_name>` in the [CLI](/enterprise_influxdb/v1.11/tools/influx-cli/use-influx/) or with the `db` query string parameter in the [InfluxDB API](/enterprise_influxdb/v1.11/tools/api/#query-string-parameters) request.
...
Returns the [field keys](/enterprise_influxdb/v1.11/concepts/glossary/#field-key) and the
[data type](/enterprise_influxdb/v1.11/write_protocols/line_protocol_reference/#data-types) of their
[field values](/enterprise_influxdb/v1.11/concepts/glossary/#field-value).
...
> **Note:** A field's data type [can differ](/enterprise_influxdb/v1.11/troubleshooting/frequently-asked-questions/#how-does-influxdb-handle-field-type-discrepancies-across-shards) across
[shards](/enterprise_influxdb/v1.11/concepts/glossary/#shard).
...
Field value
[data types](/enterprise_influxdb/v1.11/write_protocols/line_protocol_reference/#data-types)
cannot differ within a [shard](/enterprise_influxdb/v1.11/concepts/glossary/#shard) but they
...
see the [InfluxQL reference entry](/enterprise_influxdb/v1.11/query_language/spec/#show-cardinality).
...
When you filter meta queries by time, you may see results outside of your specified time. Meta query results are filtered at the shard level, so results can be approximately as granular as your shard group duration. If your time filter spans multiple shards, you'll get results from all shards with points in the specified time range. To review your shards and timestamps on points in the shard, run `SHOW SHARDS`. To learn more about shards and their duration, see [recommended shard groups durations](/enterprise_influxdb/v1.11/concepts/schema_and_data_layout/#shard-group-duration-recommendations).
...
1. Specify a shard duration on a new database or [alter an existing shard duration](/enterprise_influxdb/v1.11/query_language/manage-database/#modify-retention-policies-with-alter-retention-policy). To specify a 1h shard duration when creating a new database, run the following command:
