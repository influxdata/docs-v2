...
weight: 60
aliases:
  - /enterprise/v1.11/administration/ports/
  - /enterprise_influxdb/v1.11/administration/ports/
---
...
[Configure this port](/enterprise_influxdb/v1.11/administration/configure/config-data-nodes/#bind-address)
in the data node configuration file.

_See also: [API Reference](/enterprise_influxdb/v1.11/tools/api/)._
...
_See also: [Back up and restore](/enterprise_influxdb/v1.11/administration/backup-and-restore/)._
...
[Enable and configure this port](/enterprise_influxdb/v1.11/administration/config-data-nodes/#bind-address-2003)
in the configuration file.
...
[Enable and configure this port](/enterprise_influxdb/v1.11/administration/configure/config-data-nodes/#opentsdb-settings)
in the configuration file.
...
[Enable and configure this port](/enterprise_influxdb/v1.11/administration/configure/config-data-nodes/#udp-settings)
in the configuration file.
...
[Enable and configure this port](/enterprise_influxdb/v1.11/administration/configure/config-data-nodes/#collectd-settings)
in the configuration file.
