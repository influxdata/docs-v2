...
weight: 30
aliases:
  - /enterprise_influxdb/v1.11/administration/config-meta-nodes/
---
...
The hostname of the [meta node](/enterprise_influxdb/v1.11/concepts/glossary/#meta-node).
...
> **Note:** You must restart meta nodes to update your configuration. For more information, see how to [renew or update your license key](/enterprise_influxdb/v1.11/administration/renew-license/).
...
For example, [continuous queries](/enterprise_influxdb/v1.11/concepts/glossary/#continuous-query-cq)
...
[Configuration and operational considerations on a cluster](/enterprise_influxdb/v1.11/features/clustering-features/#configuration-and-operational-considerations-on-a-cluster).
...
[`[meta] meta-internal-shared-secret`](/enterprise_influxdb/v1.11/administration/config-data-nodes#meta-internal-shared-secret) in the data node configuration file.
...
This setting must have the same value as the data node option [`meta.password-hash`](/enterprise_influxdb/v1.11/administration/config-data-nodes/#password-hash).
...
For more information, see [TLS settings for data nodes](/enterprise_influxdb/v1.11/administration/config-data-nodes#tls-settings).
