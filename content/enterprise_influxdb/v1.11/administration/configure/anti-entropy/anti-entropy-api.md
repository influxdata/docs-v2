...
aliases:
  - /enterprise_influxdb/v1.11/administration/anti-entropy-api/
---
...
> [Anti-Entropy settings](/enterprise_influxdb/v1.11/administration/config-data-nodes/#anti-entropy-ae-settings).

Use the [Anti-Entropy service](/enterprise_influxdb/v1.11/administration/anti-entropy) in InfluxDB Enterprise to monitor and repair entropy in data nodes and their shards. To access the Anti-Entropy API and work with this service, use [`influxd-ctl entropy`](/enterprise_influxdb/v1.11/tools/influxd-ctl/#entropy) (also available on meta nodes).
