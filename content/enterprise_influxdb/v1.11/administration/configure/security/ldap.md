...
weight: 30
aliases:
  - /enterprise_influxdb/v1.11/administration/ldap/
  - /enterprise_influxdb/v1.11/administration/manage/security/ldap/
---
...
For more detail on authentication, see [Authentication and authorization in InfluxDB](/enterprise_influxdb/v1.11/administration/authentication_and_authorization/).
...
2. Save the sample file and edit as needed for your LDAP server.
   For detail, see the [sample LDAP configuration file](#sample-ldap-configuration) below.
    ...
    For more information, see [Fine-grained authorization in InfluxDB Enterprise](/enterprise_influxdb/v1.11/guides/fine-grained-authorization/).
