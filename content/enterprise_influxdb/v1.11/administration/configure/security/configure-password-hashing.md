...
weight: 40
related:
    - /enterprise_influxdb/v1.11/administration/configuration/
aliases:
  - /enterprise_influxdb/v1.11/administration/configure-password-hashing/
  - /enterprise_influxdb/v1.11/administration/manage/configure-password-hashing/
---
...
4. To apply the new hashing algorithm, you must [reset](/enterprise_influxdb/v1.11/administration/authentication_and_authorization/#reset-a-users-password)
...
[`password-hash`]: /enterprise_influxdb/v1.11/administration/config-meta-nodes/#password-hash
[`ensure-fips`]: /enterprise_influxdb/v1.11/administration/config-meta-nodes/#ensure-fips
