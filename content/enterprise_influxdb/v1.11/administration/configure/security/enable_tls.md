...
weight: 20
aliases:
  - /enterprise_influxdb/v1.11/guides/https_setup/
  - /enterprise_influxdb/v1.11/guides/enable_tls/
  - /enterprise_influxdb/v1.11/guides/enable-tls/
---
...
With a self-signed certificate, you must also use the `-k` option to skip certificate verification.
    ...
    Next, verify that HTTPS is working by connecting to InfluxDB Enterprise with the [`influx` command line interface](/enterprise_influxdb/v1.11/tools/influx-cli/use-influx/):
