...
weight: 40
related:
  - /enterprise_influxdb/v1.11/administration/manage/security/authorization-api.md
  - /{{< latest "chronograf" >}}/administration/managing-influxdb-users/
  - /enterprise_influxdb/v1.11/administration/manage/security/fine-grained-authorization/
aliases:
...
and/or the [Enterprise meta API](/enterprise_influxdb/v1.11/administration/manage/users-and-permissions/authorization-api/)
to manage InfluxDB Enterprise users and roles.
{{% /note %}}

{{% warn %}}
Outside of [creating users](/enterprise_influxdb/v1.11/query_language/spec/#create-user),
...
However, InfluxDB Enterprise offers an [*expanded set of permissions*](/enterprise_influxdb/v1.11/administration/manage/users-and-permissions/permissions/#permissions).
You can use the Meta API and Chronograf to access and assign these more granular permissions to individual users.

The [InfluxDB Enterprise meta API](/enterprise_influxdb/v1.11/administration/manage/users-and-permissions/authorization-api/)
provides the most comprehensive way to manage users, roles, permission
and other [fine grained authorization](/enterprise_influxdb/v1.11/administration/manage/users-and-permissions/fine-grained-authorization/) (FGA) capabilities.
...
Non-admin users can [`SHOW`](/enterprise_influxdb/v1.11/query_language/explore-schema/#show-databases)
...
see [Database management](/enterprise_influxdb/v1.11/query_language/manage-database/) and
[Continuous queries](/enterprise_influxdb/v1.11/query_language/continuous_queries/).
