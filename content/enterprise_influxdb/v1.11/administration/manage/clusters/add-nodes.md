...
1. Install and start a new data node.
   Complete steps 1–3 of the [data node installation instructions](/enterprise_influxdb/v1.11/introduction/install-and-deploy/installation/data_node_installation/#step-1-add-appropriate-dns-entries-for-each-of-your-servers).
    ...
    -  From a meta node, run:
      ...
      - From a remote server, run:
        ...
        ```sh
             ...
             address>:<port>
              ```
3. (Optional) [Rebalance the cluster](/enterprise_influxdb/v1.11/administration/manage/clusters/rebalance/).
