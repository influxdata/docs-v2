...
aliases:
    - /enterprise_influxdb/v1.11/guides/replacing-nodes/
menu:
...
## Concepts
Meta nodes manage and monitor both the uptime of nodes in the cluster as well as distribution of [shards](/enterprise_influxdb/v1.11/concepts/glossary/#shard) among nodes in the cluster.
They hold information about which data nodes own which shards; information on which the
[anti-entropy](/enterprise_influxdb/v1.11/administration/anti-entropy/) (AE) process depends.
...
To resolve this, log in to a meta node and use the [`influxd-ctl update-data`](/enterprise_influxdb/v1.11/tools/influxd-ctl/#update-data) command
...
[Meta nodes](/enterprise_influxdb/v1.11/concepts/clustering/#meta-nodes) together form a [Raft](https://raft.github.io/) cluster in which nodes elect a leader through consensus vote.
...
[Provision and start a new meta node](/enterprise_influxdb/v1.11/installation/meta_node_installation/), but **do not** add it to the cluster yet.
...
[Data nodes](/enterprise_influxdb/v1.11/concepts/clustering/#data-nodes) house all raw time series data and metadata.
...
[Provision and start a new data node](/enterprise_influxdb/v1.11/installation/data_node_installation/), but **do not** add it to your cluster yet.
...
Within the duration defined by [`anti-entropy.check-interval`](/enterprise_influxdb/v1.11/administration/config-data-nodes#check-interval-10m),
...
View the [Anti-entropy](/enterprise_influxdb/v1.11/administration/anti-entropy/#concepts) documentation for important information regarding anti-entropy and your database's replication factor.
