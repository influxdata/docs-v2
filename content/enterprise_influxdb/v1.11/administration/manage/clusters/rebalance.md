...
aliases:
    - /enterprise_influxdb/v1.11/guides/rebalance/
    - /enterprise_influxdb/v1.11/guides/rebalance/
menu:
...
* Evenly distribute
[shards](/enterprise_influxdb/v1.11/concepts/glossary/#shard) across all data nodes in the
cluster
* Ensure that every
...
[`influxd-ctl` tool](/enterprise_influxdb/v1.11/tools/influxd-ctl/) available on
all meta nodes.
...
[replication factor](/enterprise_influxdb/v1.11/concepts/glossary/#replication-factor) of
two.
...
[Update](/enterprise_influxdb/v1.11/query_language/manage-database/#modify-retention-policies-with-alter-retention-policy)
...
Here, we use InfluxDB's [CLI](/enterprise_influxdb/v1.11/tools/influx-cli/use-influx/) to execute the query:
...
Use the
[`SHOW RETENTION POLICIES` query](/enterprise_influxdb/v1.11/query_language/explore-schema/#show-retention-policies)
