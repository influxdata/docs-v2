...
weight: 103
aliases:
  - /enterprise_influxdb/v1.11/administration/logs/
---
...
See [Redirecting HTTP request logging](/enterprise_influxdb/v1.11/administration/logs/#redirecting-http-access-logging) in the InfluxDB OSS documentation.
...
See [Structured logging](/enterprise_influxdb/v1.11/administration/logs/#structured-logging) in the InfluxDB OSS documentation.
