...
aliases:
    - /enterprise_influxdb/v1.11/write_protocols/line/
menu:
...
write points (unless you're using a [service plugin](/enterprise_influxdb/v1.11/supported_protocols/)).
...
The name of the [measurement](/enterprise_influxdb/v1.11/concepts/glossary/#measurement)
...
The [tag(s)](/enterprise_influxdb/v1.11/concepts/glossary/#tag) that you want to include
...
The [field(s)](/enterprise_influxdb/v1.11/concepts/glossary/#field) for your data point.
...
The [timestamp](/enterprise_influxdb/v1.11/concepts/glossary/#timestamp) for your data
...
See the [API Reference](/enterprise_influxdb/v1.11/tools/api/#write-http-endpoint) for more information.
...
[measurements](/enterprise_influxdb/v1.11/concepts/glossary/#measurement),
[tag keys](/enterprise_influxdb/v1.11/concepts/glossary/#tag-key),
[tag values](/enterprise_influxdb/v1.11/concepts/glossary/#tag-value),
[field keys](/enterprise_influxdb/v1.11/concepts/glossary/#field-key),
[field values](/enterprise_influxdb/v1.11/concepts/glossary/#field-value), and
...
tag values.
In addition, InfluxQL [functions](/enterprise_influxdb/v1.11/query_language/functions/)
...
See the [API Reference](/enterprise_influxdb/v1.11/tools/api/#write-http-endpoint) for how to specify
...
weather,location=us-midwest too_hot=true 1465839830100400200
    ...
    queries. See
    [Frequently Asked Questions](/enterprise_influxdb/v1.11/troubleshooting/frequently-asked-questions/#why-can-t-i-query-boolean-field-values)
    for more information.

Within a measurement, a field's type cannot differ within a
[shard](/enterprise_influxdb/v1.11/concepts/glossary/#shard), but it can differ across
...
[InfluxQL keywords](/enterprise_influxdb/v1.11/query_language/spec/#keywords)
as [identifier](/enterprise_influxdb/v1.11/concepts/glossary/#identifier) names.
In general, we recommend avoiding using InfluxQL keywords in your schema as
it can cause
[confusion](/enterprise_influxdb/v1.11/troubleshooting/errors/#error-parsing-query-found-expected-identifier-at-line-char) when querying the data.
...
[Tools](/enterprise_influxdb/v1.11/tools/) sections for further
information.
...
and more examples, see the [API Reference](/enterprise_influxdb/v1.11/tools/api/#write-http-endpoint).

#### CLI

Write data to InfluxDB using the InfluxDB command line interface (CLI).
[Launch](/enterprise_influxdb/v1.11/tools/influx-cli/use-influx/#launch-influx) the CLI, use the relevant
...
[import](/enterprise_influxdb/v1.11/tools/influx-cli/use-influx/#import-data-from-a-file-with-import) Line
Protocol from a file.

There are several ways to write data to InfluxDB.
See the [Tools](/enterprise_influxdb/v1.11/tools/) section for more
on the [InfluxDB API](/enterprise_influxdb/v1.11/tools/api/#write-http-endpoint), the
[CLI](/enterprise_influxdb/v1.11/tools/influx-cli/use-influx/), and the available Service Plugins (
[UDP](/enterprise_influxdb/v1.11/tools/udp/),
[Graphite](/enterprise_influxdb/v1.11/tools/graphite/),
[CollectD](/enterprise_influxdb/v1.11/tools/collectd/), and
[OpenTSDB](/enterprise_influxdb/v1.11/tools/opentsdb/)).
...
[How does InfluxDB handle duplicate point?](/enterprise_influxdb/v1.11/troubleshooting/frequently-asked-questions/#how-does-influxdb-handle-duplicate-points)
