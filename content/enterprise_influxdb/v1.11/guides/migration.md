...
aliases:
  - /enterprise/v1.11/guides/migration/
menu:
...
1. Upgrade InfluxDB OSS and InfluxDB Enterprise to the latest stable versions.
   ...
   - [Upgrade InfluxDB Enterprise](/enterprise_influxdb/v1.11/administration/upgrading/)
...
see [influxd-ctl](/enterprise_influxdb/v1.11/tools/influxd-ctl) 
and [`restore`](/enterprise_influxdb/v1.11/administration/backup-and-restore/#restore).

5. To avoid data loss, dual write to both OSS and Enterprise while completing the remaining steps.
   This keeps the OSS and cluster active for testing and acceptance work. For more information, see [Write data with the InfluxDB API](/enterprise_influxdb/v1.11/guides/write_data/).
   

6. [Export data from OSS](/enterprise_influxdb/v1.11/administration/backup-and-restore/#exporting-data)
   ...
   For more information, see [`-export`](/enterprise_influxdb/v1.11/tools/influx_inspect#export).

7. [Import data into Enterprise](/enterprise_influxdb/v1.11/administration/backup-and-restore/#importing-data).

8. Verify data is successfully migrated to your Enterprise cluster. See:
   - [Query data with the InfluxDB API](/enterprise_influxdb/v1.11/guides/query_data/)
...
1. Use the [`ALTER RETENTION POLICY`](/enterprise_influxdb/v1.11/query_language/manage-database/#modify-retention-policies-with-alter-retention-policy)
   statement to increase the [replication factor](/enterprise_influxdb/v1.11/concepts/glossary/#replication-factor)
   on all existing retention polices to the number of data nodes in your cluster.
2. [Rebalance your cluster manually](/enterprise_influxdb/v1.11/guides/rebalance/)
