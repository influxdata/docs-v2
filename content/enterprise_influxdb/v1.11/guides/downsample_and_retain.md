...
menu:
  enterprise_influxdb_1_11:
    ...
    parent: Guides
aliases:
  - /enterprise_influxdb/v1.11/guides/downsampling_and_retention/
...
- [CQ documentation](/enterprise_influxdb/v1.11/query_language/continuous_queries/) and
- [RP documentation](/enterprise_influxdb/v1.11/query_language/manage-database/#retention-policy-management).
...
We store this data in a [database](/enterprise_influxdb/v1.11/concepts/glossary/#database) or [bucket]() called `food_data`, in
the [measurement](/enterprise_influxdb/v1.11/concepts/glossary/#measurement) `orders`, and
in the [fields](/enterprise_influxdb/v1.11/concepts/glossary/#field) `phone` and `website`.
...
Use the
[`CREATE CONTINUOUS QUERY`](/enterprise_influxdb/v1.11/query_language/continuous_queries/)
...
see
[Database Configuration](/enterprise_influxdb/v1.11/administration/configure/config-data-nodes/#check-interval).
...
together, check out the detailed documentation on [CQs](/enterprise_influxdb/v1.11/query_language/continuous_queries/) and [RPs](/enterprise_influxdb/v1.11/query_language/manage-database/#retention-policy-management)
