...
* Export data from a shard to [InfluxDB line protocol](/enterprise_influxdb/v1.11/concepts/glossary/#influxdb-line-protocol) that can be inserted back into the database.
...
Defaults to [`GOMAXPROCS`](/enterprise_influxdb/v1.11/administration/configure/configuration/#gomaxprocs-environment-variable) value.
...
Dump raw [measurement](/enterprise_influxdb/v1.11/concepts/glossary/#measurement) data.

##### [ `-tag-keys` ]

Dump raw [tag keys](/enterprise_influxdb/v1.11/concepts/glossary/#tag-key).

##### [ `-tag-values` ]

Dump raw [tag values](/enterprise_influxdb/v1.11/concepts/glossary/#tag-value).
...
Dumps low-level details about [TSM](/enterprise_influxdb/v1.11/concepts/glossary/#tsm-time-structured-merge-tree) files, including TSM (`.tsm`) files and WAL (`.wal`) files.
...
[influx](/enterprise_influxdb/v1.11/tools/influx-cli/use-influx/#import-data-from-a-file-with-import) command.
...
The name of the [retention policy](/enterprise_influxdb/v1.11/concepts/glossary/#retention-policy-rp) to export. Default value is `""`.
...
Path to the [WAL](/enterprise_influxdb/v1.11/concepts/glossary/#wal-write-ahead-log) directory.
...
The path to the InfluxDB [`data` directory](/enterprise_influxdb/v1.11/concepts/file-system-layout/#file-system-layout).
...
As such, it always creates the [retention policy](/enterprise_influxdb/v1.11/concepts/glossary/#retention-policy-rp) with infinite duration and replication factor of 1.  End users may want to change this prior to reimporting if they are importing to a cluster or want a different duration
for retention.
