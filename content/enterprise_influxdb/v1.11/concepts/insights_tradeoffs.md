...
1. For the time series use case, we assume that if the same data is sent multiple times, it is the exact same data that a client just sent several times.
    ...
    _**Pro:**_ Simplified [conflict resolution](/enterprise_influxdb/v1.11/troubleshooting/frequently-asked-questions/#how-does-influxdb-handle-duplicate-points) increases write performance.  
...
7. Many time [series](/enterprise_influxdb/v1.11/concepts/glossary/#series) are ephemeral.
