...
- [database](/enterprise_influxdb/v1.11/concepts/glossary/#database)
- [field key](/enterprise_influxdb/v1.11/concepts/glossary/#field-key)
- [field set](/enterprise_influxdb/v1.11/concepts/glossary/#field-set)
- [field value](/enterprise_influxdb/v1.11/concepts/glossary/#field-value)
- [measurement](/enterprise_influxdb/v1.11/concepts/glossary/#measurement)
- [point](/enterprise_influxdb/v1.11/concepts/glossary/#point)
...
- [tag set](/enterprise_influxdb/v1.11/concepts/glossary/#tag-set)
- [tag value](/enterprise_influxdb/v1.11/concepts/glossary/#tag-value)
...
[Queries](/enterprise_influxdb/v1.11/concepts/glossary/#query) that use field values as filters must scan all values that match the other conditions in the query.
...
To optimize your queries, it may be beneficial to rearrange your [schema](/enterprise_influxdb/v1.11/concepts/glossary/#schema) such that the fields (`butterflies` and `honeybees`) become the tags and the tags (`location` and `scientist`) become the fields:
...
If you're interested in reading more about retention policies, check out [Database Management](/enterprise_influxdb/v1.11/query_language/manage-database/#retention-policy-management).
...
Understanding the concept of a series is essential when designing your [schema](/enterprise_influxdb/v1.11/concepts/glossary/#schema) and when working with your data in InfluxDB.
...
See [Authentication and Authorization](/enterprise_influxdb/v1.11/administration/authentication_and_authorization/) and [Continuous Queries](/enterprise_influxdb/v1.11/query_language/continuous_queries/) for more on those topics.
...
If you're just starting out, we recommend taking a look at [Getting Started](/enterprise_influxdb/v1.11/introduction/getting_started/) and the [Writing Data](/enterprise_influxdb/v1.11/guides/writing_data/) and [Querying Data](/enterprise_influxdb/v1.11/guides/querying_data/) guides.
