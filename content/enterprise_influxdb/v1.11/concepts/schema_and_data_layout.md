...
Each InfluxDB use case is unique and your [schema](/enterprise_influxdb/v1.11/concepts/glossary/#schema) reflects that uniqueness.
...
Your queries should guide what data you store in [tags](/enterprise_influxdb/v1.11/concepts/glossary/#tag) and what you store in [fields](/enterprise_influxdb/v1.11/concepts/glossary/#field) :

- Store commonly-queried and grouping ([`group()`](/flux/v0.x/stdlib/universe/group) or [`GROUP BY`](/enterprise_influxdb/v1.11/query_language/explore-data/#group-by-tags)) metadata in tags.
- Store data in fields if each data point contains a different value.
- Store numeric values as fields ([tag values](/enterprise_influxdb/v1.11/concepts/glossary/#tag-value) only support string values).
...
- [tags](/enterprise_influxdb/v1.11/concepts/glossary/#tag)

[Tag values](/enterprise_influxdb/v1.11/concepts/glossary/#tag-value) are indexed and [field values](/enterprise_influxdb/v1.11/concepts/glossary/#field-value) are not.
...
Each unique set of indexed data elements forms a [series key](/enterprise_influxdb/v1.11/concepts/glossary/#series-key).
[Tags](/enterprise_influxdb/v1.11/concepts/glossary/#tag) containing highly variable information like unique IDs, hashes, and random strings lead to a large number of [series](/enterprise_influxdb/v1.11/concepts/glossary/#series), also known as high [series cardinality](/enterprise_influxdb/v1.11/concepts/glossary/#series-cardinality).
...
See [how to find and reduce high series cardinality](/enterprise_influxdb/v1.11/troubleshooting/frequently-asked-questions/#why-does-series-cardinality-matter).
...
[Frequently asked questions](/enterprise_influxdb/v1.11/troubleshooting/frequently-asked-questions/#tag-and-field-key-with-the-same-name)
...
Store data in [tag values](/enterprise_influxdb/v1.11/concepts/glossary/#tag-value) or [field values](/enterprise_influxdb/v1.11/concepts/glossary/#field-value), not in [tag keys](/enterprise_influxdb/v1.11/concepts/glossary/#tag-key), [field keys](/enterprise_influxdb/v1.11/concepts/glossary/#field-key), or [measurements](/enterprise_influxdb/v1.11/concepts/glossary/#measurement). If you design your schema to store data in tag and field values,
...
To learn more about the performance impact of high series cardinality, see [how to find and reduce high series cardinality](/enterprise_influxdb/v1.11/troubleshooting/frequently-asked-questions/#why-does-series-cardinality-matter).
...
Shard groups are organized by [retention policy](/enterprise_influxdb/v1.11/concepts/glossary/#retention-policy-rp) (RP) and store data with timestamps that fall within a specific time interval called the [shard duration](/enterprise_influxdb/v1.11/concepts/glossary/#shard-duration).

If no shard group duration is provided, the shard group duration is determined by the RP [duration](/enterprise_influxdb/v1.11/concepts/glossary/#duration) at the time the RP is created. The default values are:
...
To configure the shard group duration, see [Retention Policy Management](/enterprise_influxdb/v1.11/query_language/manage-database/#retention-policy-management).
...
> **Note:** Note that `INF` (infinite) is not a [valid shard group duration](/enterprise_influxdb/v1.11/query_language/manage-database/#retention-policy-management).
...
* Shard groups should each contain more than 100,000 [points](/enterprise_influxdb/v1.11/concepts/glossary/#point) per shard group
* Shard groups should each contain more than 1,000 points per [series](/enterprise_influxdb/v1.11/concepts/glossary/#series)
