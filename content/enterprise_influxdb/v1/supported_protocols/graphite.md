...
aliases:
    - /enterprise_influxdb/v1/tools/graphite/
    - /enterprise_influxdb/v1/write_protocols/graphite/
menu:
...
size limit, [see here for more details.](/enterprise_influxdb/v1/supported_protocols/udp#a-note-on-udp-ip-os-buffer-sizes)
