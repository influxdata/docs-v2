...
aliases:
    - /enterprise_influxdb/v1/tools/collectd/
menu:
...
If you're running Linux or FreeBSD, please adjust your operating system UDP buffer size limit, [see here for more details.](/enterprise_influxdb/v1/supported_protocols/udp/#a-note-on-udp-ip-os-buffer-sizes)
