...
Identifiers are tokens which refer to [database](/enterprise_influxdb/v1/concepts/glossary/#database) names, [retention policy](/enterprise_influxdb/v1/concepts/glossary/#retention-policy-rp) names, [user](/enterprise_influxdb/v1/concepts/glossary/#user) names, [measurement](/enterprise_influxdb/v1/concepts/glossary/#measurement) names, [tag keys](/enterprise_influxdb/v1/concepts/glossary/#tag-key), and [field keys](/enterprise_influxdb/v1/concepts/glossary/#field-key).
...
For more information about storage blocks, see [TSM files](/enterprise_influxdb/v1/concepts/storage_engine/#tsm-files).
...
[Series cardinality](/enterprise_influxdb/v1/concepts/glossary/#series-cardinality) is the major factor that affects RAM requirements. For more information, see:
