...
InfluxDB does not support combining mathematical operations with a wildcard (`*`) or [regular expression](/enterprise_influxdb/v1/query_language/explore-data/#regular-expressions) in the `SELECT` clause.
...
> InfluxQL supports [subqueries](/enterprise_influxdb/v1/query_language/explore-data/#subqueries) which offer similar functionality to using mathematical operators inside a function call.
