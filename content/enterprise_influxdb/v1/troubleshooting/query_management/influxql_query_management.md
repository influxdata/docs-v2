...
For Flux query management settings, see [Flux query management](/enterprise_influxdb/v1/troubleshooting/query_management/flux_query_management).
{{% /note %}}
...
[`SHOW QUERIES`](/enterprise_influxdb/v1/troubleshooting/query_management/influxql_query_management/#list-currently-running-queries-with-show-queries) output:
...
This setting is a [duration literal](/enterprise_influxdb/v1/query_language/spec/#durations).
...
Use this value with 
[`KILL QUERY`](/enterprise_influxdb/v1/troubleshooting/query_management/influxql_query_management/#stop-currently-running-queries-with-kill-query).
...
The maximum number of [points](/enterprise_influxdb/v1/concepts/glossary/#point) that a
...
The maximum number of [series](/enterprise_influxdb/v1/concepts/glossary/#series) that a
`SELECT` statement can process.
The default setting (`0`) allows the `SELECT` statement to process an unlimited
number of series.
