...
<p style="font-size:.85rem;font-style:italic;margin-top:-2rem;">See <a href="/influxdb/v2/tools/repl/">Flux read-eval-print-loop (REPL)</a>.</p>
...
To convert operands to the same type, use [type-conversion functions](/flux/v0/stdlib/universe/type-conversions/)
...
- [Handle piped-forward data](/influxdb/v2/query-data/flux/custom-functions/#functions-that-manipulate-piped-forward-data).
...
[`float()` function](/flux/v0/stdlib/universe/type-conversions/float)
...
_For an in-depth look at calculating percentages, see [Calculate percentates](/enterprise_influxdb/v1/flux/guides/calculate-percentages)._
