...
Use the [experimental `csv.from()` function](/flux/v0/stdlib/experimental/csv/from/)
...
If bandwidth is a concern, use the [`to()` function](/flux/v0/stdlib/built-in/outputs/to/)
to write the data to a bucket, and then query the bucket with [`from()`](/flux/v0/stdlib/built-in/inputs/from/).
{{% /note %}}
