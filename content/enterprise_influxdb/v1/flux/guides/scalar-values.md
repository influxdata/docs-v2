...
Use Flux [stream and table functions](/flux/v0/stdlib/universe/stream-table/)
...
- The InfluxDB user interface (UI) does not currently support raw scalar output.
  Use [`map()`](/flux/v0/stdlib/universe/map/) to add
  scalar values to output data.
- The [Flux REPL](/enterprise_influxdb/v1/flux/guides/execute-queries/#influx-cli) does not currently support
...
Use [`tableFind()`](/flux/v0/stdlib/universe/stream-table/tablefind/)
to extract the **first** table whose [group key](/enterprise_influxdb/v1/flux/get-started/#group-keys)
...
Use the [`getColumn()` function](/flux/v0/stdlib/universe/stream-table/getcolumn/)
...
Use the [`getRecord()` function](/flux/v0/stdlib/universe/stream-table/getrecord/)
...
Use [dot notation](/enterprise_influxdb/v1/flux/get-started/syntax-basics/#records) to reference
keys in the record.
