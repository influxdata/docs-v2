...
Use the [`time()` function](/flux/v0/stdlib/universe/type-conversions/time/)
...
Use the [`uint()` function](/flux/v0/stdlib/universe/type-conversions/uint/)
...
To store a duration in a column, use the [`string()` function](/flux/v0/stdlib/universe/type-conversions/string/)
...
### Current UTC time
Use the [`now()` function](/flux/v0/stdlib/built-in/misc/now/) to
