...
aliases:
  - /enterprise_influxdb/v1/flux/guides/optimize-queries
---
...
- [map()](/influxdb/v2/reference/flux/stdlib/built-in/transformations/map/)
- [reduce()](/influxdb/v2/reference/flux/stdlib/built-in/transformations/aggregates/reduce/)
- [join()](/influxdb/v2/reference/flux/stdlib/built-in/transformations/join/)
- [union()](/influxdb/v2/reference/flux/stdlib/built-in/transformations/union/)
...
Depending on the number of series returned after `filter()`([cardinality](/enterprise_influxdb/v1/concepts/glossary/#series-cardinality)),
...
For more information about Flux profilers, see the [Flux Profiler package](/influxdb/v2/reference/flux/stdlib/profiler/).
