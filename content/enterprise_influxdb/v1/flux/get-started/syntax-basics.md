...
This likely seems familiar if you've already been through through the other [getting started guides](/enterprise_influxdb/v1/flux/get-started).
...
<div class="page-nav-btns">
  <a class="btn prev" href="/enterprise_influxdb/v1/flux/get-started/transform-data/">Transform your data</a>
</div>
