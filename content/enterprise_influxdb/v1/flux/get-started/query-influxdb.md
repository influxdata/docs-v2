...
_**If you haven't already, make sure to install InfluxDB v1.8+, [enable Flux](/enterprise_influxdb/v1/flux/installation),
and choose a [tool for writing Flux queries](/enterprise_influxdb/v1/flux/get-started#tools-for-working-with-flux).**_
...
Ranges can be **relative** using negative [durations](/flux/v0/spec/lexical-elements#duration-literals)
or **absolute** using [timestamps](/flux/v0/spec/lexical-elements#date-and-time-literals).
...
<div class="page-nav-btns">
  <a class="btn prev" href="/enterprise_influxdb/v1/flux/get-started/">Get started with Flux</a>
  <a class="btn next" href="/enterprise_influxdb/v1/flux/get-started/transform-data/">Transform your data</a>
</div>
