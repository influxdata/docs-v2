...
- To significantly improve compression, use the coarsest [precision](/enterprise_influxdb/v1/api/#write-http-endpoint) possible for timestamps.
...
| Timestamp | Timestamps |  A Unix time in nanoseconds since January 1, 1970 UTC. Specify alternative precisions with the [InfluxDB API](/enterprise_influxdb/v1/api/#write-http-endpoint). The minimum valid timestamp is `-9223372036854775806` or `1677-09-21T00:12:43.145224194Z`. The maximum valid timestamp is `9223372036854775806` or `2262-04-11T23:47:16.854775806Z`. |
