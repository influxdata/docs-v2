...
See the [API Reference](/enterprise_influxdb/v1/api/#write-http-endpoint) for more information.
...
See the [API Reference](/enterprise_influxdb/v1/api/#write-http-endpoint) for how to specify
...
and more examples, see the [API Reference](/enterprise_influxdb/v1/api/#write-http-endpoint).
...
on the [InfluxDB API](/enterprise_influxdb/v1/api/#write-http-endpoint), the
