...
<span data-testid="show-in-composite-self">{{% show-in "enterprise_influxdb/v1" %}}VISIBLE{{% /show-in %}}</span>
<span data-testid="show-in-composite-other">{{% show-in "influxdb/v1" %}}VISIBLE{{% /show-in %}}</span>
<span data-testid="hide-in-composite-self">{{% hide-in "enterprise_influxdb/v1" %}}HIDDEN{{% /hide-in %}}</span>
<span data-testid="hide-in-composite-other">{{% hide-in "influxdb/v1" %}}HIDDEN{{% /hide-in %}}</span>
<span data-testid="show-in-product">{{% show-in "enterprise_influxdb" %}}VISIBLE{{% /show-in %}}</span>
<span data-testid="show-in-spaced">{{% show-in " enterprise_influxdb/v1 , core " %}}VISIBLE{{% /show-in %}}</span>
