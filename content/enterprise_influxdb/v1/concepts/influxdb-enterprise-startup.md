...
and [hinted handoff (HH)](/enterprise_influxdb/v1/concepts/clustering/#hinted-handoff).
...
### Retention
The Retention service enforces [retention policies](/enterprise_influxdb/v1/concepts/glossary/#retention-policy-rp)
...
For more information, see [Use anti-entropy](/enterprise_influxdb/v1/administration/anti-entropy/).
