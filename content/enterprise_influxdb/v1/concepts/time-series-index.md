...
Find overview and background information on Time Series Index (TSI) in this topic. For detail, including how to enable and configure TSI, see [Time Series Index (TSI) details](/enterprise_influxdb/v1/concepts/tsi-details/).
...
> For details, see [TSM-based data storage and in-memory indexing](/enterprise_influxdb/v1/concepts/storage_engine/).
...
The latter will give us the ability to add things to the query languages like the [SHOW CARDINALITY](/enterprise_influxdb/v1/query_language/spec#show-cardinality) queries.
