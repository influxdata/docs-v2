...
* Evenly distribute
[shards](/enterprise_influxdb/v1/concepts/glossary/#shard) across all data nodes in the
cluster
* Ensure that every
...
[Update](/enterprise_influxdb/v1/query_language/manage-database/#modify-retention-policies-with-alter-retention-policy)
...
Use the
[`SHOW RETENTION POLICIES` query](/enterprise_influxdb/v1/query_language/explore-schema/#show-retention-policies)
