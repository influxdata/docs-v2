...
weight: 30
aliases:
  - /enterprise_influxdb/v1/administration/subscription-management/
---
...
HTTP, HTTPS, or UDP in [line protocol](/enterprise_influxdb/v1/write_protocols/line_protocol_tutorial/).
...
_The number of writer goroutines is defined by the [`write-concurrency`](/enterprise_influxdb/v1/administration/configure/config-data-nodes/#write-concurrency-40) configuration._
...
option in the `[[influxdb]]` section of your [`kapacitor.conf`](/kapacitor/v1/administration/subscription-management/#subscription-protocol).
...
view the [Kapacitor security](/kapacitor/v1/administration/security/#secure-influxdb-and-kapacitor) documentation._
...
_**Descriptions of `[subscriber]` configuration options are available in the [data node configuration](/enterprise_influxdb/v1/administration/configure/config-data-nodes/#subscription-settings) documentation.**_
