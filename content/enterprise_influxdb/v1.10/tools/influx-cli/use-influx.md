...
aliases:
    - /enterprise_influxdb/v1.10/tools/shell
    - /enterprise_influxdb/v1.10/tools/use-influx/
menu:
...
`-execute 'command'`
Execute an [InfluxQL](/enterprise_influxdb/v1.10/query_language/explore-data/) command and quit.
...
* **DDL (Data Definition Language)**: Contains the [InfluxQL commands](/enterprise_influxdb/v1.10/query_language/manage-database/) for creating the relevant [database](/enterprise_influxdb/v1.10/concepts/glossary/) and managing the [retention policy](/enterprise_influxdb/v1.10/concepts/glossary/#retention-policy-rp).
If your database and retention policy already exist, your file can skip this section.
* **DML (Data Manipulation Language)**: Lists the relevant database and (if desired) retention policy and contains the data in [line protocol](/enterprise_influxdb/v1.10/concepts/glossary/#influxdb-line-protocol).
...
* Include timestamps in the data file. InfluxDB will assign the same timestamp to points without a timestamp. This can lead to unintended [overwrite behavior](/enterprise_influxdb/v1.10/troubleshooting/frequently-asked-questions/#how-does-influxdb-handle-duplicate-points).
...
Clears the current context for the [database](/enterprise_influxdb/v1.10/concepts/glossary/#database) or [retention policy](/enterprise_influxdb/v1.10/concepts/glossary/#retention-policy-rp).
...
Sets the current [database](/enterprise_influxdb/v1.10/concepts/glossary/#database) and/or [retention policy](/enterprise_influxdb/v1.10/concepts/glossary/#retention-policy-rp).
...
Enter `insert` followed by the data in [line protocol](/enterprise_influxdb/v1.10/concepts/glossary/#influxdb-line-protocol) to write data to InfluxDB.
Use `insert into <retention policy> <line protocol>` to write data to a specific [retention policy](/enterprise_influxdb/v1.10/concepts/glossary/#retention-policy-rp).
...
See [Data exploration](/enterprise_influxdb/v1.10/query_language/explore-data/), [Schema exploration](/enterprise_influxdb/v1.10/query_language/explore-schema/), [Database management](/enterprise_influxdb/v1.10/query_language/manage-database/), [Authentication and authorization](/enterprise_influxdb/v1.10/administration/authentication_and_authorization/) for InfluxQL documentation.
