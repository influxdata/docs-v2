...
menu:
  enterprise_influxdb_1_10:
    ...
    parent: Tools
aliases:
    - /enterprise_influxdb/v1.10/tools/influxd/restore/
    - /enterprise_influxdb/v1.10/tools/influxd/backup/
---
...
The `influxd-ctl` utility is available on all [meta nodes](/enterprise_influxdb/v1.10/concepts/glossary/#meta-node).
...
If authentication is enabled in the cluster's [meta node configuration files](/enterprise_influxdb/v1.10/administration/configure/config-meta-nodes/#auth-enabled)
and [data node configuration files](/enterprise_influxdb/v1.10/administration/config-data-nodes/#meta-auth-enabled)
...
[meta node configuration files](/enterprise_influxdb/v1.10/administration/config-meta-nodes/#auth-enabled-false)
and [data node configuration files](/enterprise_influxdb/v1.10/administration/configure/config-data-nodes/#meta-auth-enabled)
and the `influxd-ctl` command does not include authentication details, the system returns:
...
Use `add-data` instead of the [`join` argument](#join) when [installing a data node](/enterprise_influxdb/v1.10/installation/data_node_installation/) an InfluxDB Enterprise cluster.
...
Resources: [Installation](/enterprise_influxdb/v1.10/installation/data_node_installation/)
...
Use `add-meta` instead of the [`join` argument](#join) when [installing a meta node](/enterprise_influxdb/v1.10/installation/meta_node_installation/) an InfluxDB Enterprise cluster.
...
Creates a backup of a cluster's [metastore](/enterprise_influxdb/v1.10/concepts/glossary/#metastore)
and [shard](/enterprise_influxdb/v1.10/concepts/glossary/#shard) data at that point in time
...
Perform a [full backup](/enterprise_influxdb/v1.10/administration/backup-and-restore/#backup-utility).

###### [ `-rp <rp_name>` ]

Name of the single [retention policy](/enterprise_influxdb/v1.10/concepts/glossary/#retention-policy-rp) to back up (requires the `-db` flag).
...
Resources: [Back up and restore InfluxDB Enterprise](/enterprise_influxdb/v1.10/administration/backup-and-restore/)
...
Copies a [shard](/enterprise_influxdb/v1.10/concepts/glossary/#shard) from a source data node to a destination data node.
...
Resources: [Rebalance InfluxDB Enterprise clusters](/enterprise_influxdb/v1.10/guides/rebalance/)
...
Manage entropy and the [anti-entropy](/enterprise_influxdb/v1.10/administration/anti-entropy/) process among shards in a cluster.
...
Resources: [Rebalance cluster](/enterprise_influxdb/v1.10/guides/rebalance/)
...
See ["Back up and restore"](/enterprise_influxdb/v1.10/administration/backup-and-restore/#restore-overwrite-metadata-from-a-full-or-incremental-backup-to-fix-damaged-metadata)
...
Integer of the new [replication factor](/enterprise_influxdb/v1.10/concepts/glossary/#replication-factor) to restore to (this is capped to the number of data nodes in the cluster).

###### [ `-newrp <newrp_name>` ]

Name of the new [retention policy](/enterprise_influxdb/v1.10/concepts/glossary/#retention-policy-rp) to restore to.
...
Identifier of the [shard](/enterprise_influxdb/v1.10/concepts/glossary/#shard) to restore.

Resources: [Backing up and restoring in InfluxDB Enterprise](/enterprise_influxdb/v1.10/administration/backup-and-restore/)
...
Outputs details about existing [shards](/enterprise_influxdb/v1.10/concepts/glossary/#shard) of the cluster, including shard ID, database, [retention policy](/enterprise_influxdb/v1.10/concepts/glossary/#retention-policy-rp), desired replicas, [shard group](/enterprise_influxdb/v1.10/concepts/glossary/#shard-group), starting timestamp, ending timestamp, expiration timestamp, and [data node](/enterprise_influxdb/v1.10/concepts/glossary/#data-node) owners.
...
Updates a data node's address in the [meta store](/enterprise_influxdb/v1.10/concepts/glossary/#meta-service).
...
Truncates hot [shards](/enterprise_influxdb/v1.10/concepts/glossary/#shard), that is, shards that cover the time range that includes the current time ([`now()`](/enterprise_influxdb/v1.10/concepts/glossary/#now)).
...
Determines when to truncate shards after [`now()`](/enterprise_influxdb/v1.10/concepts/glossary/#now).
By default, the tool sets the delay to one minute.
The `duration` is an integer followed by a [duration unit](/enterprise_influxdb/v1.10/query_language/spec/#durations).

Resources: [Cluster rebalancing](/enterprise_influxdb/v1.10/guides/rebalance/)
