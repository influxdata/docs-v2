...
menu:
  enterprise_influxdb_1_10:
    ...
    parent: InfluxQL
aliases:
  - /enterprise_influxdb/v1.10/sample_data/data_download/
  - /enterprise_influxdb/v1.10/query_language/data_download/
...
* The [`-precision` argument](/enterprise_influxdb/v1.10/tools/influx-cli/use-influx/#influx-arguments) specifies the format/precision of any returned timestamps.
...
From your terminal, download the text file that contains the data in [line protocol](/enterprise_influxdb/v1.10/concepts/glossary/#influxdb-line-protocol) format:
```
curl https://s3.amazonaws.com/noaa.water-database/NOAA_data.txt -o NOAA_data.txt
```

Write the data to InfluxDB via the [`influx` CLI](/enterprise_influxdb/v1.10/tools/influx-cli/use-influx/):
```
