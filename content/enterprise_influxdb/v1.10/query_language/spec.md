...
* [Notation](/enterprise_influxdb/v1.10/query_language/spec/#notation)
* [Query representation](/enterprise_influxdb/v1.10/query_language/spec/#query-representation)
  * [Characters](/enterprise_influxdb/v1.10/query_language/spec/#characters)
  * [Letters and digits](/enterprise_influxdb/v1.10/query_language/spec/#letters-and-digits)
  * [Identifiers](/enterprise_influxdb/v1.10/query_language/spec/#identifiers)
  * [Keywords](/enterprise_influxdb/v1.10/query_language/spec/#keywords)
  * [Literals](/enterprise_influxdb/v1.10/query_language/spec/#literals)
* [Queries](/enterprise_influxdb/v1.10/query_language/spec/#queries)
* [Statements](/enterprise_influxdb/v1.10/query_language/spec/#statements)
* [Clauses](/enterprise_influxdb/v1.10/query_language/spec/#clauses)
* [Expressions](/enterprise_influxdb/v1.10/query_language/spec/#expressions)
* [Comments](/enterprise_influxdb/v1.10/query_language/spec/#comments)
* [Other](/enterprise_influxdb/v1.10/query_language/spec/#other)

To learn more about InfluxQL, browse the following topics:

* [Explore your data with InfluxQL](/enterprise_influxdb/v1.10/query_language/explore-data/)
* [Explore your schema with InfluxQL](/enterprise_influxdb/v1.10/query_language/explore-schema/)
* [Database management](/enterprise_influxdb/v1.10/query_language/manage-database/)
* [Authentication and authorization](/enterprise_influxdb/v1.10/administration/authentication_and_authorization/).
* [Query engine internals](/enterprise_influxdb/v1.10/query_language/spec/#query-engine-internals)
...
Identifiers are tokens which refer to [database](/enterprise_influxdb/v1.10/concepts/glossary/#database) names, [retention policy](/enterprise_influxdb/v1.10/concepts/glossary/#retention-policy-rp) names, [user](/enterprise_influxdb/v1.10/concepts/glossary/#user) names, [measurement](/enterprise_influxdb/v1.10/concepts/glossary/#measurement) names, [tag keys](/enterprise_influxdb/v1.10/concepts/glossary/#tag-key), and [field keys](/enterprise_influxdb/v1.10/concepts/glossary/#field-key).

The rules:

- double quoted identifiers can contain any unicode character other than a new line
- double quoted identifiers can contain escaped `"` characters (i.e., `\"`)
- double quoted identifiers can contain InfluxQL [keywords](/enterprise_influxdb/v1.10/query_language/spec/#keywords)
...
[identifier](/enterprise_influxdb/v1.10/concepts/glossary/#identifier) you will need to
...
See [Frequently Asked Questions](/enterprise_influxdb/v1.10/troubleshooting/frequently-asked-questions/#time) for more information.
...
>
* [field keys](/enterprise_influxdb/v1.10/concepts/glossary/#field-key) and [tag keys](/enterprise_influxdb/v1.10/concepts/glossary/#tag-key) in the [`SELECT` clause](/enterprise_influxdb/v1.10/query_language/explore-data/#the-basic-select-statement)
* [measurements](/enterprise_influxdb/v1.10/concepts/glossary/#measurement) in the [`FROM` clause](/enterprise_influxdb/v1.10/query_language/explore-data/#the-basic-select-statement)
* [tag values](/enterprise_influxdb/v1.10/concepts/glossary/#tag-value) and string [field values](/enterprise_influxdb/v1.10/concepts/glossary/#field-value) in the [`WHERE` clause](/enterprise_influxdb/v1.10/query_language/explore-data/#the-where-clause).
* [tag keys](/enterprise_influxdb/v1.10/concepts/glossary/#tag-key) in the [`GROUP BY` clause](/enterprise_influxdb/v1.10/query_language/explore-data/#group-by-tags)
>
...
For more information about storage blocks, see [TSM files](/enterprise_influxdb/v1.10/concepts/storage_engine/#tsm-files).
...
Where `query_id` is the query ID, displayed in the [`SHOW QUERIES`](/enterprise_influxdb/v1.10/troubleshooting/query_management/#list-currently-running-queries-with-show-queries) output as `qid`.
...
[Series cardinality](/enterprise_influxdb/v1.10/concepts/glossary/#series-cardinality) is the major factor that affects RAM requirements. For more information, see:

- [When do I need more RAM?](/enterprise_influxdb/v1.10/guides/hardware_sizing/#when-do-i-need-more-ram) in [Hardware Sizing Guidelines](/enterprise_influxdb/v1.10/guides/hardware_sizing/)
- [Don't have too many series](/enterprise_influxdb/v1.10/concepts/schema_and_data_layout/#avoid-too-many-series)
