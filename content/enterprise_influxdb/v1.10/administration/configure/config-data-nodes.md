...
The TCP bind address used by the RPC service for inter-node communication and [backup and restore](/enterprise_influxdb/v1.10/administration/backup-and-restore/).
...
The hostname of the [data node](/enterprise_influxdb/v1.10/concepts/glossary/#data-node). This must be resolvable by all other nodes in the cluster.
...
> **Note:** You must trigger data nodes to reload your configuration. For more information, see how to [renew or update your license key](/enterprise_influxdb/v1.10/administration/renew-license/).
...
This value must be the same as the [`internal-shared-secret`](/enterprise_influxdb/v1.10/administration/configure/config-meta-nodes/#internal-shared-secret)
...
Automatically creates a default [retention policy](/enterprise_influxdb/v1.10/concepts/glossary/#retention-policy-rp) (RP) when the system creates a database.
...
This setting must have the same value as the meta node option [`meta.password-hash`](/enterprise_influxdb/v1.10/administration/configure/config-meta-nodes/#password-hash).

For detailed configuration information, see [`meta.password-hash`](/enterprise_influxdb/v1.10/administration/configure/config-meta-nodes/#password-hash).
...
For detailed configuration information, see [`meta.ensure-fips`](/enterprise_influxdb/v1.10/administration/configure/config-meta-nodes/#ensure-fips).
...
The maximum number of [series](/enterprise_influxdb/v1.10/concepts/glossary/#series) allowed per database before writes are dropped.
...
The maximum number of [tag values](/enterprise_influxdb/v1.10/concepts/glossary/#tag-value) allowed per [tag key](/enterprise_influxdb/v1.10/concepts/glossary/#tag-key).
...
For information about the Anti-Entropy service, see [Anti-entropy service in InfluxDB Enterprise](/enterprise_influxdb/v1.10/administration/anti-entropy).
...
To change the default seven-day retention policy, you must [create](/enterprise_influxdb/v1.10/query_language/manage-database/#retention-policy-management) it.
...
For more information, see [Graphite protocol support in InfluxDB](/enterprise_influxdb/v1.10/supported_protocols/graphite/).
...
For more information, see [CollectD protocol support in InfluxDB](/enterprise_influxdb/v1.10/supported_protocols/collectd/).
...
For more information, see [OpenTSDB protocol support in InfluxDB](/enterprise_influxdb/v1.10/supported_protocols/opentsdb/).
...
For more information, see [UDP protocol support in InfluxDB](/enterprise_influxdb/v1.10/supported_protocols/udp/).
...
For more on managing queries, see [Query Management](/enterprise_influxdb/v1.10/troubleshooting/query_management/).
