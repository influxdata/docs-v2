...
aliases:
    - /enterprise_influxdb/v1.10/write_protocols/write_syntax/
menu:
...
| :-------| :---------------- |:----------- |:----------------
| [Measurement](/enterprise_influxdb/v1.10/concepts/glossary/#measurement) | Required | The measurement name. InfluxDB accepts one measurement per point. | String
| [Tag set](/enterprise_influxdb/v1.10/concepts/glossary/#tag-set) | Optional | All tag key-value pairs for the point.  | [Tag keys](/enterprise_influxdb/v1.10/concepts/glossary/#tag-key) and [tag values](/enterprise_influxdb/v1.10/concepts/glossary/#tag-value) are both strings.
| [Field set](/enterprise_influxdb/v1.10/concepts/glossary/#field-set) | Required. Points must have at least one field. | All field key-value pairs for the point. | [Field keys](/enterprise_influxdb/v1.10/concepts/glossary/#field-key) are strings. [Field values](/enterprise_influxdb/v1.10/concepts/glossary/#field-value) can be floats, integers, strings, or Booleans.
| [Timestamp](/enterprise_influxdb/v1.10/concepts/glossary/#timestamp) | Optional. InfluxDB uses the server's local nanosecond timestamp in UTC if the timestamp is not included with the point. | The timestamp for the data point. InfluxDB accepts one timestamp per point. | Unix nanosecond timestamp. Specify alternative precisions with the [InfluxDB API](/enterprise_influxdb/v1.10/tools/api/#write-http-endpoint).
...
- To significantly improve compression, use the coarsest [precision](/enterprise_influxdb/v1.10/tools/api/#write-http-endpoint) possible for timestamps.
...
| Timestamp | Timestamps | Unix nanosecond timestamp. Specify alternative precisions with the [InfluxDB API](/enterprise_influxdb/v1.10/tools/api/#write-http-endpoint). The minimum valid timestamp is `-9223372036854775806` or `1677-09-21T00:12:43.145224194Z`. The maximum valid timestamp is `9223372036854775806` or `2262-04-11T23:47:16.854775806Z`. |
...
In a measurement, a field's type cannot differ in a [shard](/enterprise_influxdb/v1.10/concepts/glossary/#shard), but can differ across
shards.
...
To learn how to write line protocol to the database, see [Tools](/enterprise_influxdb/v1.10/tools/).
...
[How does InfluxDB handle duplicate points?](/enterprise_influxdb/v1.10/troubleshooting/frequently-asked-questions/#how-does-influxdb-handle-duplicate-points)
