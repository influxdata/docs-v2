...
weight: 40
aliases:
  - /enterprise_influxdb/v1.10/guides/hardware_sizing/
---
...
- more than 10,000,000 [series cardinality](/enterprise_influxdb/v1.10/concepts/glossary/#series-cardinality)
...
Estimated guidelines include writes per second, queries per second, and number of unique [series](/enterprise_influxdb/v1.10/concepts/glossary/#series), CPU, RAM, and IOPS (input/output operations per second).
...
In general, more RAM helps queries return faster. Your RAM requirements are primarily determined by [series cardinality](/enterprise_influxdb/v1.10/concepts/glossary/#series-cardinality). Higher cardinality requires more RAM. Regardless of RAM, a series cardinality of 10 million or more can cause OOM (out of memory) failures. You can usually resolve OOM issues by redesigning your [schema](/enterprise_influxdb/v1.10/concepts/glossary/#schema).
...
Database names, [measurements](/enterprise_influxdb/v1.10/concepts/glossary/#measurement), [tag keys](/enterprise_influxdb/v1.10/concepts/glossary/#tag-key), [field keys](/enterprise_influxdb/v1.10/concepts/glossary/#field-key), and [tag values](/enterprise_influxdb/v1.10/concepts/glossary/#tag-value) are stored only once and always as strings. [Field values](/enterprise_influxdb/v1.10/concepts/glossary/#field-value) and [timestamps](/enterprise_influxdb/v1.10/concepts/glossary/#timestamp) are stored for every point.
