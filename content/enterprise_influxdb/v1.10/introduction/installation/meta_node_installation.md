...
aliases:
    - /enterprise_influxdb/v1.10/installation/meta_node_installation/
    - /enterprise_influxdb/v1.10/introduction/installation/installation/meta_node_installation/
menu:
...
The installation process sets up three [meta nodes](/enterprise_influxdb/v1.10/concepts/glossary/#meta-node), with each meta node running on its own server.
...
See the
[Clustering in InfluxDB Enterprise](/enterprise_influxdb/v1.10/concepts/clustering/)
...
After your meta nodes are part of your cluster, [install data nodes](/enterprise_influxdb/v1.10/introduction/installation/installation/data_node_installation/).
