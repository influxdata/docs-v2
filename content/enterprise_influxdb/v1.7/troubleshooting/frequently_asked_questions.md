...
aliases:
    - /enterprise_influxdb/v1.7/troubleshooting/frequently-asked-questions/
    - /enterprise/v1.7/troubleshooting/frequently_asked_questions/
...
[join the meta node to the cluster](/enterprise_influxdb/v1.7/install-and-deploy/production_installation/meta_node_installation/#step-3-join-the-meta-nodes-to-the-cluster).

## Why am I seeing a `409` error in some of my data node logs?

When you create a
[Continuous Query (CQ)](/influxdb/v1.7/concepts/glossary/#continuous-query-cq)
