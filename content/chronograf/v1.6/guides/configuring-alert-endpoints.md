...
aliases:
  - /chronograf/v1.6/guides/configure-kapacitor-event-handlers/
...
If this field is empty (not specified), Chronograf sends alert messages to the channel or DM selected for the **Slack WebHook URL** or to the channel or DM specified in the [alert rule](/chronograf/v1.6/guides/create-a-kapacitor-alert/).
