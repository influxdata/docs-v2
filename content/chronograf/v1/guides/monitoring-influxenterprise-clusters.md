...
aliases:
  - /chronograf/v1/guides/monitor-an-influxenterprise-cluster/
menu:
  chronograf_v1:
    weight: 80
    parent: Guides
...
See the [Creating Chronograf dashboards](/chronograf/v1/guides/create-a-dashboard/) guide for more information.
