...
aliases:
  - /chronograf/v1/introduction/templating/
  - /chronograf/v1/templating/
menu:
  chronograf_v1:
    weight: 90
    parent: Guides
...
- [`dashboardTime`](/chronograf/v1/guides/dashboard-template-variables/?t=Flux#dashboardtime-flux)
- [`upperDashboardTime`](/chronograf/v1/guides/dashboard-template-variables/?t=Flux#upperdashboardtime-flux)
- [`autoInterval`](/chronograf/v1/guides/dashboard-template-variables/?t=Flux#autointerval)
{{% /note %}}
