...
This file consists of key-value pairs. See keys (environment variables) for [Chronograf configuration options](/chronograf/v1/administration/config-options), and set values for the keys you want to configure.
...
* [OAuth 2.0 authentication](/chronograf/v1/administration/managing-security/#configure-oauth-2-0)
* [TLS (Transport Layer Security) for HTTPS](/chronograf/v1/administration/managing-security/#configure-tls-transport-layer-security-and-https)
...
* [Managing organizations](/chronograf/v1/administration/managing-organizations/)
* [Managing Chronograf users](/chronograf/v1/administration/managing-chronograf-users/)
