...
2. Use the [`resources-path` configuration option](/chronograf/v1/administration/config-options/#--resources-path) to save the dashboard in the `/resources` directory (by default, `/usr/share/chronograf/resources`).
