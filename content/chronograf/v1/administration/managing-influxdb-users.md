...
aliases:
  - /chronograf/v1/administration/user-management/
menu:
  chronograf_v1:
...
Because authentication is enabled, you need to create an [admin user](/influxdb/v1/administration/authentication_and_authorization/#user-types-and-privileges) before you can do anything else in the database.
...
If you've already [connected your database to Chronograf](/chronograf/v1/introduction/installation/#connect-chronograf-to-your-influxdb-instance-or-influxdb-enterprise-cluster), update the connection configuration in Chronograf with your new username and password.
...
[`add-data`](/enterprise_influxdb/v1/administration/cluster-commands/#add-data),
[`add-meta`](/enterprise_influxdb/v1/administration/cluster-commands/#add-meta),
[`join`](/enterprise_influxdb/v1/administration/cluster-commands/#join),
[`remove-data`](/enterprise_influxdb/v1/administration/cluster-commands/#remove-data),
[`remove-meta`](/enterprise_influxdb/v1/administration/cluster-commands/#remove-meta), and
[`leave`](/enterprise_influxdb/v1/administration/cluster-commands/#leave)
...
**Relevant `influxd-ctl` arguments**:
[`copy-shard`](/enterprise_influxdb/v1/administration/cluster-commands/#copy-shard)

**Pages in Chronograf that require this permission**: NA

#### CreateDatabase
Permission to create databases, create [retention policies](/influxdb/v1/concepts/glossary/#retention-policy-rp), alter retention policies, and view retention policies.
...
[`ALTER RETENTION POLICY`](/influxdb/v1/query_language/manage-database/#modify-retention-policies-with-alter-retention-policy), and
...
**Relevant InfluxQL queries**:
[`CREATE USER`](/influxdb/v1/administration/authentication_and_authorization/#user-management-commands),
[`DROP USER`](/influxdb/v1/administration/authentication_and_authorization/#general-admin-and-non-admin-user-management),
[`GRANT ALL PRIVILEGES`](/influxdb/v1/administration/authentication_and_authorization/#user-management-commands),
[`GRANT [READ,WRITE,ALL]`](/influxdb/v1/administration/authentication_and_authorization/#non-admin-user-management),
[`REVOKE ALL PRIVILEGES`](/influxdb/v1/administration/authentication_and_authorization/#user-management-commands),
[`REVOKE [READ,WRITE,ALL]`](/influxdb/v1/administration/authentication_and_authorization/#non-admin-user-management),
[`SET PASSWORD`](/influxdb/v1/administration/authentication_and_authorization/#general-admin-and-non-admin-user-management),
[`SHOW GRANTS`](/influxdb/v1/administration/authentication_and_authorization/#non-admin-user-management), and
[`SHOW USERS`](/influxdb/v1/administration/authentication_and_authorization/#user-management-commands)

**Pages in Chronograf that require this permission**: Data Explorer, Dashboards, Users and Roles on the Admin page

#### DropData
Permission to drop data, in particular [series](/influxdb/v1/concepts/glossary/#series) and [measurements](/influxdb/v1/concepts/glossary/#measurement).

**Relevant InfluxQL queries**:
[`DROP SERIES`](/influxdb/v1/query_language/manage-database/#drop-series-from-the-index-with-drop-series),
[`DELETE`](/influxdb/v1/query_language/manage-database/#delete-series-with-delete), and
...
**Relevant InfluxQL queries**:
[`DROP DATABASE`](/influxdb/v1/query_language/manage-database/#delete-a-database-with-drop-database) and
...
Permission to create, drop, and view [continuous queries](/influxdb/v1/concepts/glossary/#continuous-query-cq).

**Relevant InfluxQL queries**:
[`CreateContinuousQueryStatement`](/influxdb/v1/query_language/continuous_queries/),
[`DropContinuousQueryStatement`](/influxdb/v1/query_language/continuous_queries/#deleting-continuous-queries), and
[`ShowContinuousQueriesStatement`](/influxdb/v1/query_language/continuous_queries/#listing-continuous-queries)
...
**Relevant InfluxQL queries**:
[`SHOW QUERIES`](/influxdb/v1/troubleshooting/query_management/#list-currently-running-queries-with-show-queries) and
[`KILL QUERY`](/influxdb/v1/troubleshooting/query_management/#stop-currently-running-queries-with-kill-query)

**Pages in Chronograf that require this permission**: Queries on the Admin page

#### ManageShard
Permission to copy, delete, and view [shards](/influxdb/v1/concepts/glossary/#shard).

**Relevant InfluxQL queries**:
[`DropShardStatement`](/influxdb/v1/query_language/manage-database/#delete-a-shard-with-drop-shard),
[`ShowShardGroupsStatement`](/influxdb/v1/query_language/spec/#show-shard-groups), and
[`ShowShardsStatement`](/influxdb/v1/query_language/spec/#show-shards)

**Pages in Chronograf that require this permission**: NA

#### ManageSubscription
Permission to create, drop, and view [subscriptions](/influxdb/v1/concepts/glossary/#subscription).

**Relevant InfluxQL queries**:
[`CREATE SUBSCRIPTION`](/influxdb/v1/query_language/spec/#create-subscription),
[`DROP SUBSCRIPTION`](/influxdb/v1/query_language/spec/#drop-subscription), and
...
[`SHOW TAG VALUES`](/influxdb/v1/query_language/explore-schema/#show-tag-values), and
[`SHOW RETENTION POLICIES`](/influxdb/v1/query_language/explore-schema/#show-retention-policies)
