...
>
> Use [InfluxDB 2.0 API compatibility endpoints](/enterprise_influxdb/v1/api/buckets-v2-compatible/) to integrate applications built on InfluxDB 2.0 or InfluxDB Cloud with InfluxDB Enterprise 1.8+:
>
