...
For details about the configuration file, see [Get started with Telegraf](/telegraf/v1/get_started/).
...
Now that you've explored your data with queries, you can build a dashboard in Chronograf to visualize the data. For details, see [Create a dashboard](/chronograf/v1/guides/create-a-dashboard) and [Using pre-created dashboards](/chronograf/v1/guides/using-precreated-dashboards/).
