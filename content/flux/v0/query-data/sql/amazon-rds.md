...
description: >
  Use [`sql.from()`](/flux/v0/stdlib/sql/from/) to query a relational database
...
2. Use the [`sql.from()` function](/flux/v0/stdlib/sql/from/) and provide the
...
- [Query MariaDB](/flux/v0/query-data/sql/mariadb/)
- [Query MySQL](/flux/v0/query-data/sql/mysql/)
- [Query PostgreSQL](/flux/v0/query-data/sql/postgresql/)
- [Query SQL Server](/flux/v0/query-data/sql/sql-server/)
