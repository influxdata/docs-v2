...
list_title: BigQuery
description: >
  Use [`sql.to()`](/flux/v0/stdlib/sql/to/) with the `bigquery` driver to
...
| :-------------------------------------------- | :----------------- |
| [int](/flux/v0/data-types/basic/int/)       | INT64              |
| [float](/flux/v0/data-types/basic/float/)   | FLOAT64            |
| [string](/flux/v0/data-types/basic/string/) | STRING             |
