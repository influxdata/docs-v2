...
weight: 106
aliases:
  - /influxdb/v2/reference/flux/language/types/
  - /influxdb/cloud/reference/flux/language/types/
---

A **type** defines the set of values and operations on those values.
Types are never explicitly declared as part of the syntax except as part of a [builtin statement](/flux/v0/spec/system-built-ins/).
...
{{< page-nav prev="/flux/v0/spec/options/" next="/flux/v0/spec/blocks/" >}}
