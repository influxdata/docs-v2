...
related:
  ...
  - /flux/v0/stdlib/contrib/bonitoo-io/hex/int/
...
Use the [`int()` function](/flux/v0/stdlib/universe/int/) to convert
the following [basic types](/flux/v0/data-types/basic/) to integers:
...
2. Use [`hex.int()`](/flux/v0/stdlib/contrib/bonitoo-io/hex/int/) to convert
...
**To convert the `_value` column to integers**, use the [`toInt()` function](/flux/v0/stdlib/universe/toint/).
...
2. Use [`int()`](/flux/v0/stdlib/universe/int/) to convert columns values to integers.
