...
However, you can use [`float()`](/flux/v0/stdlib/universe/float/) to convert
...
Use the [`float()` function](/flux/v0/stdlib/universe/float/) to convert
the following [basic types](/flux/v0/data-types/basic/) to floats:
...
### Flux math package
Use the [`math` package](/flux/v0/stdlib/math/) to perform
