...
data into native Flux types; specifically Flux [arrays](/flux/v0.x/data-types/composite/array/)
and [records](/flux/v0.x/data-types/composite/record/).
...
1.  Import the [`experimental/dynamic` package](/flux/v0.x/stdlib/experimental/dynamic/).
2.  Use [`dynamic.dynamic()`](/flux/v0.x/stdlib/experimental/dynamic/dynamic/) to
...
Use [`string()`](/flux/v0.x/stdlib/universe/string/) to convert a dynamic type to a string.
...
Use [`int()`](/flux/v0.x/stdlib/universe/int/) to convert a dynamic type to an integer.
`int()` returns the [integer equivalent](/flux/v0.x/data-types/basic/int/#convert-data-types-to-integers)
...
Use [`uint()`](/flux/v0.x/stdlib/universe/uint/) to convert a dynamic type to an unsigned integer (UInteger).
`uint()` returns the [UInteger equivalent](/flux/v0.x/data-types/basic/uint/#convert-data-types-to-uintegers)
of the dynamic value.
...
Use [`float()`](/flux/v0.x/stdlib/universe/float/) to convert a dynamic type to a floating point value.
`float()` returns the [float equivalent](/flux/v0.x/data-types/basic/float/#convert-data-types-to-floats)
of the dynamic value.
...
Use [`bool()`](/flux/v0.x/stdlib/universe/bool/) to convert a dynamic type to a boolean value.
`bool()` returns the [boolean equivalent](/flux/v0.x/data-types/basic/bool/#convert-data-types-to-booleans)
of the dynamic value.
...
Use [`duration()`](/flux/v0.x/stdlib/universe/duration/) to convert a dynamic type to a duration value.
`duration()` returns the [duration equivalent](/flux/v0.x/data-types/basic/duration/#convert-data-types-to-durations)
of the dynamic value.
...
Use [`time()`](/flux/v0.x/stdlib/universe/time/) to convert a dynamic type to a time value.
`time()` returns the [time equivalent](/flux/v0.x/data-types/basic/time/#convert-data-types-to-time)
of the dynamic value.
...
Use [`bytes()`](/flux/v0.x/stdlib/universe/bytes/) to convert a dynamic type to a byte-encoded string.
`bytes()` returns the [bytes equivalent](/flux/v0.x/data-types/basic/bytes/#convert-data-types-to-bytes)
of the dynamic value.
...
1.  Use [`string()`](/flux/v0.x/stdlib/universe/string/) to convert a dynamic type to a string.
2.  Import the [`regexp` package](/flux/v0.x/stdlib/regexp/) and use
    [`regexp.compile()`](/flux/v0.x/stdlib/regexp/compile/) to convert the string
...
3.  Use [`dynamic.asArray()`](/flux/v0.x/stdlib/experimental/dynamic/asarray/)
    to convert the dynamic-typed array into an array of dynamic types.
4.  Use [`array.map()`](/flux/v0.x/stdlib/array/map/) to iterate over each element
...
4.  Use [`array.map()`](/flux/v0.x/stdlib/array/map/) to do the following:

    - Iterate over each dynamic record in the dynamic array and flatten nested records.
      Flux tables do not support nested [records](/flux/v0.x/data-types/composite/record/)
...
2.  Use [`dynamic.dynamic()`](/flux/v0.x/stdlib/experimental/dynamic/dynamic/)
    to convert the record to a dynamic type.
3.  Use [`dynamic.jsonEncode()`](/flux/v0.x/stdlib/experimental/dynamic/jsonencode/)
...
4.  Use [`dynamic.jsonEncode()`](/flux/v0.x/stdlib/experimental/dynamic/jsonencode/)
