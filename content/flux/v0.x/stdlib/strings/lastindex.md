...
https://github.com/influxdata/flux/blob/master/stdlib/strings/strings.flux#L472-L472
...
```js
strings.lastIndex = (substr: string, v: string) => int
```
