...
https://github.com/influxdata/flux/blob/master/stdlib/strings/strings.flux#L280-L280
...
```js
strings.hasSuffix = (suffix: string, v: string) => bool
```
