...
https://github.com/influxdata/flux/blob/master/stdlib/experimental/experimental.flux#L1165-L1165
...
```js
experimental.min = (<-tables: stream[{A with _value: B}]) => stream[{A with _value: B}]
```
