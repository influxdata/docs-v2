...
https://github.com/influxdata/flux/blob/master/stdlib/experimental/experimental.flux#L1117-L1117
...
```js
experimental.last = (<-tables: stream[{A with _value: B}]) => stream[{A with _value: B}]
```
