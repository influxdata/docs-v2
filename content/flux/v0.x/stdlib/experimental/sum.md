...
https://github.com/influxdata/flux/blob/master/stdlib/experimental/experimental.flux#L982-L982
...
```js
experimental.sum = (<-tables: stream[{A with _value: B}]) => stream[{A with _value: B}] where B: Numeric
```
