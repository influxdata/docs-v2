...
menu:
  flux_0_x_ref:
    ...
    identifier: experimental/bitwise/ulshift
weight: 201
---
...
https://github.com/influxdata/flux/blob/master/stdlib/experimental/bitwise/bitwise.flux#L175-L175
...
```js
bitwise.ulshift = (a: uint, b: uint) => uint
```
