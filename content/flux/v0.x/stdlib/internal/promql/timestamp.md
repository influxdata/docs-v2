...
https://github.com/influxdata/flux/blob/master/stdlib/internal/promql/promql.flux#L174-L174
...
```js
promql.timestamp = (<-tables: stream[{A with _value: float}]) => stream[{A with _value: float}]
```
