...
https://github.com/influxdata/flux/blob/master/stdlib/sampledata/sampledata.flux#L173-L177
...
```js
sampledata.int = (?includeNull: bool) => stream[{A with _value: B, _value: int}]
```
