...
https://github.com/influxdata/flux/blob/master/stdlib/date/date.flux#L157-L157
...
```js
date.weekDay = (t: A, ?location: {zone: string, offset: duration}) => int where A: Timeable
```
