...
https://github.com/influxdata/flux/blob/master/stdlib/date/date.flux#L394-L394
...
```js
date.quarter = (t: A, ?location: {zone: string, offset: duration}) => int where A: Timeable
```
