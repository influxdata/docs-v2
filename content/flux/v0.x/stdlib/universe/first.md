...
https://github.com/influxdata/flux/blob/master/stdlib/universe/universe.flux#L659-L659
...
```js
first = (<-tables: stream[A], ?column: string) => stream[A] where A: Record
```
