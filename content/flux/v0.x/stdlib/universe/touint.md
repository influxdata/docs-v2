...
https://github.com/influxdata/flux/blob/master/stdlib/universe/universe.flux#L4528-L4528
...
```js
toUInt = (<-tables: stream[{A with _value: B}]) => stream[{A with _value: B, _value: uint}]
```
