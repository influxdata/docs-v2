...
https://github.com/influxdata/flux/blob/master/stdlib/universe/universe.flux#L3473-L3473
...
```js
linearBins = (count: int, start: float, width: float, ?infinity: bool) => [float]
```
