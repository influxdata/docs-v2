...
https://github.com/influxdata/flux/blob/master/stdlib/universe/universe.flux#L1972-L1975
...
```js
pivot = (<-tables: stream[A], columnKey: [string], rowKey: [string], valueColumn: string) => stream[B] where A: Record, B: Record
```
