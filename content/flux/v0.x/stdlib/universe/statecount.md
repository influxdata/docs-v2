...
https://github.com/influxdata/flux/blob/master/stdlib/universe/universe.flux#L3838-L3840
...
```js
stateCount = (<-tables: stream[A], fn: (r: A) => bool, ?column: string) => stream[B] where A: Record, B: Record
```
