...
https://github.com/influxdata/flux/blob/master/stdlib/universe/universe.flux#L2848-L2848
...
```js
tableFind = (<-tables: stream[B], fn: (key: A) => bool) => stream[B] where A: Record, B: Record
```
