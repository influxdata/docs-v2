...
https://github.com/influxdata/flux/blob/master/stdlib/universe/universe.flux#L2537-L2537
...
```js
sum = (<-tables: stream[A], ?column: string) => stream[B] where A: Record, B: Record
```
