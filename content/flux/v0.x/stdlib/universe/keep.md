...
https://github.com/influxdata/flux/blob/master/stdlib/universe/universe.flux#L1185-L1188
...
```js
keep = (<-tables: stream[A], ?columns: [string], ?fn: (column: string) => bool) => stream[B] where A: Record, B: Record
```
