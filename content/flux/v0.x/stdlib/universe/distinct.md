...
https://github.com/influxdata/flux/blob/master/stdlib/universe/universe.flux#L398-L398
...
```js
distinct = (<-tables: stream[A], ?column: string) => stream[B] where A: Record, B: Record
```
