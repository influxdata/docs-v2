...
https://github.com/influxdata/flux/blob/master/stdlib/universe/universe.flux#L4479-L4479
...
```js
toInt = (<-tables: stream[{A with _value: B}]) => stream[{A with _value: B, _value: int}]
```
