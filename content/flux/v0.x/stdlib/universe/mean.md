...
https://github.com/influxdata/flux/blob/master/stdlib/universe/universe.flux#L1728-L1728
...
```js
mean = (<-tables: stream[A], ?column: string) => stream[B] where A: Record, B: Record
```
