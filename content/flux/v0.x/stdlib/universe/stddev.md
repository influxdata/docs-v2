...
https://github.com/influxdata/flux/blob/master/stdlib/universe/universe.flux#L2515-L2515
...
```js
stddev = (<-tables: stream[A], ?column: string, ?mode: string) => stream[B] where A: Record, B: Record
```
