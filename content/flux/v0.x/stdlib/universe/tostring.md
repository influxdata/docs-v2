...
https://github.com/influxdata/flux/blob/master/stdlib/universe/universe.flux#L4430-L4430
...
```js
toString = (<-tables: stream[{A with _value: B}]) => stream[{A with _value: B, _value: string}]
```
