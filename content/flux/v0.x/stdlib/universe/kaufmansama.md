...
https://github.com/influxdata/flux/blob/master/stdlib/universe/universe.flux#L1148-L1148
...
```js
kaufmansAMA = (<-tables: stream[A], n: int, ?column: string) => stream[B] where A: Record, B: Record
```
