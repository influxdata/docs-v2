...
2. In your terminal, use cURL to send a request to the following {{% product-name %}} endpoint:
   ...
   {{% api-endpoint endpoint="https://console.influxdata.com/api/v0/accounts/ACCOUNT_ID/clusters/CLUSTER_ID/tokens" method="get" api-ref="/influxdb3/cloud-dedicated/api/database-tokens/#operation/GetDatabaseTokens" %}}
...
To retrieve a specific database token by ID, send a request to the following {{% product-name %}} endpoint:
   ...
   {{% api-endpoint endpoint="https://console.influxdata.com/api/v0/accounts/ACCOUNT_ID/clusters/CLUSTER_ID/tokens/TOKEN_ID" method="get" api-ref="/influxdb3/cloud-dedicated/api/database-tokens/#operation/GetDatabaseToken" %}}
