...
related:
  ...
  - /influxdb3/cloud-dedicated/reference/internals/system-tables/
--- 
...
- {{% code-placeholder-key %}}`PARTITION_KEY`{{% /code-placeholder-key %}}: a [partition key](/influxdb3/cloud-dedicated/admin/custom-partitions/#partition-keys)
...
data for all [InfluxDB Queriers](/influxdb3/cloud-dedicated/reference/internals/storage-engine/#querier) in your cluster.
