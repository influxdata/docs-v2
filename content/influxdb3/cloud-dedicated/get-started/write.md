...
to the
[InfluxDB API `/write` endpoint](/influxdb3/cloud-dedicated/api/data-api/write-data/)
using the `POST` request method.

{{% api-endpoint endpoint="https://{{< influxdb/host >}}/write" method="post"
api-ref="/influxdb3/cloud-dedicated/api/data-api/write-data/"%}}
...
> [v1 API `/write` endpoint](/influxdb3/cloud-dedicated/api/data-api/write-data/),
...
method="post" api-ref="/influxdb3/cloud-dedicated/api/data-api/write-data/" >}}
