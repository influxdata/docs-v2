...
A query plan is a sequence of steps that the InfluxDB v3 [Querier](/influxdb3/clustered/reference/internals/storage-engine/#querier) devises and executes to calculate the result of a query.
...
The InfluxDB `RecordBatchesExec` implementation retrieves and scans recently written, yet-to-be-persisted, data from the InfluxDB v3 [Ingester](/influxdb3/clustered/reference/internals/storage-engine/#ingester).
