...
description: >
  InfluxDB v3 client libraries use InfluxDB HTTP APIs to write data and use [Flight clients](/influxdb3/clustered/reference/client-libraries/flight-sql) to execute SQL and InfluxQL queries.
