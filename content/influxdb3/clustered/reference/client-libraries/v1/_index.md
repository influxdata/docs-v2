...
{{% note %}}
Upgrade to InfluxDB v3 to use new client libraries compatible with InfluxDB write APIs, SQL, and InfluxQL. For more information, see [InfluxDB client libraries](/influxdb3/clustered/reference/client-libraries/v3/).
{{% /note %}}
