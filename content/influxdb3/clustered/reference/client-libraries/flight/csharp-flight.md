...
> 
> Use the [`influxdb3-csharp` C# client library](/influxdb3/clustered/reference/client-libraries/v3/csharp/) for integrating InfluxDB 3 with your C# application code.
> 
