...
With a
[basic understanding of line protocol](/influxdb3/clustered/write-data/line-protocol/),
...
[Set up InfluxDB](/influxdb3/clustered/get-started/setup/) and
[Write data set up](/influxdb3/clustered/get-started/write/#set-up-your-project-and-credentials)
instructions in [Get started](/influxdb3/clustered/get-started/).

After setting up InfluxDB and your project, you should have the following:

- {{< product-name >}} credentials:

  - [Database](/influxdb3/clustered/admin/databases/)
...
[InfluxDB v2 clients](/influxdb3/clustered/reference/client-libraries/v2/).
...
2. Constructs `home`
   [measurement](/influxdb3/clustered/reference/glossary/#measurement)
   `Point` objects.
