...
description: >
  ...
  [line protocol](/influxdb3/clustered/reference/syntax/line-protocol/)
...
```toml { placeholders="DATABASE_NAME" }
[[outputs.influxdb_v2]]
...
To learn more about configuration options, see [Enable and configure the InfluxDB v2 output plugin](/influxdb3/clustered/write-data/use-telegraf/configure/#enable-and-configure-the-influxdb-v2-output-plugin).
...
**`INFLUX_TOKEN`** is an environment variable you created in the [Setup instructions](/influxdb3/clustered/get-started/setup/?t=Telegraf) of the Get Started tutorial.
