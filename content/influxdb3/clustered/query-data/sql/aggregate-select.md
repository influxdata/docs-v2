...
related:
  - /influxdb3/clustered/reference/sql/functions/aggregate/
  - /influxdb3/clustered/reference/sql/functions/selector/
list_code_example: |
...
[View aggregate functions](/influxdb3/clustered/reference/sql/functions/aggregate/)
...
[View selector functions](/influxdb3/clustered/reference/sql/functions/selector/)
...
- In your `SELECT` clause:
  ...
  - Use the [`DATE_BIN` function](/influxdb3/clustered/reference/sql/functions/time-and-date/#date_bin)
  ...
  - Use [aggregate](/influxdb3/clustered/reference/sql/functions/aggregate/) or [selector](/influxdb3/clustered/reference/sql/functions/selector/) functions on specified columns.
