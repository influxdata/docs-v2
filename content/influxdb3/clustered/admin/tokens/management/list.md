...
description: >
  Use the [`influxctl management list` command](/influxdb3/clustered/reference/cli/influxctl/management/list/)
...
related:
  ...
  - /influxdb3/clustered/reference/cli/influxctl/management/list/
list_code_example: |
  ```sh
