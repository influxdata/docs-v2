...
Use the following guidelines to design your [schema](/influxdb3/core/reference/glossary/#schema)
...
- **Database**: A named location where time series data is stored.
  ...
  - **Table**: A logical grouping for time series data.
    ...
    - **Timestamp**: Timestamp associated with the data.
      ...
      [Unix timestamp](/influxdb3/core/reference/glossary/#unix-timestamp)
      in UTC.
...
A table has a [maximum number of columns](/influxdb3/core/admin/databases/#column-limit).
...
For example, consider the following [line protocol](/influxdb3/core/reference/syntax/line-protocol/)
...
- [SQL keywords](/influxdb3/core/reference/sql/#keywords)
