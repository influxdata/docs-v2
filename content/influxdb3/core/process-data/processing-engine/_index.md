...
seotitle: InfluxDB 3 {< product-name >}} Processing Engine overview and plugin support
description: Learn how the {{< product-name >}} processing engine works and how to manage plugins.
menu:
  influxdb3_core:
