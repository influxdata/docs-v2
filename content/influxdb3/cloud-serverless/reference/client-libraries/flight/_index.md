...
We recommend using [InfluxDB v3 client libraries](/influxdb3/cloud-serverless/reference/client-libraries/v3/) for integrating InfluxDB v3 with your application code.
