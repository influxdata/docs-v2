...
> 
> Use the [`influxdb3-java` Java client library](/influxdb3/cloud-serverless/reference/client-libraries/v3/java/) for integrating InfluxDB 3 with your Java application code.
> 
