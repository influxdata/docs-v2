...
For a list of available aggregation functions, see [SQL aggregate functions](/influxdb3/cloud-serverless/reference/sql/functions/aggregate/).
...
[InfluxDB data organization](/influxdb3/cloud-serverless/get-started/#data-organization)
...
[SQL functions](/influxdb3/cloud-serverless/reference/sql/functions/).
...
[`influxctl`](/influxdb3/cloud-serverless/reference/cli/influxctl/) is a CLI that
performs [administrative tasks](/influxdb3/cloud-serverless/admin/) for an
...
See [line protocol](/influxdb3/cloud-serverless/reference/syntax/line-protocol/).
...
See [Query data in InfluxDB](/influxdb3/cloud-serverless/query-data/).
...
See [Query plans](/influxdb3/cloud-serverless/reference/internals/query-plans/).
...
See [SQL selector functions](/influxdb3/cloud-serverless/reference/sql/functions/selector/)
...
In InfluxDB 3, a table represents a measurement.
...
[Use Telegraf to collect data](/influxdb3/cloud-serverless/write-data/use-telegraf/),
...
[Elements of line protocol](/influxdb3/cloud-serverless/reference/syntax/line-protocol/#elements-of-line-protocol).
...
Related entries:
[Manage tokens](/influxdb3/cloud-serverless/admin/tokens/)
...
InfluxQL [transformation functions](/influxdb3/cloud-serverless/reference/influxql/functions/transformations/) modify and return values in each row of queried data, but do not return an aggregated value across those rows.
