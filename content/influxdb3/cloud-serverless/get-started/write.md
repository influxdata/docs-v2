...
to the
[InfluxDB API `/write` endpoint](/influxdb3/cloud-serverless/api/write-data/#operation/PostLegacyWrite)
using the `POST` request method.

{{% api-endpoint endpoint="https://{{< influxdb/host >}}/write" method="post"
api-ref="/influxdb3/cloud-serverless/api/write-data/#operation/PostLegacyWrite"%}}
...
method="post" api-ref="/influxdb3/cloud-serverless/api/write-data/#operation/PostWrite" >}}
