...
menu:
  influxdb3_cloud_serverless:
    ...
    name: Use Superset
influxdb3/cloud-serverless/tags: [Flight client, query, flightsql, superset]
aliases:
...
5.  Enter your **SQL Alchemy URI** comprised of the following:
    ...
    - **Domain**: [InfluxDB Cloud Serverless region domain](/influxdb3/cloud-serverless/reference/regions/)
    - **Port**: 443
