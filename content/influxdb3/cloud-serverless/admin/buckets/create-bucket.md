...
{{< api-endpoint method="post" endpoint="https://{{< influxdb/host >}}/api/v2/buckets" api-ref="/influxdb3/cloud-serverless/api/buckets/#operation/PostBuckets" >}}
...
[InfluxDB API Buckets reference documentation](/influxdb3/cloud-serverless/api/buckets/#operation/PostBuckets)._
<!------------------------------ END API CONTENT ------------------------------>
{{% /tab-content %}}
{{< /tabs-wrapper >}}
