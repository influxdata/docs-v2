...
Send a request to the InfluxDB HTTP API [`/api/v2/buckets` endpoint](/influxdb3/cloud-serverless/api/buckets/#operation/GetBuckets) to view buckets in an organization.
