...
<!--To estimate your projected usage costs, use the [InfluxDB Cloud pricing calculator](/influxdb3/cloud-serverless/account-management/pricing-calculator/). -->

## Free Plan

New {{< product-name >}} accounts start with the Free Plan that provides a limited
number of resources and data usage.
See [plan limits](/influxdb3/cloud-serverless/admin/billing/limits/).

## Usage-Based Plan

The Usage-Based Plan offers more flexibility and ensures you only pay for what you
[use](/influxdb3/cloud-serverless/admin/billing/data-usage/).
...
Discover how to [manage InfluxDB Cloud Serverless billing](/influxdb3/cloud-serverless/admin/billing/).
