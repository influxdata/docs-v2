...
If you exceed your plan's [adjustable quotas or limits](/influxdb3/cloud-serverless/account-management/limits/), you'll receive a notification in the {{< product-name "short" >}} user interface (UI) **Usage** page.
