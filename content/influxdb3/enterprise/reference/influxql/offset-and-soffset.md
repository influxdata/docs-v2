...
description: >
  Use `OFFSET` to specify the number of [rows](/influxdb3/enterprise/reference/glossary/#series)
  to skip in each InfluxQL group before returning results.
  Use `SOFFSET` to specify the number of [series](/influxdb3/enterprise/reference/glossary/#series)
