---
title: influxdb3-csharp release notes
list_title: Release notes
description: Release notes for the influxdb3-csharp client library for InfluxDB 3.
menu:
  influxdb3_enterprise:
    name: Release notes
    parent: influxdb3-csharp
    identifier: influxdb3-csharp-release-notes
weight: 301
