---
title: influxdb3-rust release notes
list_title: Release notes
description: Release notes for the influxdb3-rust client library for InfluxDB 3.
menu:
  influxdb3_enterprise:
    name: Release notes
    parent: influxdb3-rust
    identifier: influxdb3-rust-release-notes
weight: 301
