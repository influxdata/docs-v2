...
related:
  ...
  - /influxdb3/enterprise/api/write-data/#operation/PostV2Write, /api/v2/write (v2-compatible) endpoint
  - /influxdb3/enterprise/api/write-data/#operation/PostV1Write, /write (v1-compatible) endpoint
